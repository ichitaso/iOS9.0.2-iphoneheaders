...
@class NSMutableArray, NSMutableSet, HKDataUnitGroup, WDControllerManager, HKUnitController, NSArray, NSString;
...
-(void)_performAdditionalDataHandlingForSource:(id)arg1 healthStore:(id)arg2 forStartDate:(id)arg3 endDate:(id)arg4 updateHandler:(/*^block*/id)arg5 ;
