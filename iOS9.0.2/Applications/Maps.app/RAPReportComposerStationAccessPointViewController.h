...
@class RAPStationAccessPointQuestion, RAPReportComposerCommentPart;

@interface RAPReportComposerStationAccessPointViewController : RAPReportTableViewController {

	RAPStationAccessPointQuestion* _question;
