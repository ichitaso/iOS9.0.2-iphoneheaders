...
@class RCCompositionController, UILabel, UIFont, NSLayoutConstraint, NSTimer, UIButton, UIProgressView, NSString, NSDate, _RCMemoAlertContext, RCUIConfiguration, RCLayoutMetrics, RCControlsView, NSArray, RCAVWaveformViewController, RCWaveformDataSource, RCAVState;
