...
-(void)dispatchNativeViewEventOfType:(int)arg1 withExtraInfo:(id)arg2 forViewController:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(unsigned)_indexOfEventListener:(id)arg1 forNativeViewIdentifier:(id)arg2 eventType:(id)arg3 returningContainerMutableArray:(id*)arg4 ;
...
-(void)_dispatchNativeViewEventOfType:(int)arg1 withExtraInfo:(id)arg2 forJSNativeViewController:(id)arg3 appContext:(id)arg4 jsContext:(id)arg5 completion:(/*^block*/id)arg6 ;
-(void)_registerViewController:(id)arg1 withExistingJSNativeViewController:(id)arg2 ;
-(char)_shouldUseInternalEventRegistryListenersToDispatchNativeViewEventOfType:(int)arg1 ;
