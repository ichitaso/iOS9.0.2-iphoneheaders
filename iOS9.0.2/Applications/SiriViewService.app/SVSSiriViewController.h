...
@class NSMutableSet, NSMutableDictionary, SVSPunchoutSignature, NSObject, SVSPreferences, SVSConversationStore, NSMutableArray, AFUISiriLanguage, AFUIAudioPlayer, SVSAceCommandRecords, AFUIRequestOptions, NSString, NSTimer, AFManagedStorageConnection;

@interface SVSSiriViewController : UIViewController <AFUIDomainObjectStore, AFUIAudioPlayerDelegate, SVSAceCommandRecordsDelegate, SVSConversationDelegate, SiriUIPresentationDataSource, SiriUIPresentationDelegate, AFUISiriLanguageDelegate, SVSSiriViewControllerServing> {
...
-(void)_speakText:(id)arg1 provisionally:(char)arg2 eligibleAfterDuration:(double)arg3 speakableUtteranceParser:(id)arg4 preparation:(/*^block*/id)arg5 completion:(/*^block*/id)arg6 animationBlock:(/*^block*/id)arg7 ;
