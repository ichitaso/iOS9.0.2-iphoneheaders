...
@interface IMCustomSlider : UISlider {
	...
	float _fineScrubbingVerticalRange;
...
@property (assign,nonatomic) float fineScrubbingVerticalRange;                        //@synthesize fineScrubbingVerticalRange=_fineScrubbingVerticalRange - In the implementation block
...
-(void)setFineScrubbingVerticalRange:(float)arg1 ;
