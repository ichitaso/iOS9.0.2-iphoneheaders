...
#import <iBooks/AEHighlightedTextLabelTextViewDelegate.h>
...
+(float)adjustedLeadingForFont:(CTFontRef)arg1 ;
+(unsigned)possibleLineLengthForAnnotation:(id)arg1 size:(CGSize)arg2 ;
+(CTParagraphStyleRef)createParagraphStyleForFont:(CTFontRef)arg1 ;
+(void)collapseNewlinesForMutableAttributedString:(id)arg1 ;
-(id)initWithFrame:(CGRect)arg1 generateHighlight:(char)arg2 generateHighlightAsynchronously:(char)arg3 ;
-(void)drawLabelInRect:(CGRect)arg1 ;
-(AEHighlightRenderingController *)renderingController;
-(void)p_renderHighlightLayer:(id)arg1 inContext:(CGContextRef)arg2 flippingOriginWithY:(float)arg3 ;
