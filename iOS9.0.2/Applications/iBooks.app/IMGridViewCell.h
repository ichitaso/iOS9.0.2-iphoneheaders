...
@property (assign,nonatomic) char ignoreChangesToHidden;                     //@synthesize ignoreChangesToHidden=_ignoreChangesToHidden - In the implementation block
+(CGRect)imageRectForBounds:(CGRect)arg1 image:(id)arg2 gravity:(int)arg3 ;
+(CGSize)scaledImageSizeForBounds:(CGRect)arg1 image:(id)arg2 ;
...
-(void)setIgnoreChangesToHidden:(char)arg1 ;
