...
@class GKGameRecord, GKGameRecommendationInternal, NSString, GKSegmentedSectionDataSource, GKAchievementsDataSource, GKChallengesDataSource, GKCollectionViewDataSource, UICollectionReusableView, GKSupplementaryViewMetrics, GKLeaderboardScoresDataSource, GKLeaderboardHeaderView, GKCollectionViewAggregateDataSource, GKFriendPlayersDataSource, GKGameRecentPlayersDataSource, NSArray, UIActivityViewController, UIViewController;
...
@property (nonatomic,retain) UIViewController * friendSuggestionPresentedViewController;                            //@synthesize friendSuggestionPresentedViewController=_friendSuggestionPresentedViewController - In the implementation block
...
-(void)setFriendSuggestionPresentedViewController:(UIViewController *)arg1 ;
-(char)isChildOfActiveTabBarViewController;
-(UIViewController *)friendSuggestionPresentedViewController;
-(void)presentNavigationControllerInPopover:(id)arg1 fromCell:(id)arg2 subview:(id)arg3 permittedArrowDirections:(unsigned)arg4 completion:(/*^block*/id)arg5 ;
...
-(void)uninstallGame;
-(unsigned)popoverArrowDirectionsForViewController:(id)arg1 ;
