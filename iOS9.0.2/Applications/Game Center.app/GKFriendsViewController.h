...
-(void)presentFriendRequestViewController;
-(void)showPopoverWithNavigationController:(id)arg1 highlightTarget:(id)arg2 arrowDirection:(unsigned)arg3 completion:(/*^block*/id)arg4 ;
