...
#import <libobjc.A.dylib/ADSSession_RPC.h>
...
@interface ADSSession : NSObject <ADSSession_RPC, ADClientStateDelegate> {
	...
	char _unlimitedControllersAllowed;
...
@property (nonatomic,readonly) char unlimitedControllersAllowed;                                  //@synthesize unlimitedControllersAllowed=_unlimitedControllersAllowed - In the implementation block
...
@property (nonatomic,retain) NSMutableArray * actionsAwaitingMobileInstallationData;              //@synthesize actionsAwaitingMobileInstallationData=_actionsAwaitingMobileInstallationData - In the implementation block
...
-(char)unlimitedControllersAllowed;
