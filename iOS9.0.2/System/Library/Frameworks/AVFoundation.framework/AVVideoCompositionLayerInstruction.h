...
-(char)getTransformRampForTime:(SCD_Struct_CM5)arg1 startTransform:(CGAffineTransform*)arg2 endTransform:(CGAffineTransform*)arg3 timeRange:(SCD_Struct_CM6*)arg4 ;
-(char)getOpacityRampForTime:(SCD_Struct_CM5)arg1 startOpacity:(float*)arg2 endOpacity:(float*)arg3 timeRange:(SCD_Struct_CM6*)arg4 ;
-(char)getCropRectangleRampForTime:(SCD_Struct_CM5)arg1 startCropRectangle:(CGRect*)arg2 endCropRectangle:(CGRect*)arg3 timeRange:(SCD_Struct_CM6*)arg4 ;
-(int)trackID;
