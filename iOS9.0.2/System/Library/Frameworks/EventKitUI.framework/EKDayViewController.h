...
@property (assign,nonatomic) char scrollEventsInToViewIgnoresVisibility; 
...
@property (assign,nonatomic) char transitionedToSameDay;                                       //@synthesize transitionedToSameDay=_transitionedToSameDay - In the implementation block
...
-(void)scrollDayViewAppropriatelyWithAnimation:(char)arg1 ;
-(void)_relayoutDays;
...
-(char)_shouldScrollToNow;
-(char)_canScrollToNow;
-(char)_shouldRespondToApplicationDidBecomeActiveStateChange;
-(char)_isCurrentDayToday;
...
-(void)setTransitionedToSameDay:(char)arg1 ;
...
-(char)_canShowNowAfterScrollViewDidEndDecelerating:(id)arg1 ;
-(double)_showNowDelay;
-(void)_showNowTimerFired:(id)arg1 ;
-(char)transitionedToSameDay;
