...
@interface EKDayView : UIView <UIScrollViewDelegate, EKDayAllDayViewDelegate, EKDayViewContentDelegate, EKDayTimeViewDelegate> {
	...
	char _isNowVisible;
	char _scrollEventsInToViewIgnoresVisibility;
...
@property (assign,nonatomic) float verticalContentInset;                              //@synthesize verticalContentInset=_verticalContentInset - In the implementation block
@property (assign,nonatomic) char isNowVisible;                                       //@synthesize isNowVisible=_isNowVisible - In the implementation block
@property (assign,nonatomic) char scrollEventsInToViewIgnoresVisibility;              //@synthesize scrollEventsInToViewIgnoresVisibility=_scrollEventsInToViewIgnoresVisibility - In the implementation block
...
@property (assign,nonatomic) float todayScrollSecondBuffer;                           //@synthesize todayScrollSecondBuffer=_todayScrollSecondBuffer - In the implementation block
...
-(void)scrollToDate:(id)arg1 offset:(float)arg2 animated:(char)arg3 whenFinished:(/*^block*/id)arg4 ;
...
-(void)_scrollToSecond:(int)arg1 offset:(float)arg2 animated:(char)arg3 whenFinished:(/*^block*/id)arg4 ;
...
-(char)scrollEventsInToViewIgnoresVisibility;
-(void)setScrollEventsInToViewIgnoresVisibility:(char)arg1 ;
