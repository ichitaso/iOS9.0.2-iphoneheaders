...
@interface EKUIInviteeAlternativeTimeSearcher : NSObject {
	...
	unsigned _remainingSearchAttempts;
...
@property (assign,nonatomic) unsigned remainingSearchAttempts;                                          //@synthesize remainingSearchAttempts=_remainingSearchAttempts - In the implementation block
...
-(unsigned)remainingSearchAttempts;
...
-(void)setRemainingSearchAttempts:(unsigned)arg1 ;
-(id)stateChanged;
