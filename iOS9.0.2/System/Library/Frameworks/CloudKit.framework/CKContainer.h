...
@property (assign,nonatomic) char needsSandboxExtensions;                                        //@synthesize needsSandboxExtensions=_needsSandboxExtensions - In the implementation block
...
-(void)setNeedsSandboxExtensions:(char)arg1 ;
...
-(void)statusGroupsForApplicationPermission:(unsigned)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)setApplicationPermission:(unsigned)arg1 enabled:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)statusForApplicationPermission:(unsigned)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)requestApplicationPermission:(unsigned)arg1 completionHandler:(/*^block*/id)arg2 ;
