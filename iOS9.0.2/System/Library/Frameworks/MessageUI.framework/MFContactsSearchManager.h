...
@property (assign,nonatomic) unsigned autocompleteSearchType;                                            //@synthesize autocompleteSearchType=_autocompleteSearchType - In the implementation block
...
@property (assign,getter=isSimulatedResultsEnabled,nonatomic) char simulatedResultsEnabled;              //@synthesize simulatedResultsEnabled=_simulatedResultsEnabled - In the implementation block
...
-(void)setAutocompleteSearchType:(unsigned)arg1 ;
-(void)setSendingAccountIdentifier:(NSString *)arg1 ;
-(void)setSimulatedResultsEnabled:(char)arg1 ;
...
-(id)initWithAutocompleteSearchType:(unsigned)arg1 ;
