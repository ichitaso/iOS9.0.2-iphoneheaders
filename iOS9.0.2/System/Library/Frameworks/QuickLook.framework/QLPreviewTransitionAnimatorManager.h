...
@interface QLPreviewTransitionAnimatorManager : NSObject <UIViewControllerTransitioningDelegate, UINavigationControllerDelegate> {
	...
	char _transitionWantsStatusBar;

}

@property (assign) char transitionWantsStatusBar;                   //@synthesize transitionWantsStatusBar=_transitionWantsStatusBar - In the implementation block
@property (readonly) unsigned hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
+(id)sharedManager;
-(char)transitionWantsStatusBar;
-(void)setTransitionWantsStatusBar:(char)arg1 ;
