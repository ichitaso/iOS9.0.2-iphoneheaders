...
@property (assign,getter=isCancelling,nonatomic) char cancelling;                             //@synthesize cancelling=_cancelling - In the implementation block
