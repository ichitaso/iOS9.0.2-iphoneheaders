...
+(char)_validatePredicate:(id)arg1 ;
+(id)_rewritePredicateForDaemon:(id)arg1 characteristicIsInvalid:(char*)arg2 ;
+(id)predicateForEvaluatingTriggerWithCharacteristic:(id)arg1 relatedBy:(unsigned)arg2 toValue:(id)arg3 ;
