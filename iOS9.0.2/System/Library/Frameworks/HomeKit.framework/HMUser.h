...
@property (assign,nonatomic) char administrator;                                      //@synthesize administrator=_administrator - In the implementation block
...
-(id)initWithUserID:(id)arg1 name:(id)arg2 uuid:(id)arg3 home:(id)arg4 isAdministrator:(char)arg5 ;
