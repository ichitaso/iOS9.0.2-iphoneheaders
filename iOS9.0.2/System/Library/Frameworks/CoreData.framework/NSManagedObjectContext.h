...
-(id)enumerateObjectsFromFetchRequest:(id)arg1 count:(unsigned*)arg2 usingDefaultBatchSizeWithBlock:(/*^block*/id)arg3 ;
-(void)pl_refresh;
-(id)enumerateObjectsFromFetchRequest:(id)arg1 count:(unsigned*)arg2 batchSize:(unsigned)arg3 usingBlock:(/*^block*/id)arg4 ;
-(id)enumerateWithIncrementalSaveUsingObjects:(id)arg1 shouldRefreshAfterSave:(char)arg2 withBlock:(/*^block*/id)arg3 ;
...
-(void)_managedObjectContextEditor:(id)arg1 didCommit:(char)arg2 contextInfo:(SCD_Struct_NS9*)arg3 ;
