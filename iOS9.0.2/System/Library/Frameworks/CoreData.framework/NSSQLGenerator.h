...
-(id)newSQLStatementForFetchRequest:(id)arg1 ignoreInheritance:(char)arg2 countOnly:(char)arg3 nestingLevel:(unsigned)arg4 nestIsWhereScoped:(char)arg5 ;
...
-(id)initializeContextForFetchRequest:(id)arg1 ignoreInheritance:(char)arg2 nestingLevel:(unsigned)arg3 nestIsWhereScoped:(char)arg4 ;
...
-(id)newSQLStatementForRequest:(id)arg1 ignoreInheritance:(char)arg2 countOnly:(char)arg3 nestingLevel:(unsigned)arg4 nestIsWhereScoped:(char)arg5 ;
@end
