...
-(long)encodeWithComputeEncoder:(id)arg1 commandBuffer:(id)arg2 primaryTexture:(id)arg3 secondaryTexture:(id)arg4 destinationTexture:(id)arg5 callInfo:(const SCD_Struct_MP11*)arg6 ;
