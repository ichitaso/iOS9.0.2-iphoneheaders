...
-(void)_setState:(int)arg1 notify:(char)arg2 ;
-(void)_validatePreconditionsWhileRetrievingRemoteCredentials:(char)arg1 withCompletion:(/*^block*/id)arg2 ;
-(id)displayableErrorForError:(id)arg1 ;
-(void)_registerWhileRetrievingRemoteCredentials:(char)arg1 withCompletion:(/*^block*/id)arg2 ;
...
-(void)paymentWebService:(id)arg1 didQueueTSMConnectionForTaskID:(unsigned)arg2 ;
-(void)paymentWebService:(id)arg1 didCompleteTSMConnectionForTaskID:(unsigned)arg2 ;
