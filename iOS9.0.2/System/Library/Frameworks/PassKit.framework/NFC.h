...
+(void)insertNFCPayload:(id)arg1 forPass:(id)arg2 inDatabase:(id)arg3 ;
+(id)anyInDatabase:(id)arg1 forPassPID:(unsigned long long)arg2 ;
+(id)_predicateForPassPID:(long long)arg1 ;
+(id)_predicateForPass:(id)arg1 ;
+(id)_propertySettersForNFC;
+(id)databaseTable;
+(id)associationPropertyForEntityClass:(Class)arg1 ;
-(id)initWithNFCPayload:(id)arg1 pass:(id)arg2 inDatabase:(id)arg3 ;
-(id)nfcPayload;
@end
