...
@property (readonly) char willShowCompleteVerificationButton; 
...
-(id)_bankAppName;
-(id)_bankAppStoreIDs;
-(void)_requestDelegatePresentationOfViewController:(id)arg1 wrapWithPortraitNavigationController:(char)arg2 ;
...
-(char)willShowCompleteVerificationButton;
