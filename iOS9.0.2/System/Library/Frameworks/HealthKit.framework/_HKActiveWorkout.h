...
+(id)_workoutWithActivityType:(unsigned)arg1 startDate:(id)arg2 endDate:(id)arg3 workoutEvents:(id)arg4 duration:(double)arg5 totalActiveEnergyBurned:(id)arg6 totalBasalEnergyBurned:(id)arg7 totalDistance:(id)arg8 goalType:(unsigned)arg9 goal:(id)arg10 shouldUseDeviceData:(char)arg11 metadata:(id)arg12 ;
+(id)_clientInterface;
+(id)_serverInterface;
