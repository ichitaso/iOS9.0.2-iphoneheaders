...
-(void)deliverResultsResetWithAnchor:(id)arg1 final:(char)arg2 forQuery:(id)arg3 ;
-(void)deliverSampleBatch:(id)arg1 deletedBatch:(id)arg2 final:(char)arg3 anchor:(id)arg4 forQuery:(id)arg5 ;
