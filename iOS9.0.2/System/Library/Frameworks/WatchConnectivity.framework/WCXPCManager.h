...
@property (assign) char connectionInvalidated;                            //@synthesize connectionInvalidated=_connectionInvalidated - In the implementation block
...
-(char)connectionInvalidated;
-(void)onqueue_reconnect;
-(void)handleSessionStateChanged:(id)arg1 forceReachableChanged:(char)arg2 ;
-(void)setConnectionInvalidated:(char)arg1 ;
