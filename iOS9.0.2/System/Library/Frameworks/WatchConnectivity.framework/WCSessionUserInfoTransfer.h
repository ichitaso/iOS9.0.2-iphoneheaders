...
@property (assign,getter=isCurrentComplicationInfo,nonatomic) char currentComplicationInfo;              //@synthesize currentComplicationInfo=_currentComplicationInfo - In the implementation block
@property (nonatomic,copy,readonly) NSDictionary * userInfo; 
@property (assign,getter=isTransferring,nonatomic) char transferring;                                    //@synthesize transferring=_transferring - In the implementation block
...
-(id)initWithTranferIdentifier:(id)arg1 complicationTransferIdentifier:(id)arg2 currentComplication:(char)arg3 ;
-(char)updateUserInfoData:(id)arg1 error:(id*)arg2 ;
-(WCUserInfo *)userInfoStorage;
-(char)updateUserInfo:(id)arg1 error:(id*)arg2 ;
-(char)verifyUserInfo;
-(char)isCurrentComplicationInfo;
-(char)isTransferring;
-(id)initWithComplicationTransferIdentifier:(id)arg1 ;
-(id)initWithProtoBufFileURL:(id)arg1 ;
-(id)protobufData;
-(void)setCurrentComplicationInfo:(char)arg1 ;
-(void)setTransferring:(char)arg1 ;
