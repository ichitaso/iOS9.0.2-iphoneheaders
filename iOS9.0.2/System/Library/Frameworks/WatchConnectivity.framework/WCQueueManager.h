...
@property (assign) char messageOutstanding;                             //@synthesize messageOutstanding=_messageOutstanding - In the implementation block
...
-(char)messageOutstanding;
-(id)onqueue_peekMessage;
-(NSMutableDictionary *)inFlightMessages;
-(void)setMessageOutstanding:(char)arg1 ;
-(void)onqueue_handleAcceptanceWithCurrentAccepted:(char)arg1 nextAvailable:(char)arg2 ;
