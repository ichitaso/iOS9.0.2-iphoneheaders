...
@interface WCSession : NSObject <WCXPCManagerDelegate> {
	...
	char _paired;
	char _watchAppInstalled;
	char _complicationEnabled;
	char _reachable;
	char _iOSDeviceNeedsUnlockAfterRebootForReachability;
	char _sessionActivated;
	char _delegateQueueSuspended;
	char _shouldSuspendDelegateQueue;
...
@property (assign,getter=isWatchAppInstalled,nonatomic) char watchAppInstalled;                       //@synthesize watchAppInstalled=_watchAppInstalled - In the implementation block
@property (assign,getter=isComplicationEnabled,nonatomic) char complicationEnabled;                   //@synthesize complicationEnabled=_complicationEnabled - In the implementation block
...
@property (assign,nonatomic) char iOSDeviceNeedsUnlockAfterRebootForReachability;                     //@synthesize iOSDeviceNeedsUnlockAfterRebootForReachability=_iOSDeviceNeedsUnlockAfterRebootForReachability - In the implementation block
...
@property (assign) char sessionActivated;                                                             //@synthesize sessionActivated=_sessionActivated - In the implementation block
...
@property (assign) char delegateQueueSuspended;                                                       //@synthesize delegateQueueSuspended=_delegateQueueSuspended - In the implementation block
@property (assign) char shouldSuspendDelegateQueue;                                                   //@synthesize shouldSuspendDelegateQueue=_shouldSuspendDelegateQueue - In the implementation block
...
-(char)sessionActivated;
-(void)setSessionActivated:(char)arg1 ;
...
-(void)setWatchAppInstalled:(char)arg1 ;
-(void)setComplicationEnabled:(char)arg1 ;
...
-(char)logAndTestIfUnactivatedOrMissingDelegate;
...
-(void)onqueue_sendMessageData:(id)arg1 replyHandler:(/*^block*/id)arg2 errorHandler:(/*^block*/id)arg3 dictionaryMessage:(char)arg4 ;
...
-(void)onqueue_sendResponseData:(id)arg1 identifier:(id)arg2 dictionaryMessage:(char)arg3 ;
-(void)_onqueue_sendResponseError:(id)arg1 identifier:(id)arg2 dictionaryMessage:(char)arg3 ;
...
-(char)verifySessionFile:(id)arg1 ;
-(void)onqueue_cancelMessagesIfNeeded;
-(void)didSessionStateChange:(id)arg1 forceReachableChanged:(char)arg2 withChangeHandler:(/*^block*/id)arg3 ;
-(char)didPairingIDChange:(id)arg1 ;
-(char)didWatchURLChange:(id)arg1 ;
...
-(char)updateApplicationContext:(id)arg1 error:(id*)arg2 ;
...
-(char)iOSDeviceNeedsUnlockAfterRebootForReachability;
-(void)setIOSDeviceNeedsUnlockAfterRebootForReachability:(char)arg1 ;
...
-(char)delegateQueueSuspended;
-(void)setDelegateQueueSuspended:(char)arg1 ;
-(char)shouldSuspendDelegateQueue;
-(void)setShouldSuspendDelegateQueue:(char)arg1 ;
-(NSString *)pairingID;
