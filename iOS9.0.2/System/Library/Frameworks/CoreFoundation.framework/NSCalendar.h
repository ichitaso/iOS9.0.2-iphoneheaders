...
-(id)_maps_dateStringForDate:(id)arg1 withStyle:(unsigned)arg2 useRelativeFormatting:(char)arg3 inTimeZone:(id)arg4 ;
-(char)_maps_isDateInTomorrow:(id)arg1 inTimeZone:(id)arg2 ;
...
-(unsigned)bs_dayPeriodForDate:(id)arg1 inLocale:(id)arg2 ;
...
-(SCD_Struct_NS15)_minimumRangeOfUnit:(unsigned)arg1 ;
-(SCD_Struct_NS15)_maximumRangeOfUnit:(unsigned)arg1 ;
-(SCD_Struct_NS15)_rangeOfUnit:(unsigned)arg1 inUnit:(unsigned)arg2 forAT:(double)arg3 ;
