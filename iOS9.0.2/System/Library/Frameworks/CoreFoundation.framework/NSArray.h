...
@interface NSArray : NSObject <CKRecordValue, CSCoderEncoder, NSCopying, NSMutableCopying, NSSecureCoding, NSFastEnumeration>
...
@property (nonatomic,readonly) char isQueryResultSetInvalidated; 
...
+(id)safari_arrayWithPropertyListData:(id)arg1 options:(unsigned)arg2 ;
...
-(char)naui_any:(/*^block*/id)arg1 ;
-(char)naui_all:(/*^block*/id)arg1 ;
-(id)naui_firstObjectPassingTest:(/*^block*/id)arg1 ;
-(char)ck_containsObjectIdenticalTo:(id)arg1 ;
...
-(id)safari_numberAtIndex:(unsigned)arg1 ;
-(id)safari_dictionaryAtIndex:(unsigned)arg1 ;
-(id)safari_mapObjectsUsingBlock:(/*^block*/id)arg1 ;
-(id)safari_arrayAtIndex:(unsigned)arg1 ;
-(id)safari_stringAtIndex:(unsigned)arg1 ;
-(id)safari_mapAndFilterObjectsUsingBlock:(/*^block*/id)arg1 ;
-(id)safari_mapAndFilterObjectsWithOptions:(unsigned)arg1 usingBlock:(/*^block*/id)arg2 ;
...
-(unsigned)countObjectsPassingTest:(/*^block*/id)arg1 ;
...
-(id)objectsPassingTest:(/*^block*/id)arg1 ;
-(char)containsObjectPassingTest:(/*^block*/id)arg1 ;
-(id)objectPassingTest:(/*^block*/id)arg1 ;
-(id)objectsOfClass:(Class)arg1 ;
-(id)arrayByGroupingIntoArraysWithMaxCount:(unsigned)arg1 ;
-(id)allObjectsWithClass:(Class)arg1 ;
...
-(id)_cn_tail;
-(id)_cn_take:(unsigned)arg1 ;
-(id)_cn_flatMap:(/*^block*/id)arg1 ;
-(id)_cn_distinctObjects;
-(id)_cn_partition:(/*^block*/id)arg1 ;
-(unsigned)_cn_indexOfFirstObjectPassingTest:(/*^block*/id)arg1 ;
...
-(char)axIsEqualToOrderedArray:(id)arg1 withPredicate:(/*^block*/id)arg2 ;
