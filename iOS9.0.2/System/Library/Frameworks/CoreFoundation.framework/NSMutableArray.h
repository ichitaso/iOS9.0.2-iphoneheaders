...
-(void)pl_valuesChanged:(char)arg1 forKey:(CFStringRef)arg2 ;
...
-(void)_mapkit_sortUsingDistanceFromCoordinate:(SCD_Struct_NS20)arg1 ascending:(char)arg2 ;
...
-(void)_mapkit_sortUsingDistanceFromCoordinate:(SCD_Struct_NS20)arg1 ;
-(void)_cn_addNonNilObject:(id)arg1 ;
-(id)_cn_popObject;
-(void)_cn_addObject:(id)arg1 orPlaceholder:(id)arg2 ;
-(void)_cn_insertNonNilObject:(id)arg1 atIndex:(unsigned)arg2 ;
