...
@property (nonatomic,readonly) char isToday; 
@property (nonatomic,readonly) char isYesterday; 
...
-(char)isEarlierThanDate:(id)arg1 ;
-(char)isLaterThanDate:(id)arg1 ;
-(char)isToday;
-(char)isYesterday;
...
-(char)isSameWeekAsDate:(id)arg1 inCalendar:(id)arg2 ;
...
-(id)dateForEndOfDayInTimeZone:(id)arg1 ;
-(id)dateAtHour:(unsigned)arg1 minute:(unsigned)arg2 second:(unsigned)arg3 inTimeZone:(id)arg4 ;
