...
-(void)runPeriodicMaintenanceTasks:(id)arg1 connection:(id)arg2 ;
...
-(id)_startCPLDownloadForAsset:(id)arg1 resourceType:(unsigned)arg2 masterResourceOnly:(char)arg3 highPriority:(char)arg4 track:(char)arg5 notify:(char)arg6 doneToken:(id)arg7 ;
