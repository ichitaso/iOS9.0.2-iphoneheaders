...
@interface _SFWebProcessPlugInReaderEnabledPageController : WBUWebProcessPlugInAutoFillPageController <SFReaderWebProcessControllerProtocol> {
	...
	char _viewingReadingListArchive;
...
@property (assign,nonatomic) int cachedReaderTopScrollOffset;                                                  //@synthesize cachedReaderTopScrollOffset=_cachedReaderTopScrollOffset - In the implementation block
...
@property (nonatomic,readonly) float readerUserVisibleWidth;                                                   //@synthesize readerUserVisibleWidth=_readerUserVisibleWidth - In the implementation block
@property (getter=isViewingReadingListArchive,nonatomic,readonly) char viewingReadingListArchive;              //@synthesize viewingReadingListArchive=_viewingReadingListArchive - In the implementation block
...
-(void)setReaderInitialTopScrollOffset:(int)arg1 configuration:(id)arg2 userVisibleWidth:(double)arg3 isViewingArchive:(char)arg4 ;
