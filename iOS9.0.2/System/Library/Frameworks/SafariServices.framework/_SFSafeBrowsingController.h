...
@interface _SFSafeBrowsingController : NSObject <_SFSafeBrowsingWarningResponseObserver> {
	...
	unsigned _safeBrowsingCheckSeed;
...
@property (getter=isShowingSecurityWarningPage,nonatomic,readonly) char showingSecurityWarningPage;              //@synthesize showingSecurityWarningPage=_showingSecurityWarningPage - In the implementation block
@property (getter=isLoadingSecurityWarningPage,nonatomic,readonly) char loadingSecurityWarningPage;              //@synthesize loadingSecurityWarningPage=_loadingSecurityWarningPage - In the implementation block
...
-(char)isLoadingSecurityWarningPage;
