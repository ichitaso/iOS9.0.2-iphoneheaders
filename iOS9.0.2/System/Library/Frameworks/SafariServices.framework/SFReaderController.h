...
@property (getter=isReaderAvailable) char readerAvailable;               //@synthesize readerAvailable=_readerAvailable - In the implementation block
...
-(void)setReaderAvailable:(char)arg1 ;
