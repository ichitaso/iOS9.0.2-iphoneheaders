...
@property (assign,nonatomic) char idleTimerNeedsReset;                                            //@synthesize idleTimerNeedsReset=_idleTimerNeedsReset - In the implementation block
...
-(void)controllerWithUDID:(unsigned)arg1 setData:(id)arg2 ;
-(void)controllerWithUDID:(unsigned)arg1 setValue:(float)arg2 forElement:(int)arg3 ;
-(void)controllerWithUDID:(unsigned)arg1 setArrayValue:(SCD_Struct_GC4)arg2 forElement:(int)arg3 ;
...
-(char)idleTimerNeedsReset;
-(void)setIdleTimerNeedsReset:(char)arg1 ;
