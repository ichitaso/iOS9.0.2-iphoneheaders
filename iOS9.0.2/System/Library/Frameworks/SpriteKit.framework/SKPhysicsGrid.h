...
-(void)spritesFromGrid:(id)arg1 gridSize:(CGSize)arg2 zPosition:(float)arg3 edgeColor:(id)arg4 interiorColor:(id)arg5 spriteSize:(CGSize)arg6 physicsBody:(id)arg7 ;
-(void)spritesFromGrid:(id)arg1 xDivisions:(int)arg2 zPosition:(float)arg3 spriteSize:(CGSize)arg4 texture:(id)arg5 physicsBody:(id)arg6 ;
-(float)width;
-(float)height;
@end
