...
@property (assign,nonatomic) unsigned particleRenderOrder;                                       //@synthesize particleRenderOrder=_particleRenderOrder - In the implementation block
...
-(void)setWantsNewParticles:(char)arg1 ;
...
-(unsigned)particleRenderOrder;
-(void)setParticleRenderOrder:(unsigned)arg1 ;
