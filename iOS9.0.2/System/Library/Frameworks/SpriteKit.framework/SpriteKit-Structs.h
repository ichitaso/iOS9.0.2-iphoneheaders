...
typedef struct SKCStats {
	...
	double currentTime;
	int frameCount;
	SCD_Struct_SK39 clientUpdate;
	SCD_Struct_SK39 update;
	SCD_Struct_SK40 physics;
	SCD_Struct_SK40 constraints;
	SCD_Struct_SK41 render;
} SKCStats;
...
typedef union GLKVector3 {
	SCD_Struct_SK51 field1;
	SCD_Struct_SK51 field2;
	SCD_Struct_SK51 field3;
	float v[3];
} GLKVector3;
...
typedef union GLKVector4 {
	SCD_Struct_SK53 field1;
	SCD_Struct_SK53 field2;
	SCD_Struct_SK53 field3;
	float v[4];
} GLKVector4;
