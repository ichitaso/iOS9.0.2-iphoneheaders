...
-(void)dd_makeLinksForResultsInAttributesOfType:(unsigned)arg1 usingURLificationBlock:(/*^block*/id)arg2 context:(id)arg3 ;
-(void)dd_replaceResultAttributesWithSimpleLinksForTypes:(unsigned)arg1 context:(id)arg2 ;
