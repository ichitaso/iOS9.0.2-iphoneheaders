...
-(void)_makeProvider:(id)arg1 provideItemAtURL:(id)arg2 recursively:(char)arg3 forAccessClaimWithID:(id)arg4 processIdentifier:(int)arg5 completionHandler:(/*^block*/id)arg6 ;
