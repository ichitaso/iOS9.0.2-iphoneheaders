...
-(char)containsAttribute:(id)arg1 ;
-(id)dd_contextAtLocation:(int)arg1 ;
-(_DDResult*)dd_resultAtLocation:(int)arg1 ;
...
-(void)drawWithRect:(CGRect)arg1 options:(int)arg2 ;
-(CGRect)boundingRectWithSize:(CGSize)arg1 options:(int)arg2 ;
-(CGSize)size;
...
-(NSRange)_rangeOfTextTableRow:(id)arg1 atIndex:(unsigned)arg2 completeRow:(char*)arg3 ;
-(NSRange)_rangeOfTextTableRow:(id)arg1 atIndex:(unsigned)arg2 ;
-(char)_isStringDrawingTextStorage;
-(unsigned)_lineBreakBeforeIndex:(unsigned)arg1 withinRange:(NSRange)arg2 usesAlternativeBreaker:(char)arg3 ;
-(unsigned)lineBreakByHyphenatingBeforeIndex:(unsigned)arg1 withinRange:(NSRange)arg2 ;
-(unsigned)nextWordFromIndex:(unsigned)arg1 forward:(char)arg2 ;
-(NSRange)doubleClickAtIndex:(unsigned)arg1 inRange:(NSRange)arg2 ;
-(char)containsAttachmentsInRange:(NSRange)arg1 ;
...
-(char)_atStartOfTextTable:(id)arg1 atIndex:(unsigned)arg2 ;
-(char)_atEndOfTextTable:(id)arg1 atIndex:(unsigned)arg2 ;
-(char)_atStartOfTextTableRow:(id)arg1 atIndex:(unsigned)arg2 ;
-(char)_atEndOfTextTableRow:(id)arg1 atIndex:(unsigned)arg2 ;
...
-(char)_scrcHasPauseCommaAtIndex:(unsigned)arg1 ;
