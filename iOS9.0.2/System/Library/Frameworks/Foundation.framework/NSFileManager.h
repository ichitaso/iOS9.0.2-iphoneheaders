...
-(char)br_movePromisedItemAtURL:(id)arg1 toURL:(id)arg2 error:(id*)arg3 ;
...
-(char)createDirectoryIfNeededAtPath:(id)arg1 error:(id*)arg2 ;
-(char)directoryExistsAtPath:(id)arg1 ;
-(id)tmpFileForVideoTranscodeToPhotoDataDirectory:(char)arg1 withExtension:(id)arg2 ;
