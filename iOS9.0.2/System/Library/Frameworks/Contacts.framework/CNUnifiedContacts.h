...
+(unsigned)indexOfPreferredContactForUnifying:(id)arg1 includingMainStoreContacts:(char)arg2 ;
+(id)unifyContactsSortedByPreference:(id)arg1 includingMainStoreContacts:(char)arg2 ;
...
+(unsigned)indexOfPreferredContactForImage:(id)arg1 ;
...
+(void)replaceInferiorValueInMultiValue:(id)arg1 withEntryAtIndex:(unsigned)arg2 fromMultiValue:(id)arg3 forProperty:(id)arg4 ;
...
+(unsigned)countOfLabel:(id)arg1 value:(id)arg2 inMultiValue:(id)arg3 forProperty:(id)arg4 ;
+(unsigned)countOfLabelIncludingEquivalents:(id)arg1 value:(id)arg2 inMultiValue:(id)arg3 forProperty:(id)arg4 ;
+(unsigned)countOfLabelsEquivalentTo:(id)arg1 valuesEquivalentTo:(id)arg2 inMultiValue:(id)arg3 forProperty:(id)arg4 ;
...
+(unsigned)indexOfValueMostInferiorTo:(id)arg1 inMultiValue:(id)arg2 forProperty:(id)arg3 ;
