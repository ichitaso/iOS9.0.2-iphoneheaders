...
@property (assign,nonatomic) char automaticLocationGeocodingAllowed; 
...
-(void)setAutomaticLocationGeocodingAllowed:(char)arg1 ;
-(id)localSource;
-(id)ownedSources;
...
-(char)removeResourceChangesForCalendarItem:(id)arg1 error:(id*)arg2 ;
...
-(void)cacheValidationStatusForEmail:(id)arg1 status:(unsigned)arg2 ;
-(unsigned)emailAddressValidationStatus:(id)arg1 ;
