...
@property (assign,nonatomic) unsigned shareeStatus; 
@property (assign,nonatomic) unsigned shareeAccessLevel; 
...
-(void)setShareeStatus:(unsigned)arg1 ;
-(id)_persistentSharee;
-(NSString *)externalID;
-(unsigned)shareeStatus;
-(unsigned)shareeAccessLevel;
-(id)initWithEmailAddress:(id)arg1 name:(id)arg2 ;
-(void*)ABRecordWithAddressBook:(void*)arg1 ;
-(void)setShareeAccessLevel:(unsigned)arg1 ;
-(NSString *)firstName;
-(NSString *)lastName;
-(id)init;
