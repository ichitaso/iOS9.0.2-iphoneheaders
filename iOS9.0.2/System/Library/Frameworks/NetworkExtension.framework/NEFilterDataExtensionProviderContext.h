...
@property (assign) char controlProviderExists;                               //@synthesize controlProviderExists=_controlProviderExists - In the implementation block
...
-(void)setControlProviderExists:(char)arg1 ;
...
-(char)socketContentFilterWriteMessageWithControlSocket:(int)arg1 socketID:(unsigned long long)arg2 drop:(char)arg3 inboundPassOffset:(unsigned long long)arg4 inboundPeekOffset:(unsigned long long)arg5 outboundPassOffset:(unsigned long long)arg6 outboundPeekOffset:(unsigned long long)arg7 ;
