...
@property (assign,nonatomic) char shouldIgnoreImage;                           //@synthesize shouldIgnoreImage=_shouldIgnoreImage - In the implementation block
...
-(void)setShouldIgnoreImage:(char)arg1 ;
