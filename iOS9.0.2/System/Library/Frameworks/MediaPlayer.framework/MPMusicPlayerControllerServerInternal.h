...
+(char)_canSeedGeniusWithItem:(id)arg1 ;
...
-(char)_clientPIDHasPermissionToPlay:(int)arg1 ;
...
-(void)_registerClientPort:(unsigned)arg1 forProcessID:(int)arg2 hasAudioBackgroundMode:(char)arg3 ;
-(void)_setQueuePrepared:(char)arg1 ;
