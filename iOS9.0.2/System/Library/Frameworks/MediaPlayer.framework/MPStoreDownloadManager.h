...
-(void)_sendDownloadsDidFinishToObserversForDownloads:(id)arg1 notifyDownloadManager:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(char)_onQueue_hasExistingDownloadForStoreDownload:(id)arg1 ;
