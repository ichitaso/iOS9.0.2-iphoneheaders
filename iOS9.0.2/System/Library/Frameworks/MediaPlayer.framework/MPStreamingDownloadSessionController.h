...
@interface MPStreamingDownloadSessionController : NSObject {
	...
	unsigned _pausingAllDownloadsTransactionCount;
...
-(void)_unregisterDownloadSession:(id)arg1 withAssetDownloadSession:(id)arg2 playbackItemMetadata:(id)arg3 returningWasLastAssociatedDownloadSession:(char*)arg4 ;
...
-(id)_preferredAssetFlavorsForAssetQuality:(unsigned)arg1 ;
-(id)_newDownloadSessionForPlaybackItemMetadata:(id)arg1 sourceURL:(id)arg2 downloadKey:(id)arg3 sinfs:(id)arg4 pathExtension:(id)arg5 assetFlavor:(id)arg6 protectionType:(unsigned)arg7 returningAssetDownloadSession:(id*)arg8 ;
...
-(unsigned)_assetQualityForAssetFlavor:(id)arg1 ;
