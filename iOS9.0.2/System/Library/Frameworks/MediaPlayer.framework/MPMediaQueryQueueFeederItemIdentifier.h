...
@property (nonatomic,readonly) unsigned repeatIndex;                             //@synthesize repeatIndex=_repeatIndex - In the implementation block
@property (readonly) unsigned hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
+(char)supportsSecureCoding;
-(id)initWithMediaItem:(id)arg1 repeatIndex:(unsigned)arg2 feederRevisionID:(unsigned long long)arg3 ;
