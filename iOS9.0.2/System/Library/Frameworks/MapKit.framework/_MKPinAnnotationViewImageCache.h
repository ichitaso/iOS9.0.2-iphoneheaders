...
-(id)pinsWithMapType:(unsigned)arg1 displayStyle:(unsigned)arg2 pinColor:(id)arg3 traits:(id)arg4 ;
-(void)setPins:(id)arg1 forMapType:(unsigned)arg2 displayStyle:(unsigned)arg3 pinColor:(id)arg4 traits:(id)arg5 ;
-(id)init;
@end
