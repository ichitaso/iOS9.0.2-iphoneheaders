...
@property (assign,nonatomic) char hasLoadedFullPhoto;                //@synthesize hasLoadedFullPhoto=_hasLoadedFullPhoto - In the implementation block
...
-(char)hasLoadedFullPhoto;
-(void)setHasLoadedFullPhoto:(char)arg1 ;
