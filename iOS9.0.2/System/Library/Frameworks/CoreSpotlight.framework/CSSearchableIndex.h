...
-(/*^block*/id)_registerCompletionBlock:(/*^block*/id)arg1 label:(id)arg2 throttle:(char)arg3 ;
...
-(void)_changeStateOfSearchableItemsWithUIDs:(id)arg1 toState:(int)arg2 forUser:(unsigned)arg3 forBundleID:(id)arg4 forUTIType:(id)arg5 ;
