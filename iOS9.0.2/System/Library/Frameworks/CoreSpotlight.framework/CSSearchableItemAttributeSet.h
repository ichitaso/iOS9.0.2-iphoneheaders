...
@class NSDictionary, NSString, NSMutableDictionary, CSDecoder, NSArray, NSNumber, NSDate;
...
@property (assign) int searchableItemFlags;                                                  //@synthesize searchableItemFlags=_searchableItemFlags - In the implementation block
...
-(void)_setOrRemoveValue:(id)arg1 forKey:(id)arg2 copy:(char)arg3 ;
