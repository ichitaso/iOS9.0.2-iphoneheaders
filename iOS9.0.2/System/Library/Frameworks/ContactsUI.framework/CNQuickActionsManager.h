...
@interface CNQuickActionsManager : NSObject <CNQuickContactActionDelegate> {
	...
	NSArray* _categories;
	int _mode;
	unsigned _desiredNumberOfActions;
...
@property (assign,nonatomic) unsigned desiredNumberOfActions;                                //@synthesize desiredNumberOfActions=_desiredNumberOfActions - In the implementation block
...
@property (assign,nonatomic) char sortsWithDuet; 
...
-(char)sortsWithDuet;
-(id)_hierarchicalActionsForCategory:(id)arg1 fromActions:(id)arg2 askDelegate:(char)arg3 ;
-(char)_shouldGroupActionsInCategory:(id)arg1 ;
-(unsigned)desiredNumberOfActions;
-(id)_ignoredLabels;
-(id)_orderedLabels;
...
-(void)refreshActionsAndForceSendUpdate:(char)arg1 ;
...
-(id)_expandedActionsFromOrderedActionsByCategories:(id)arg1 totalNumberOfActions:(unsigned)arg2 ;
-(id)_hybridActionsFromOrderedActionsByCategories:(id)arg1 totalNumberOfActions:(unsigned)arg2 ;
...
-(id)quickActions;
-(void)setDesiredNumberOfActions:(unsigned)arg1 ;
