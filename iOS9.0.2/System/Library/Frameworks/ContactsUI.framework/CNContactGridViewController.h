...
@property (assign,nonatomic) char inlineActionsEnabled;                                            //@synthesize inlineActionsEnabled=_inlineActionsEnabled - In the implementation block
...
@property (assign,nonatomic) int indexOfContactWithExpandedInlineActions; 
...
-(char)inlineActionsEnabled;
-(NSArray *)inlineActionsCategories;
-(NSIndexPath *)indexPathOfContactWithExpandedInlineActions;
-(void)setIndexPathOfContactWithExpandedInlineActions:(id)arg1 animated:(char)arg2 ;
-(void)setIndexOfContactWithExpandedInlineActions:(int)arg1 animated:(char)arg2 ;
...
-(void)setInlineActionsEnabled:(char)arg1 ;
