...
@property (assign,nonatomic) char allowsCustomItems;                                      //@synthesize allowsCustomItems=_allowsCustomItems - In the implementation block
...
-(void)setAllowsCustomItems:(char)arg1 ;
...
-(unsigned)_indexForCustomItemAtIndexPath:(id)arg1 ;
