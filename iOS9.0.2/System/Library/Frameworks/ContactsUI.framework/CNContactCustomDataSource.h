...
@interface CNContactCustomDataSource : NSObject <CNContactChangesObserver, CNContactDataSource> {
	...
	char _autoUpdateContacts;
	char _observingContacts;
...
@property (assign,nonatomic) char autoUpdateContacts;                                                      //@synthesize autoUpdateContacts=_autoUpdateContacts - In the implementation block
...
@property (assign,nonatomic) char observingContacts;                                                       //@synthesize observingContacts=_observingContacts - In the implementation block
...
-(void)setAutoUpdateContacts:(char)arg1 ;
...
-(char)autoUpdateContacts;
-(char)observingContacts;
-(void)setObservingContacts:(char)arg1 ;
-(char)canReload;
