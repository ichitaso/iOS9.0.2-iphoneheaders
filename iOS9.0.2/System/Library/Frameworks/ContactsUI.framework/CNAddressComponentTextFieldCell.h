...
@property (assign,nonatomic) char usesSplitTextFields;                                  //@synthesize usesSplitTextFields=_usesSplitTextFields - In the implementation block
