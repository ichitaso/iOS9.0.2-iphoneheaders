...
@interface CNContactListViewController : UITableViewController <CNAvatarCardControllerDelegate, CNContactDataSourceDelegate, UISearchControllerDelegate, UISearchResultsUpdating, UISearchBarDelegate, CNContactListBannerViewDelegate, CNContactPickerDelegate, CNContactViewControllerDelegate, UIGestureRecognizerDelegate> {
	...
	char _shouldRefreshMeContact;
	char _shouldDisplayMeContactBanner;
	char _shouldAutoHideMeContactBanner;
	char _allowsSearching;
	char _presentsSearchUI;
...
@property (assign,nonatomic) char shouldDisplayMeContactBanner;                                    //@synthesize shouldDisplayMeContactBanner=_shouldDisplayMeContactBanner - In the implementation block
@property (assign,nonatomic) char shouldAutoHideMeContactBanner;                                   //@synthesize shouldAutoHideMeContactBanner=_shouldAutoHideMeContactBanner - In the implementation block
...
@property (assign,nonatomic) char allowsSearching;                                                 //@synthesize allowsSearching=_allowsSearching - In the implementation block
...
@property (assign,nonatomic) char shouldRefreshMeContact;                                          //@synthesize shouldRefreshMeContact=_shouldRefreshMeContact - In the implementation block
@property (nonatomic,readonly) float contentOffsetDueToMeContactBanner;                            //@synthesize contentOffsetDueToMeContactBanner=_contentOffsetDueToMeContactBanner - In the implementation block
...
@property (nonatomic,readonly) char presentsSearchUI;                                              //@synthesize presentsSearchUI=_presentsSearchUI - In the implementation block
...
-(void)searchForString:(id)arg1 animated:(char)arg2 completionBlock:(/*^block*/id)arg3 ;
-(char)selectContact:(id)arg1 animated:(char)arg2 scrollPosition:(int)arg3 ;
-(void)reloadContacts;
-(id)initWithDataSource:(id)arg1 searchable:(char)arg2 ;
-(void)contactDataSourceDidChange:(id)arg1 ;
-(char)presentsSearchUI;
-(char)allowsSearching;
-(void)refreshMeContactAndMeContactBanner;
-(char)updateFrameAndDisplayNoContactsViewIfNeeded;
...
-(char)isContactWithIdentifierMeContactOrLinkedToMeContact:(id)arg1 ;
-(void)refreshMeContactBanner;
-(void)setShouldRefreshMeContact:(char)arg1 ;
-(char)shouldAutoHideMeContactBanner;
...
-(char)shouldRefreshMeContact;
-(void)setShouldAutoHideMeContactBanner:(char)arg1 ;
