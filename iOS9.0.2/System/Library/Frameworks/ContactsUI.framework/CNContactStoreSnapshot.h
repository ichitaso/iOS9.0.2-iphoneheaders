...
-(void)_loadContactsInRange:(NSRange)arg1 inBackground:(char)arg2 ;
-(void)_generateExcerptsInRange:(NSRange)arg1 ;
-(unsigned)countOf_contacts;
-(id)objectIn_contactsAtIndex:(unsigned)arg1 ;
