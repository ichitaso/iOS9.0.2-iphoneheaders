...
@interface SCNRenderContextMetal : SCNRenderContextImp <SCNBufferStream> {
	...
	char _currentPassIsMirrored;
	SCD_Struct_SC16 _currentStreamBufferIndices;
	NSMutableArray* _vertexVolatileBuffers[3];
	unsigned _vertexVolatileBufferIndex;
	unsigned _vertexVolatileBufferOffset;
	...
	unsigned _maxFrameConstantBufferIndex[3];
	unsigned _frameConstantBufferIndex;
	unsigned _frameConstantBufferOffset;
...
-(long)profile;
-(char)mapVolatileMesh:(_C3DMesh*)arg1 verticesCount:(int)arg2 ;
...
-(void)_setBuffer:(id)arg1 offset:(unsigned)arg2 atIndices:(SCD_Struct_SC16)arg3 ;
...
-(id)_renderTargetWithDescription:(SCD_Struct_SC21)arg1 size:(id)arg2 name:(int)arg3 ;
-(id)_finalRenderTexture;
-(char)_setupDescriptor:(id)arg1 forPass:(_C3DFXPass*)arg2 isFinalTechnique:(char)arg3 ;
-(void)_clearRenderCommanderEncoderCache;
-(void)__C3DFXContextDidApplyPass:(_C3DFXPass*)arg1 ;
-(char*)_allocateConstantBufferSize:(int)arg1 buffer:(id*)arg2 offset:(unsigned*)arg3 ;
-(void)_setVertexBuffers:(const id*)arg1 offsets:(const unsigned*)arg2 withRange:(NSRange)arg3 ;
-(void)setRasterizerStates:(C3DRasterizerStatesRef)arg1 ;
-(void)_setConstantBufferBytes:(void*)arg1 size:(int)arg2 atIndices:(SCD_Struct_SC16)arg3 ;
-(void)_setMeshBuffers:(id)arg1 ;
-(void)_drawMeshElement:(id)arg1 instanceCount:(unsigned)arg2 ;
...
-(void)_setZeroConstantBufferOfSize:(unsigned)arg1 atIndices:(SCD_Struct_SC16)arg2 ;
-(id)__reserveVolatileBufferForSize:(unsigned long)arg1 offset:(unsigned*)arg2 ;
-(id)_newMTLBufferFromPoolWithLength:(unsigned)arg1 ;
...
-(char)beginRenderPass:(_C3DFXPass*)arg1 isFinalTechnique:(char)arg2 ;
-(void)endRenderPass;
-(void)_logLightingInformation;
-(void)_setVertexBuffer:(id)arg1 offset:(unsigned)arg2 atIndex:(unsigned)arg3 ;
-(void)_setFragmentBuffer:(id)arg1 offset:(unsigned)arg2 atIndex:(unsigned)arg3 ;
-(void)_setVertexTexture:(id)arg1 atIndex:(unsigned)arg2 ;
-(void)_setFragmentTexture:(id)arg1 atIndex:(unsigned)arg2 ;
...
-(_C3DMeshElement*)createVolatileMeshElementOfType:(char)arg1 primitiveCount:(int)arg2 bytesPerIndex:(int)arg3 ;
...
-(void)dealloc;
-(id<MTLDevice>)device;
-(void)writeBytes:(void*)arg1 length:(unsigned)arg2 ;
-(id)resourceManager;
