...
-(char)_appendToEntries:(id)arg1 entriesWithType:(unsigned long)arg2 passingTest:(/*^block*/id)arg3 entryObjectConstructor:(/*^block*/id)arg4 ;
-(id)identifiersOfEntriesWithClass:(Class)arg1 ;
-(int)countOfScenes;
-(id)sceneAtIndex:(unsigned)arg1 options:(id)arg2 ;
-(id)sceneAtIndex:(unsigned)arg1 options:(id)arg2 error:(id*)arg3 ;
