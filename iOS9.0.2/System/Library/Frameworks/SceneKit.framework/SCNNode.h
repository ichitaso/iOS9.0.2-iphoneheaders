...
-(unsigned)countOfParticleSystems;
-(id)objectInParticleSystemsAtIndex:(unsigned)arg1 ;
-(void)insertObject:(id)arg1 inParticleSystemsAtIndex:(unsigned)arg2 ;
-(void)removeObjectFromParticleSystemsAtIndex:(unsigned)arg1 ;
-(void)replaceObjectInParticleSystemsAtIndex:(unsigned)arg1 withObject:(id)arg2 ;
-(void)removeAllAudioPlayers;
-(void)removeAudioPlayer:(id)arg1 ;
-(unsigned)countOfAudioPlayers;
-(id)objectInAudioPlayersAtIndex:(unsigned)arg1 ;
-(void)insertObject:(id)arg1 inAudioPlayersAtIndex:(unsigned)arg2 ;
-(void)removeObjectFromAudioPlayersAtIndex:(unsigned)arg1 ;
-(void)replaceObjectInAudioPlayerAtIndex:(unsigned)arg1 withObject:(id)arg2 ;
