...
@class _UICascadingTextStorage, UIImage, UIView, UITextInputTraits, UIButton, UITextFieldBorderView, UITextFieldBackgroundView, UITextFieldLabel, UIImageView, UILabel, UITextInteractionAssistant, UITapGestureRecognizer, UIViewController, UITextFieldAtomBackgroundView, NSLayoutConstraint, _UIBaselineLayoutStrut, NSString, UIFont, NSAttributedString, MPUTextContainerContentSizeUpdater, NSDictionary, UIColor, UITextRange, UITextPosition;

@interface UITextField : UIControl <MPUAutoupdatingTextContainer, ABText, UIKeyboardInput, _UILayoutBaselineUpdating, UIGestureRecognizerDelegate, UIKeyInputPrivate, UITextInputTraits_Private, UIPopoverControllerDelegate, UITextInput, NSCoding> {
