...
@property (assign,nonatomic) SCD_Struct_UI37 styling; 
...
+(id)tokenForKey:(id)arg1 style:(SCD_Struct_UI37)arg2 ;
+(id)tokenForKeyMask:(id)arg1 style:(SCD_Struct_UI37)arg2 displayInsets:(UIEdgeInsets)arg3 ;
+(id)tokenForKey:(id)arg1 style:(SCD_Struct_UI37)arg2 displayInsets:(UIEdgeInsets)arg3 ;
