...
@class UIImageView, _UIStaticScrollBar, UIView, UIScrollViewPinchGestureRecognizer, UISwipeGestureRecognizer, NSISVariable, NSArray, UIPanGestureRecognizer, UIPinchGestureRecognizer, NSString;
...
@interface UIScrollView : UIView <UIGestureRecognizerDelegate, _UIScrollToTopView, NSCoding> {
	...
	struct {
		...
		unsigned delegateScrollViewAdjustedCentroid : 1;
	}  _scrollViewFlags;
...
@property (nonatomic,readonly) char pu_isBouncing; 
@property (nonatomic,readonly) char pu_isPerformingScrollTest; 
...
-(void)pu_scrollToEdge:(unsigned)arg1 animated:(char)arg2 ;
-(void)pu_scrollToContentOffset:(CGPoint)arg1 animated:(char)arg2 ;
-(void)pu_cancelScrollGesture;
-(char)pu_isPerformingScrollTest;
-(char)pu_isScrolledAtEdge:(unsigned)arg1 tolerance:(float)arg2 ;
-(void)pu_cancelScrollAnimation;
-(CGRect)pu_displayFrameForRect:(CGRect)arg1 ;
-(CGSize)pu_currentContentSize;
-(char)_pu_isScrolledAtEdge:(unsigned)arg1 tolerance:(float)arg2 ;
-(int)_pu_scrollableAxis;
-(char)pu_isScrolledBeyondEdge:(unsigned)arg1 ;
...
-(CGPoint)_adjustedCentroidForCentroid:(CGPoint)arg1 ;
