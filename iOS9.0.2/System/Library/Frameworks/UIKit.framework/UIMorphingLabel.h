...
@interface UIMorphingLabel : UIView {
	...
	UIView* _colorView;
	NSRange _memo[5151];
	SCD_Struct_UI94 _alignment[100];
...
-(unsigned)calculateHardAlignment:(SCD_Struct_UI95*)arg1 size:(unsigned)arg2 fromGlyphs:(const unsigned short*)arg3 count:(unsigned)arg4 toGlyphs:(const unsigned short*)arg5 count:(unsigned)arg6 ;
