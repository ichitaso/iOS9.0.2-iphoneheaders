...
@class UITraitCollection, UIImage, NSArray, UIColor;
...
-(id)pu_extractPlayOverlayBackgroundImageFromCenter:(CGPoint)arg1 asynchronously:(char)arg2 handler:(/*^block*/id)arg3 ;
