...
-(void)pu_popViewControllerAnimated:(char)arg1 interactive:(char)arg2 ;
-(void)pu_pushViewController:(id)arg1 withTransition:(id)arg2 animated:(char)arg3 isInteractive:(char)arg4 ;
-(id)pu_currentNavigationTransition;
-(void)pu_popToViewController:(id)arg1 animated:(char)arg2 interactive:(char)arg3 ;
...
-(char)pu_popToViewControllerIfAllowed:(id)arg1 animated:(char)arg2 forced:(char)arg3 ;
