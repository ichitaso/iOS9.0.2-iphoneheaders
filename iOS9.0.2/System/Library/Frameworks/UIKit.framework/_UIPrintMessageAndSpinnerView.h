...
@property (assign,nonatomic) char centeringConstraintsSet;                            //@synthesize centeringConstraintsSet=_centeringConstraintsSet - In the implementation block
...
-(char)centeringConstraintsSet;
-(void)setCenteringConstraintsSet:(char)arg1 ;
