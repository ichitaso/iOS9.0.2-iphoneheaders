...
@class NSString, _UIViewServiceInterface, _UIRemoteViewService, NSArray, _UIAsyncInvocation, _UISizeTrackingView, _UIRemoteView, _UITextEffectsRemoteView, UIView, NSError, UIActionSheet, _UITextServiceSession, UIDimmingView, BKSTouchDeliveryPolicyAssertion;
