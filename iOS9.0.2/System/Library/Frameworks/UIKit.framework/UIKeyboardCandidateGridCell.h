...
+(CGColorRef)legacy_outlineShadowColorForVisualStyling:(SCD_Struct_UI37)arg1 candidatesVisualStyle:(int)arg2 ;
+(CGColorRef)legacy_outlineColorForVisualStyling:(SCD_Struct_UI37)arg1 candidatesVisualStyle:(int)arg2 ;
