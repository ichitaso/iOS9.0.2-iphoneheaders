...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI66 _previousPoint;
...
@property (assign,nonatomic) SCD_Struct_UI65 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI65)arg1 ;
-(char)initialPointPosted;
-(SCD_Struct_UI65)previousPoint;
