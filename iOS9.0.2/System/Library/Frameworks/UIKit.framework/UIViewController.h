...
@interface UIViewController : UIResponder <GKContentRefresh, GKURLHandling, _UIViewServiceDeputy, NSExtensionRequestHandling, UIViewControllerPresenting, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, _UIFocusRegion, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment> {
	...
	SCD_Struct_UI32 _presentationSizeClassPair;
...
@property (assign,setter=pu_debugSetTransient:,nonatomic) char pu_debugIsTransient; 
...
@property (nonatomic,readonly) char pu_shouldActAsTabRootViewController; 
@property (nonatomic,readonly) int pu_preferredBarStyle; 
@property (nonatomic,readonly) char pu_wantsNavigationBarVisible; 
@property (nonatomic,readonly) char pu_wantsToolbarVisible; 
@property (nonatomic,readonly) char pu_wantsTabBarVisible; 
...
@property (nonatomic,readonly) char isPresentedInsidePopover; 
@property (assign,setter=music_setWantsSearchEntryRightBarButtonItem:,nonatomic) char music_wantsSearchEntryRightBarButtonItem; 
@property (nonatomic,readonly) UIBarButtonItem * music_searchEntryRightBarButtonItem; 
@property (assign,setter=music_setSearchOptions:,nonatomic) unsigned music_searchOptions; 
...
@property (assign,setter=music_setWantsAccountEntryLeftBarButtonItem:,nonatomic) char music_wantsAccountEntryLeftBarButtonItem; 
@property (nonatomic,readonly) UIBarButtonItem * music_accountEntryLeftBarButtonItem; 
@property (assign,setter=music_setWantsDefaultIndexBar:,nonatomic) char music_wantsDefaultIndexBar; 
@property (assign,setter=music_setWantsToOverrideRightBarButtonItem:,nonatomic) char music_wantsToOverrideRightBarButtonItem; 
@property (assign,nonatomic) int interstitialPresentationPolicy; 
@property (assign,nonatomic) char canDisplayBannerAds; 
@property (nonatomic,retain,readonly) UIView * originalContentView; 
@property (getter=isPresentingFullScreenAd,nonatomic,readonly) char presentingFullScreenAd; 
@property (getter=isDisplayingBannerAd,nonatomic,readonly) char displayingBannerAd; 
@property (nonatomic,readonly) char shouldPresentInterstitialAd; 
...
@property (nonatomic,readonly) SCD_Struct_UI32 __sizeClassPair; 
...
@property (assign,setter=_setPresentationSizeClassPair:,getter=_presentationSizeClassPair,nonatomic) SCD_Struct_UI32 presentationSizeClassPair;                                                    //@synthesize presentationSizeClassPair=_presentationSizeClassPair - In the implementation block
...
-(char)pu_debugIsTransient;
-(void)pu_debugSetTransient:(char)arg1 ;
-(void)pu_restoreNavigationTransition;
-(void)pu_removeNavigationTransition;
-(void)pu_dismissViewControllerAnimated:(char)arg1 interactive:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)pu_presentViewController:(id)arg1 transition:(id)arg2 animated:(char)arg3 interactive:(char)arg4 completion:(/*^block*/id)arg5 ;
...
-(char)pu_shouldActAsTabRootViewController;
-(char)pu_handleSecondTabTap;
-(id)pu_navigationController;
-(int)pu_preferredBarStyle;
-(void)pu_setupInitialBarsVisibilityOnViewWillAppearAnimated:(char)arg1 ;
-(void)pu_performBarsVisibilityUpdatesWithAnimationSettings:(PUBarAnimationSettings)arg1 ;
-(char)pu_wantsNavigationBarVisible;
-(char)pu_wantsToolbarVisible;
-(char)pu_wantsTabBarVisible;
-(char)pu_isViewVisible;
-(void)_pu_performBarsVisibilityUpdatesWithAnimationSettings:(PUBarAnimationSettings)arg1 isStatusBarHidden:(char)arg2 ;
...
-(void)_pu_setNavigationBarVisible:(char)arg1 withAnimationSettings:(PUBarAnimationSettings)arg2 ;
-(void)_pu_setTabBarVisible:(char)arg1 withAnimationSettings:(PUBarAnimationSettings)arg2 ;
-(void)_pu_setToolbarVisible:(char)arg1 withAnimationSettings:(PUBarAnimationSettings)arg2 ;
...
-(char)naui_isHorizontalSizeClassRegularOrGreater;
-(char)naui_isVerticalSizeClassRegularOrGreater;
-(char)naui_isDescendantOfViewController:(id)arg1 ;
-(void)naui_addChildViewWithViewController:(id)arg1 ;
-(char)naui_hasAxisWithRegularSizeClassOrGreater;
...
-(char)isPresentedInsidePopover;
-(void)dismissDetailViewController:(id)arg1 ;
-(id)music_furthestPresentingViewController;
-(void)music_dismissViewController:(id)arg1 animated:(char)arg2 ;
-(void)music_setSearchOptions:(unsigned)arg1 ;
-(void)music_setWantsSearchEntryRightBarButtonItem:(char)arg1 ;
-(char)music_wantsSearchEntryRightBarButtonItem;
-(UIBarButtonItem *)music_searchEntryRightBarButtonItem;
-(void)_music_handleSearchButtonTapped:(id)arg1 ;
-(unsigned)music_searchOptions;
-(void)music_presentSearchViewControllerAnimated:(char)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)music_setWantsAccountEntryLeftBarButtonItem:(char)arg1 ;
-(UIBarButtonItem *)music_accountEntryLeftBarButtonItem;
-(void)_music_handleAccountButtonTapped:(id)arg1 ;
-(char)music_wantsAccountEntryLeftBarButtonItem;
-(void)music_setWantsToOverrideRightBarButtonItem:(char)arg1 ;
-(char)music_wantsToOverrideRightBarButtonItem;
-(void)music_setWantsDefaultIndexBar:(char)arg1 ;
-(char)music_wantsDefaultIndexBar;
...
-(void)_iAd_requestForInterstitialAdDidSucceed:(char)arg1 resultMessage:(id)arg2 ;
...
-(void)_setPresentationSizeClassPair:(SCD_Struct_UI32)arg1 ;
...
-(void)getRotationContentSettings:(SCD_Struct_UI33*)arg1 forWindow:(id)arg2 ;
