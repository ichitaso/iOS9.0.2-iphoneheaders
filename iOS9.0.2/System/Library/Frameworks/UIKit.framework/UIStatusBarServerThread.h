...
@interface UIStatusBarServerThread : NSThread {
	...
	SCD_Struct_UI72 _statusBarData;
	SCD_Struct_UI72 _composedStatusBarData;
	SCD_Struct_UI73 _overrides;
...
-(SCD_Struct_UI73*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI72*)arg1 actions:(int)arg2 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI73*)arg1 ;
