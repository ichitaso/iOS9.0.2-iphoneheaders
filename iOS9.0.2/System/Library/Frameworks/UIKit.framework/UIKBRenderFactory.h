...
+(char)_enabled;
+(id)lightweightFactoryForVisualStyle:(SCD_Struct_UI37)arg1 renderConfig:(id)arg2 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI37)arg1 renderConfig:(id)arg2 skipLayoutSegments:(char)arg3 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI37)arg1 renderConfig:(id)arg2 ;
+(id)cacheKeyForString:(id)arg1 withRenderFlags:(int)arg2 renderConfig:(id)arg3 ;
+(id)segmentedControlColor:(char)arg1 ;
+(Class)factoryClassForVisualStyle:(SCD_Struct_UI37)arg1 ;
-(void)dealloc;
