...
-(char)_downloadResourceForAssetWithLocalIdentifier:(id)arg1 progress:(/*^block*/id)arg2 error:(id*)arg3 ;
-(int)_streamDataAtURL:(id)arg1 progress:(/*^block*/id)arg2 dataHandler:(/*^block*/id)arg3 error:(id*)arg4 ;
