...
@class NSString, NPSDomainAccessor, NSMutableDictionary, NSObject, NSDictionary, NSMutableSet;

@interface SPApplicationManager : NSObject {

	char _newGizmo;
	char _domainVerified;
	char _appsCacheValid;
	char _glancesCacheValid;
	char _appsWithNotificationsCacheValid;
...
@property (assign) char appsCacheValid;                                                              //@synthesize appsCacheValid=_appsCacheValid - In the implementation block
@property (assign) char glancesCacheValid;                                                           //@synthesize glancesCacheValid=_glancesCacheValid - In the implementation block
@property (assign) char appsWithNotificationsCacheValid;                                             //@synthesize appsWithNotificationsCacheValid=_appsWithNotificationsCacheValid - In the implementation block
...
-(id)iTunesMetaDataForApplicationWithIdentifier:(id)arg1 ;
...
-(char)isBetaApplication:(id)arg1 ;
...
-(void)updateInstallStatusForApplicationWithIdentifier:(id)arg1 status:(id)arg2 message:(id)arg3 error:(id)arg4 ;
...
-(void)updateInstallStatusFromGizmoForApplicationWithIdentifier:(id)arg1 status:(id)arg2 message:(id)arg3 error:(id)arg4 ;
...
-(void)restartInstallationsIfNeeded;
-(char)didActivePairedDeviceChange;
-(void)saveActivePairedDevice;
...
-(void)trustStateForAppsWasSet:(char)arg1 ;
...
-(void)setXcodeWillInstallStatusInApplicationInfo:(id)arg1 companionBundleID:(id)arg2 ;
-(id)watchKitApplicationNameForBundleWithURL:(id)arg1 containerProxy:(id)arg2 ;
-(id)containerApplicationNameWithProxy:(id)arg1 ;
-(char)isInstalledByXCode:(id)arg1 containerProxy:(id)arg2 ;
...
-(id)createWatchKitApplicationInfoWithContainerProxy:(id)arg1 ;
-(NSObject*<OS_dispatch_queue>)appInstallationQueue;
-(void)installedOrUpdatedWatchKitApplicationsForBundleIDs:(id)arg1 completion:(/*^block*/id)arg2 ;
-(id)removedWatchKitApplicationsForBundleIDs:(id)arg1 ;
-(char)applicationContainsWK2Application:(id)arg1 ;
-(char)isWatchKit20Supported;
-(id)watchKitApplicationIdentifierWithContainerProxy:(id)arg1 ;
-(char)watchKitApplicationIsInstallCandidate:(id)arg1 applicationInfo:(id)arg2 containerAppChanged:(char*)arg3 ;
-(char)applicationContainsWK1Application:(id)arg1 ;
-(void)stopUsingPluginIfNecessary:(id)arg1 ;
-(char)gizmoApplicationIsInstallCandidate:(id)arg1 applicationInfo:(id)arg2 containerAppChanged:(char*)arg3 ;
-(id)infoForContainerAppBundleId:(id)arg1 ;
-(char)systemTrustsApplicationWithContainerBundleURL:(id)arg1 ;
-(char)installerIsBridge:(id)arg1 ;
-(void)showUntrustedApplicationAlertWithApplicationInfo:(id)arg1 ;
-(void)showLowDiskSpaceAlertWithApplicationInfo:(id)arg1 ;
-(void)showValidationErrorAlertWithApplicationInfo:(id)arg1 ;
-(void)clearXcodeWillInstallSockPuppetAppWithCompanionAppIDState:(id)arg1 ;
-(id)gizmoApplicationIcons:(id)arg1 ;
-(id)applicationInstallationInfoWithIdentifier:(id)arg1 idsPriority:(int)arg2 installer:(id)arg3 error:(id*)arg4 ;
-(id)pluginBundleIDForWatchKitApplicationWithURL:(id)arg1 ;
-(id)supportedComplicationsInfoInGizmoApplication:(id)arg1 ;
-(id)bundleTimeStamp:(id)arg1 ;
-(void)updateApplicationInfoWithContainerProxy:(id)arg1 applicationInfo:(id)arg2 ;
...
-(char)newGizmo;
-(char)shouldInstallNewlyTrustedAppWithTrustState:(int)arg1 ;
-(char)shouldUninstallNewlyTrustedAppWithTrustState:(int)arg1 ;
-(int)newTrustStatefromPreviousTrustState:(int)arg1 appIsNowTrusted:(char)arg2 ;
...
-(id)extensionInfoPListInGizmoApplication:(id)arg1 ;
...
-(void)applicationInstallationInfoWithIdentifier:(id)arg1 idsPriority:(int)arg2 installer:(id)arg3 completion:(/*^block*/id)arg4 ;
-(id)applicationRemovalInfoWithIdentifier:(id)arg1 ;
...
-(id)preferencesDataForApplicationWithIdentifier:(id)arg1 ;
...
-(char)appsCacheValid;
-(void)setAppsCacheValid:(char)arg1 ;
-(char)glancesCacheValid;
-(void)setGlancesCacheValid:(char)arg1 ;
-(char)appsWithNotificationsCacheValid;
-(void)setAppsWithNotificationsCacheValid:(char)arg1 ;
