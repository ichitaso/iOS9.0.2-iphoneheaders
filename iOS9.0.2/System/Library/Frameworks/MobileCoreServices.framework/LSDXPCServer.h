...
-(long)registerItemWithRegistrationInfo:(LSRegistrationInfo*)arg1 alias:(CFDataRef)arg2 diskImageAlias:(CFDataRef)arg3 containerAlias:(CFDataRef)arg4 plist:(CFDictionaryRef)arg5 installationDict:(CFDictionaryRef)arg6 extraItems:(CFArrayRef)arg7 withReply:(id)arg8 ;
-(id)odrConnection;
