...
@property (assign,nonatomic) unsigned semantic; 
...
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 float:(float)arg3 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 matrix4x4:(SCD_Struct_MD0)arg3 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 textureSampler:(id)arg3 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 color:(CGColorRef)arg3 ;
...
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 URL:(id)arg3 ;
-(id)initWithName:(id)arg1 semantic:(unsigned)arg2 string:(id)arg3 ;
-(NSURL *)URLValue;
-()float4Value;
-()float3Value;
-(unsigned)semantic;
-(void)setSemantic:(unsigned)arg1 ;
