...
-(void)updateTexture;
-(id)initWithName:(id)arg1 channelEncoding:(int)arg2 textureDimensions:(float)arg3 turbidity:(float)arg4 sunElevation:(float)arg5 upperAtmosphereScattering:(float)arg6 ;
-(float)turbidity;
