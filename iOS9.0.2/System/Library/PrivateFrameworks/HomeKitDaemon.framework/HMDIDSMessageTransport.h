...
@property (nonatomic,readonly) char proxy;                                                      //@synthesize proxy=_proxy - In the implementation block
...
-(id)initWithIDSService:(id)arg1 proxy:(char)arg2 ;
...
-(char)rerouteDestinationIfCompanion:(id)arg1 newDestination:(id*)arg2 ;
-(char)rerouteDestinationIfWatch:(id)arg1 newDestination:(id*)arg2 ;
...
-(char)_rerouteDestinationIfWatch:(id)arg1 newDestination:(id*)arg2 ;
-(NSString *)pairedWatchDestination;
-(char)_rerouteDestinationIfCompanion:(id)arg1 newDestination:(id*)arg2 ;
...
-(char)_isCompatibleWatchDevice:(id)arg1 ;
-(char)_isCompatibleCompanionDevice:(id)arg1 ;
