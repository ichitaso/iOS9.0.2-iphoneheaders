...
-(char)_presentDialogWithInfo:(id)arg1 options:(unsigned long)arg2 textField:(id*)arg3 withContext:(id)arg4 ;
...
-(char)_presentDialogWithInfo:(id)arg1 options:(unsigned long)arg2 targetResponse:(unsigned long)arg3 textField:(id*)arg4 withContext:(id)arg5 ;
...
-(char)_presentDialogWithInfo:(id)arg1 options:(unsigned long)arg2 targetResponse:(unsigned long)arg3 textField:(id*)arg4 withContext:(id)arg5 selectedByPeerDevice:(char*)arg6 timeout:(double)arg7 ;
