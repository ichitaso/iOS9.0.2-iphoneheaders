...
@property (assign,nonatomic) char appIsInForeground;                                                           //@synthesize appIsInForeground=_appIsInForeground - In the implementation block
...
-(void)deregisterPairedAccessory:(id)arg1 btleTransport:(char)arg2 ;
-(void)registerPairedAccessory:(id)arg1 btleTransport:(char)arg2 ;
-(void)retrieveHAPAccessoryForHMDAccessory:(id)arg1 linkType:(int)arg2 queue:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)_registerPairedAccessory:(id)arg1 btleTransport:(char)arg2 ;
-(void)_activate;
...
-(void)_stopDiscoveringAccessoriesWithForce:(char)arg1 ;
...
-(char)_isAccessoryServerTombstoned:(id)arg1 ;
-(char)_shouldAccessoryServerBeTombstoned:(id)arg1 ;
...
-(char)_accessoryServerIsBlocked:(id)arg1 ;
...
-(void)_retrieveHAPAccessoryForHMDAccessory:(id)arg1 linkType:(int)arg2 queue:(id)arg3 completion:(/*^block*/id)arg4 ;
-(char)_isRetrievalInProgressForLinkType:(int)arg1 accessory:(id)arg2 ;
