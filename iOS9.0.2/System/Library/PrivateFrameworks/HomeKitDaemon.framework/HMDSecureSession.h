...
-(char)clientMode;
-(void)_configureAsClient:(char)arg1 queue:(id)arg2 nonSecure:(char)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(id)initWithDestination:(id)arg1 messageDispatcher:(id)arg2 sessionNotifications:(id)arg3 identityRegistry:(id)arg4 notificationRelay:(id)arg5 clientMode:(char)arg6 sessionID:(id)arg7 ;
-(void)startAndInvokeOnQueue:(id)arg1 nonSecure:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
