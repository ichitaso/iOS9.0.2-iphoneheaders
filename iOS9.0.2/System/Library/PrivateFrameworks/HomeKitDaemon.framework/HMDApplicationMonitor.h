...
@property (nonatomic,readonly) char activeHomeKitApps; 
...
+(id)applicationStateDescription:(unsigned)arg1 ;
...
-(void)_callActiveHomeKitAppDelegate:(char)arg1 ;
-(void)_handleAppStateChangedInfo:(id)arg1 ;
-(unsigned)_translateApplicationState:(unsigned)arg1 ;
-(char)infoIsForViewService:(id)arg1 ;
-(id)processInfoForPID:(int)arg1 ;
-(unsigned)translateApplicationStateForInfo:(id)arg1 processInfo:(id)arg2 ;
-(void)_callAppStateChangeDelegate:(id)arg1 ;
-(void)removeProcess:(id)arg1 ;
-(char)_delegateConformsAndRespondsToSelector:(SEL)arg1 ;
