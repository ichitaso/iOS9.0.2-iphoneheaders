...
-(void)_postFollowUpItemWithUniqueIdentifier:(id)arg1 title:(id)arg2 informativeText:(id)arg3 actionURL:(id)arg4 actionLabelText:(id)arg5 showNotification:(char)arg6 ;
-(void)_clearFollowUpItems;
-(void)postFollowUpItemWithUniqueIdentifier:(id)arg1 title:(id)arg2 informativeText:(id)arg3 actionURL:(id)arg4 actionLabelText:(id)arg5 showNotification:(char)arg6 ;
@end
