...
@property (getter=isViewService,nonatomic,readonly) char viewService;                 //@synthesize viewService=_viewService - In the implementation block
@property (getter=isForegrounded,nonatomic,readonly) char foreground; 
@property (getter=isBackgrounded,nonatomic,readonly) char background; 
...
@property (nonatomic,readonly) unsigned proxyCount; 
