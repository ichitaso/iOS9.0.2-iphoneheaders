...
@property (assign,nonatomic) char cloudHomeDataRecordExists;                                      //@synthesize cloudHomeDataRecordExists=_cloudHomeDataRecordExists - In the implementation block
...
@property (assign,nonatomic) char cloudMetadataRecordExists;                                      //@synthesize cloudMetadataRecordExists=_cloudMetadataRecordExists - In the implementation block
...
-(void)_handleAccountStatus:(int)arg1 completionHandler:(/*^block*/id)arg2 error:(id)arg3 ;
...
-(void)_resetCloudDataAndDeleteMetadataForCurrentAccount:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
-(CKRecordID *)homeDataBlobRecordID;
-(CKRecordID *)metadataBlobRecordID;
-(void)setCloudHomeDataRecordExists:(char)arg1 ;
...
-(void)_updateCloudDataSyncFilterState:(char)arg1 ;
...
-(void)setCloudMetadataRecordExists:(char)arg1 ;
...
-(void)_handleKeychainSyncStateChanged:(char)arg1 ;
...
-(void)_handleFetchCompletedWithError:(id)arg1 serverToken:(id)arg2 completionHandler:(/*^block*/id)arg3 moreRecordsComing:(char)arg4 ;
-(NSMutableArray *)pendingFetchedRecords;
-(id)fetchCompletionHandler;
-(char)needConflictResolution;
-(HAPOSTransaction *)homeDataFetchedTransaction;
-(char)_validFetchRetryCKErrorCode:(int)arg1 ;
...
-(void)updateAccountStatusChanged:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
-(void)resetCloudDataAndDeleteMetadataForCurrentAccount:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
