...
#import <libobjc.A.dylib/NBServerProtocol.h>
...
-(void)migrateLegacyContactPreferencesFromBackup:(id)arg1 device:(id)arg2 ;
-(char)isDevice:(id)arg1 mirroringDomain:(id)arg2 ;
