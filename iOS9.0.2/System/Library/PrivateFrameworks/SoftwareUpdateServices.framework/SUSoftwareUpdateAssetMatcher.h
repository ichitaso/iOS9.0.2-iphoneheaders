...
@property (assign,nonatomic) char compareWithTatsuForEligibility;              //@synthesize checkTatsu=_checkTatsu - In the implementation block
...
-(char)_isPossibleSoftwareUpdate:(id)arg1 ;
-(char)_isDeviceEligibleForUpdate:(id)arg1 ;
...
-(char)compareWithTatsuForEligibility;
-(void)setCompareWithTatsuForEligibility:(char)arg1 ;
@end
