...
-(id)_sliceRectanglesForRenditionSize:(SCD_Struct_TD7)arg1 unadjustedSliceRectangles:(id*)arg2 imageSlicesNeedAdjustment:(char*)arg3 newRenditionSize:(SCD_Struct_TD7*)arg4 ;
