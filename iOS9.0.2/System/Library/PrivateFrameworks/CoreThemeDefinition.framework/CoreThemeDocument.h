...
+(int)maximumAreaOfPackableImageForScale:(unsigned)arg1 ;
...
-(id)slicesComputedForImageSize:(CGSize)arg1 usingSliceInsets:(SCD_Struct_Co10)arg2 resizableSliceSize:(CGSize)arg3 withRenditionType:(int)arg4 ;
