...
@property (assign,nonatomic) char didCompleteLayout;                              //@synthesize didCompleteLayout=_didCompleteLayout - In the implementation block
...
-(void)setDidCompleteLayout:(char)arg1 ;
