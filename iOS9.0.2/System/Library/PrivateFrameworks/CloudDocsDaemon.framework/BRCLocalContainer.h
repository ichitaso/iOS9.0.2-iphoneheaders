...
-(PQLResultSet*)itemsEnumeratorWithRankMin:(unsigned long long)arg1 rankMax:(unsigned long long)arg2 namePrefix:(id)arg3 shouldIncludeFolders:(char)arg4 shouldIncludeAliases:(char)arg5 shouldIncludeDataScope:(char)arg6 shouldIncludeDocumentsScope:(char)arg7 count:(unsigned long long)arg8 ;
