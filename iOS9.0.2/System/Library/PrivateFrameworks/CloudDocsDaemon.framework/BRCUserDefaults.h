...
@property (nonatomic,readonly) unsigned spotlightIndexerBatchSize; 
@property (nonatomic,readonly) unsigned spotlightIndexerMaxHeirarchyDepth; 
...
@property (nonatomic,readonly) unsigned notifOverflowLimit; 
@property (nonatomic,readonly) unsigned notifGatherUpTo; 
@property (nonatomic,readonly) unsigned notifBatchSize; 
...
-(unsigned)notifOverflowLimit;
-(unsigned)notifGatherUpTo;
-(unsigned)notifBatchSize;
...
-(unsigned)spotlightIndexerBatchSize;
-(unsigned)spotlightIndexerMaxHeirarchyDepth;
