...
-(void)_waitForDownloadOfDocument:(id)arg1 key:(id)arg2 requireCurrent:(char)arg3 completionHandler:(/*^block*/id)arg4 ;
-(void)_waitForDownloadOfDirectory:(id)arg1 key:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)__provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 session:(id)arg3 recursively:(char)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(char)_hasFilePresenterForURL:(id)arg1 ;
