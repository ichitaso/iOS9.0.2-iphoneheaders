...
@interface BRCGlobalProgress : NSObject <BRCReachabilityDelegate> {
	...
	char _showAdditionalLocalizedDescription;
...
-(long long)_computeDeltaFromSize:(long long)arg1 toSize:(long long)arg2 versionSize:(long long)arg3 progressSize:(long long)arg4 isFinished:(char)arg5 ;
-(void)_updateState:(id)arg1 forContainerID:(id)arg2 shouldBeAdded:(char)arg3 ;
...
-(void)_cancelUploadForDocumentID:(id)arg1 willRetryTransfer:(char)arg2 ;
...
-(void)removeProgressBecauseTransferFailed:(id)arg1 willRetryTransfer:(char)arg2 ;
@end
