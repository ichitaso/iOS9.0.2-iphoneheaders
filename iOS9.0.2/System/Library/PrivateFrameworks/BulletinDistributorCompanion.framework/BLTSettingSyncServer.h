...
-(void)setSectionSubtypeParametersIcon:(id)arg1 forSectionID:(id)arg2 forSubtypeID:(int)arg3 withQueue:(id)arg4 withSent:(/*^block*/id)arg5 withAcknowledgement:(/*^block*/id)arg6 ;
...
-(void)setSectionSubtypeParametersIcon:(id)arg1 forSectionID:(id)arg2 forSubtypeID:(int)arg3 completion:(/*^block*/id)arg4 ;
