...
@property (nonatomic,readonly) char conflictDetected;                      //@synthesize conflictDetected=_conflictDetected - In the implementation block
+(id)sharedManager;
-(id)photoLibrary;
-(void)dealloc;
-(id)init;
...
-(void)setConflictDetected:(char)arg1 ;
...
-(void)migration_fixupOrderKeys:(id)arg1 usingOrderValuePropertyKey:(id)arg2 enforceSingletonAlbumReservedKeySpace:(char)arg3 ;
