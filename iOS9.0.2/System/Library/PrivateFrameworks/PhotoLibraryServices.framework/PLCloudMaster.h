...
-(id)description;
-(id)cplResourceForResourceType:(unsigned)arg1 forAssetUuid:(id)arg2 ;
-(id)cloudResourceForResourceType:(unsigned)arg1 forAssetUuid:(id)arg2 ;
-(unsigned long long)sizeOfOriginal;
-(id)cloudResourcesForResourceType:(unsigned)arg1 ;
