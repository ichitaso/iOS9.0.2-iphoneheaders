...
@property (assign,nonatomic) SCD_Struct_PL12 gpsCoordinate; 
...
+(SCD_Struct_PL12)locationFromAVAsset:(id)arg1 ;
...
+(id)insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 savedAssetType:(short)arg3 replacementUUID:(id)arg4 imageSource:(CGImageSource*)arg5 imageData:(id*)arg6 isPlaceholder:(char)arg7 deleteFileOnFailure:(char)arg8 ;
...
+(id)_insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 savedAssetType:(short)arg3 replacementUUID:(id)arg4 imageSource:(CGImageSource*)arg5 imageData:(id*)arg6 isPlaceholder:(char)arg7 deleteFileOnFailure:(char)arg8 ;
...
+(void)resetAssetsForCloudInLibrary:(id)arg1 hardReset:(char)arg2 ;
...
-(id)pl_PHAssetWithPropertyHint:(unsigned)arg1 ;
-(id)pl_PHAsset;
...
-(char)becomePhotoIrisWithMediaGroupUUID:(id)arg1 videoURL:(id)arg2 videoDuration:(SCD_Struct_PL11)arg3 stillDisplayTime:(SCD_Struct_PL11)arg4 createSidecar:(char)arg5 ;
...
-(id)cplMasterChangeInLibrary:(id)arg1 forceUpdateForVideo:(char)arg2 ;
...
-(id)_sidecarFileMatchingUTI:(CFStringRef)arg1 requireExactMatch:(char)arg2 requireSort:(char)arg3 ;
...
-(void)_setLocationFromCoordinate:(SCD_Struct_PL12)arg1 ;
...
-(void)_setAdjustmentDataBlob:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 baseVersion:(int)arg4 editorBundleID:(id)arg5 renderedContentURL:(id)arg6 penultimateRenderedJPEGData:(id)arg7 isSubstandardRender:(char)arg8 fullSizeRenderSize:(CGSize)arg9 shouldUpdateAttributes:(char)arg10 useSecureMove:(char)arg11 removeFileOnSuccess:(char)arg12 inManagedObjectContext:(id)arg13 ;
...
-(char)isLocatedAtCoordinates:(SCD_Struct_PL12)arg1 ;
...
-(SCD_Struct_PL12)gpsCoordinate;
-(void)setGpsCoordinate:(SCD_Struct_PL12)arg1 ;
-(char)isUsedByiPhoto;
-(char)isHDVideo;
-(char)isPanorama;
...
-(char)isRAWOnly;
-(char)isRAWPlusJPEG;
-(void)setAdjustmentDataBlob:(id)arg1 formatIdentifier:(id)arg2 formatVersion:(id)arg3 baseVersion:(int)arg4 editorBundleID:(id)arg5 renderedContentURL:(id)arg6 penultimateRenderedJPEGData:(id)arg7 useSecureMove:(char)arg8 ;
...
-(void)getFileURL:(id*)arg1 originalFilename:(id*)arg2 uti:(id*)arg3 forSidecarMatchingUTI:(id)arg4 requireExactMatch:(char)arg5 ;
...
-(unsigned)cplAssetSubtypeFromPLAssetSubtype:(short)arg1 ;
-(unsigned)cplBurstFlagsFromPLAvalancheType:(int)arg1 ;
-(id)userVisibleCloudResourceOfType:(unsigned)arg1 ;
...
-(id)_createJPEGResourcesFromFullSizeJPEGPath:(id)arg1 withItemIdentifier:(id)arg2 forMaster:(char)arg3 forResourceTypes:(id)arg4 ;
...
-(id)_createVideoResourceFromVideoURL:(id)arg1 withResourceType:(unsigned)arg2 itemIdentifier:(id)arg3 applyVideoAdjustments:(char)arg4 forMaster:(char)arg5 forPhotoIris:(char)arg6 ;
...
-(id)_cplMasterResourcesFromCloudMaster:(id)arg1 includeFile:(char)arg2 ;
...
-(unsigned)bestResourceTypeForAdjustedFingerPrint;
...
-(void)_updateAssetSubtypeFromCPLAssetSubtype:(unsigned)arg1 ;
...
-(CGSize)targetSizeForInputSize:(CGSize)arg1 maxPixelSize:(unsigned)arg2 ;
-(void)enumerateUserVisibleResourcesWithBlock:(/*^block*/id)arg1 ;
-(id)descriptionForResources;
-(char)hasFullDerivativesSet;
