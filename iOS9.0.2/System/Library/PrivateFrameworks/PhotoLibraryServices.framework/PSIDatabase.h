...
@interface PSIDatabase : NSObject {
	...
	SCD_Struct_PL27 _tokenizerOutputRanges[8];
	NSString* _path;
...
-(id)newQueryWithSearchText:(id)arg1 isWildcardSearch:(char)arg2 ;
...
-(void)_inqGetTokensFromString:(id)arg1 forIndexing:(char)arg2 useWildcard:(char)arg3 tokenOutput:(tokenOutput_t*)arg4 ;
...
-(unsigned long long)_inqGroupIdForCategory:(short)arg1 owningGroupId:(unsigned long long)arg2 contentString:(id)arg3 insertIfNeeded:(char)arg4 tokenOutput:(const tokenOutput_t*)arg5 ;
