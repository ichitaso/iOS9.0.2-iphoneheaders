...
@property (assign,nonatomic) int appliedOrientation; 
@property (assign,nonatomic) CGRect normalizedCropRect; 
@property (assign,nonatomic) float straightenAngle; 
@property (assign,getter=isAutoCropped,nonatomic) char autoCropped; 
...
-(void)pl_setNormalizedCropRectForDataCrop:(CGRect)arg1 straightenAngle:(float)arg2 imageGeometry:(id)arg3 ;
