...
+(void)revalidateAvalancheAssets:(id)arg1 inLibrary:(id)arg2 deleteNonPicks:(char)arg3 allowDissolve:(char)arg4 ;
...
+(id)_updatePropertiesForAssets:(id)arg1 autoPicks:(id)arg2 stackAsset:(id)arg3 userFavorites:(id)arg4 deleteNonPicks:(char)arg5 setFirstPick:(char)arg6 allowDissolve:(char)arg7 ;
+(void)_updateMembershipForAssets:(id)arg1 autoPicks:(id)arg2 stackAsset:(id)arg3 userFavorites:(id)arg4 deleteNonPicks:(char)arg5 allowDissolve:(char)arg6 inLibrary:(id)arg7 ;
