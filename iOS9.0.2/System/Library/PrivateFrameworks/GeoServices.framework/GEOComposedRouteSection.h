...
@interface GEOComposedRouteSection : NSObject {
	...
	unsigned _composedRouteLegIndex;
	SCD_Struct_GE57 _bounds;
	SCD_Struct_GE57 _overlayBounds;
	unsigned _finalStepIndex;

}

@property (nonatomic,readonly) SCD_Struct_GE178 vkBounds; 
...
@property (nonatomic,readonly) unsigned composedRouteLegIndex;                      //@synthesize composedRouteLegIndex=_composedRouteLegIndex - In the implementation block
@property (nonatomic,readonly) unsigned finalStepIndex;                             //@synthesize finalStepIndex=_finalStepIndex - In the implementation block
...
-(SCD_Struct_GE178)vkBounds;
-(SCD_Struct_GE57)bounds;
-(void)dealloc;
-(id)description;
-(int)transportType;
-(unsigned)endPointIndex;
-(unsigned)finalStepIndex;
-(id)initWithRoute:(id)arg1 startPoint:(unsigned)arg2 pointCount:(unsigned)arg3 transportType:(int)arg4 finalStepIndex:(unsigned)arg5 fallbackStartCoordinate:(SCD_Struct_GE16)arg6 fallbackEndCoordinate:(SCD_Struct_GE16)arg7 ;
-(id)initWithRoute:(id)arg1 startPoint:(unsigned)arg2 pointCount:(unsigned)arg3 bounds:(SCD_Struct_GE57)arg4 transportType:(int)arg5 finalStepIndex:(unsigned)arg6 ;
-(unsigned)startPointIndex;
-(GEOComposedRouteLeg *)composedRouteLeg;
-(char)isTransfer;
-(unsigned)composedRouteLegIndex;
-(unsigned)pointCount;
