...
-(NSDate *)time;
-(double)penalty;
-(void)updateWithCurrentTime:(id)arg1 location:(id)arg2 isMostRecentReroute:(char)arg3 destinationCoordinate:(SCD_Struct_GE16)arg4 numThrottledReroutes:(unsigned)arg5 ;
