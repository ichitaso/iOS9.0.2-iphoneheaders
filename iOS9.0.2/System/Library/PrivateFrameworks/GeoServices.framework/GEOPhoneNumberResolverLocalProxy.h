...
-(id)stringForLocationNameStrings:(const SCD_Struct_GE249*)arg1 countryName:(id)arg2 ;
...
-(char)decomposePhoneNumber:(id)arg1 country:(id)arg2 components:(PhoneNumberComponents*)arg3 ;
