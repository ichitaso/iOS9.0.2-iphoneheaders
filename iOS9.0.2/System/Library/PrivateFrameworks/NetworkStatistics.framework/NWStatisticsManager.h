...
-(void)traceInterfaceMessage:(nstat_msg_hdr*)arg1 length:(long)arg2 tag:(char*)arg3 ;
...
-(char)queryBothInternal:(unsigned)arg1 completion:(unsigned long long)arg2 ;
...
-(void)removeSourceInternal:(unsigned)arg1 isFromClient:(char)arg2 ;
...
-(char)queryCountsInternal:(unsigned)arg1 completion:(unsigned long long)arg2 ;
-(char)queryDescriptionInternal:(unsigned)arg1 completion:(unsigned long long)arg2 ;
...
-(char)addAllRoute;
-(char)queryAllCounts:(/*^block*/id)arg1 ;
-(char)queryAllDescriptions:(/*^block*/id)arg1 ;
-(char)queryAll:(/*^block*/id)arg1 ;
-(char)querySource:(id)arg1 completion:(/*^block*/id)arg2 ;
