...
-(id)createRowStyleBasicEditableWithImage:(id)arg1 labelText:(id)arg2 currentValue:(id)arg3 placeholderText:(id)arg4 isSecure:(char)arg5 keyboardType:(int)arg6 withTag:(unsigned)arg7 ;
-(void)setNewRow:(id)arg1 accessoryType:(int)arg2 ;
-(char)tagOfCellAtIndexPath:(id)arg1 tag:(int*)arg2 ;
...
-(char)verifyStr1:(id)arg1 forTag1:(unsigned)arg2 matchesStr2:(id)arg3 forTag2:(unsigned)arg4 ;
-(void)deleteSectionWithIdentifier:(id)arg1 animated:(char)arg2 ;
-(void)setNewRow:(id)arg1 verifierAccessoryType:(int)arg2 ;
-(void)addSectionInfo:(id)arg1 animated:(char)arg2 ;
-(id)createRowStyleBasicOnOffWithImage:(id)arg1 labelText:(id)arg2 isOn:(char)arg3 withTag:(unsigned)arg4 ;
...
-(char)isCellAtIndexPath:(id)arg1 identicalToNewRow:(id)arg2 ;
-(void)updateCellAtIndexPath:(id)arg1 withNewRowInfo:(id)arg2 ;
-(UITableView *)managedTableView;
-(char)checkIfSectionDataSameInTable:(id)arg1 ;
...
-(void)setMenuCell:(id)arg1 visualStateToSelected:(char)arg2 atIndexPath:(id)arg3 ;
-(id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2 layoutMode:(char)arg3 ;
...
-(char)textFieldIsSecureAndUnchanged:(id)arg1 ;
...
-(char)textFieldHasVerifierAtIndexPath:(id)arg1 ;
-(char)textFieldVerifiedAtIndexPath:(id)arg1 ;
...
-(char)updateRowAtIndexPath:(id)arg1 withNewRowInfo:(id)arg2 ;
-(char)updateSectionsIfMatchingExisting:(id)arg1 ;
...
-(id)createRowStyleSegmentedControlWithItems:(id)arg1 selectedSegmentIndex:(id)arg2 enabled:(char)arg3 withTag:(unsigned)arg4 ;
-(id)createRowStyleProgressViewWithCancelAndStatus:(id)arg1 statusText:(id)arg2 altText:(id)arg3 withTag:(unsigned)arg4 ;
-(id)createRowStyleActivityStatus:(char)arg1 text1:(id)arg2 grayedText1:(char)arg3 text2:(id)arg4 grayedText2:(char)arg5 withTag:(unsigned)arg6 ;
...
-(char)setNewRow:(id)arg1 itemAttribute:(id)arg2 forItemOfType:(id)arg3 atItemTypeIndex:(unsigned)arg4 toValue:(id)arg5 ;
...
-(void)setNewRow:(id)arg1 selectableCell:(char)arg2 ;
...
-(char)becomeFirstResponderAtIndexPath:(id)arg1 ;
