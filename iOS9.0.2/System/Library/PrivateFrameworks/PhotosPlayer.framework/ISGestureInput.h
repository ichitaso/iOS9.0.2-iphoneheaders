...
@interface ISGestureInput : ISInput {
	...
	char __needsUpdateGestureRecognizer;
...
@property (assign,setter=_setNeedsUpdateGestureRecognizer:,nonatomic) char _needsUpdateGestureRecognizer;              //@synthesize _needsUpdateGestureRecognizer=__needsUpdateGestureRecognizer - In the implementation block
...
-(void)_setNeedsUpdateGestureRecognizer:(char)arg1 ;
-(char)_needsUpdateGestureRecognizer;
