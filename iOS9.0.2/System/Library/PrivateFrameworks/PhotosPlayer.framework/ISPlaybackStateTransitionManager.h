...
@interface ISPlaybackStateTransitionManager : NSObject {
	...
	char __needsUpdateAnimations;
	char __didHideCrossfadeContentForCurrentPlayback;
...
@property (nonatomic,readonly) int currentPlaybackState;                                                                                            //@synthesize currentPlaybackState=_currentPlaybackState - In the implementation block
...
@property (assign,setter=_setNeedsUpdateAnimations:,nonatomic) char _needsUpdateAnimations;                                                         //@synthesize _needsUpdateAnimations=__needsUpdateAnimations - In the implementation block
@property (assign,setter=_setCurrentRequestID:,nonatomic) int _currentRequestID;                                                                    //@synthesize _currentRequestID=__currentRequestID - In the implementation block
@property (assign,setter=_setDidHideCrossfadeContentForCurrentPlayback:,nonatomic) char _didHideCrossfadeContentForCurrentPlayback;                 //@synthesize _didHideCrossfadeContentForCurrentPlayback=__didHideCrossfadeContentForCurrentPlayback - In the implementation block
...
-(void)hideCrossfadeContentForTransitionToVideo:(char)arg1 subtractingDuration:(double)arg2 ;
...
-(void)_setDidHideCrossfadeContentForCurrentPlayback:(char)arg1 ;
...
-(void)_notifyDelegateDidEndTransitionToPlaybackState:(int)arg1 forRequestID:(int)arg2 finished:(char)arg3 ;
-(char)_didHideCrossfadeContentForCurrentPlayback;
-(void)_updateAnimationsIfNeeded;
-(void)_setNeedsUpdateAnimations:(char)arg1 ;
-(char)_needsUpdateAnimations;
