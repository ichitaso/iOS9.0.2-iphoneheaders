...
-(NSArray *)observables;
-(void)observableAtIndex:(unsigned)arg1 didReceiveResult:(id)arg2 forObserver:(id)arg3 ;
-(void)observableAtIndexDidComplete:(unsigned)arg1 forObserver:(id)arg2 ;
-(void)observableAtIndex:(unsigned)arg1 didFailWithError:(id)arg2 forObserver:(id)arg3 ;
