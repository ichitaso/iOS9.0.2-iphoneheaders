...
@property (nonatomic,readonly) char softAPIsEnabled; 
@property (nonatomic,readonly) char hasSoftAPCapability; 
+(id)sharedInstance;
-(id)init;
-(char)hasSoftAPCapability;
-(char)softAPIsEnabled;
-(void)_enableSoftAPWithCompletion:(/*^block*/id)arg1 ;
-(void)disableSoftAPWithCompletion:(/*^block*/id)arg1 ;
-(char)startDHCPReturningError:(id*)arg1 ;
