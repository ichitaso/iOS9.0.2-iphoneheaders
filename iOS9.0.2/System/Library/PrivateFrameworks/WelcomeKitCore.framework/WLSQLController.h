...
-(id)summariesForAccounts:(id)arg1 sortedByModifiedDate:(char)arg2 ;
-(id)_sqlite3_column_NSDateForStatement:(sqlite3_stmtRef)arg1 column:(int)arg2 ;
-(id)_migratableAppsForDevice:(id)arg1 ;
-(char)_foundHandleIDs:(id)arg1 representSameGroupMessageAsHandleIDs:(id)arg2 handleIDsAreComplete:(char)arg3 ;
...
-(unsigned)insertAccount:(id)arg1 migrator:(id)arg2 device:(id)arg3 ;
-(id)accountsForMigrator:(id)arg1 device:(id)arg2 ;
-(char)deleteAccountsAndSummariesForMigrator:(id)arg1 device:(id)arg2 ;
-(unsigned)insertRecordSummary:(id)arg1 account:(id)arg2 ;
-(void)totalSummaryItemSizeForAccounts:(id)arg1 addOverhead:(char)arg2 completion:(/*^block*/id)arg3 ;
-(unsigned)totalSummaryDownloadSegmentCountForAccounts:(id)arg1 ;
...
-(id)migrationMetadataForSourceDevice:(id)arg1 strictMatch:(char)arg2 ;
...
-(id)groupMessageInfoMatchingSortedHandleIDs:(id)arg1 handleIDsAreComplete:(char)arg2 didMatchExactly:(char*)arg3 ;
-(void)insertGroupMessageInfoWithSourceThreadID:(id)arg1 roomName:(id)arg2 groupID:(id)arg3 ;
-(void)insertGroupMessageInfoWithSortedHandleIDs:(id)arg1 handleIDsAreComplete:(char)arg2 roomName:(id)arg3 groupID:(id)arg4 ;
