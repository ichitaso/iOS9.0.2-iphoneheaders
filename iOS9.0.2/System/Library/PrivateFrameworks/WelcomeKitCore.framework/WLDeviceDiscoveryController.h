...
+(id)sharedInstance;
+(char)_shouldUseLegacySSIDPSKAlgorithm;
+(char)_shouldUseLegacyTwelveDigitPairingCode;
...
-(char)_shouldForceDiscoveryError;
...
-(id)_defaultChannel;
-(int)createListenerSocketOnPort:(unsigned)arg1 ;
-(int)acceptIncomingConnectionWithListenerSocket:(int)arg1 nonBlocking:(char)arg2 ;
