...
@interface WLMigrator : NSObject <WLMigrationWebServiceDelegate, WLDataMigratorProtocol> {
	...
	char _shouldSendProgressToDevice;
...
+(id)_deviceType;
+(char)_shouldContinueMigrationFromAnotherDevice;
+(unsigned long long)_bytesFreeOnDevice;
+(char)_shouldTerminateMigrationBeforeImport;
...
-(char)_shouldTerminateMigrationOnError;
-(void)_selectFromDataTypeToSizeMap:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_setProgressToSegmentsDownloaded:(unsigned)arg1 ofExpectedSegments:(unsigned)arg2 ;
...
-(char)_shouldDelayBetweenMigrationSteps;
-(void)migrator:(id)arg1 didImportRecordCount:(unsigned)arg2 ;
-(void)cancelMigrationWithReply:(/*^block*/id)arg1 ;
-(id)initWithSourceDevice:(id)arg1 dataTypes:(unsigned)arg2 authentication:(id)arg3 delegate:(id)arg4 connectionKey:(id)arg5 ;
-(void)startMigration;
