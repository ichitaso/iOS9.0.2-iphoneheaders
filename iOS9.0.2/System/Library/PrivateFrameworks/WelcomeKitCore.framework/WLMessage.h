...
@property (nonatomic,readonly) unsigned messageDirection;              //@synthesize messageDirection=_messageDirection - In the implementation block
...
+(NSRange)_populateMimeHeaders:(id)arg1 recipients:(id)arg2 fromRange:(NSRange)arg3 ofString:(id)arg4 addCountryCodeToParties:(char)arg5 ;
+(void)addRecipients:(id)arg1 toMimeHeaders:(id)arg2 ;
+(id)_dateFormatterForMimeDateStrings;
+(char)_shouldIgnoreMessageThreadID;
