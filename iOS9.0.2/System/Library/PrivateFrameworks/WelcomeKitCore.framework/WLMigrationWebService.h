...
@interface WLMigrationWebService : NSObject {
	...
	char _importsNilData;
	char _needsPreImportPhase;
	WLSourceDevice* _device;
	id<WLMigrationWebServiceDelegate> _delegate;
	unsigned _expectedRecordCount;
	unsigned _importedRecordCount;
...
@property (assign,nonatomic) char importsNilData;                                              //@synthesize importsNilData=_importsNilData - In the implementation block
@property (assign,nonatomic) char needsPreImportPhase;                                         //@synthesize needsPreImportPhase=_needsPreImportPhase - In the implementation block
@property (nonatomic,readonly) unsigned expectedRecordCount;                                   //@synthesize expectedRecordCount=_expectedRecordCount - In the implementation block
@property (nonatomic,readonly) unsigned importedRecordCount;                                   //@synthesize importedRecordCount=_importedRecordCount - In the implementation block
+(unsigned)_downloadSegmentSize;
+(char)_allowSegmentedDownloads;
...
-(void)_performRequest:(id)arg1 numberOfRetriesAllowed:(unsigned)arg2 startDate:(id)arg3 logString:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(void)_performDownloadRequest:(id)arg1 toDestination:(id)arg2 numberOfRetriesAllowed:(unsigned)arg3 startDate:(id)arg4 logString:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
-(void)_downloadSegmentsStartingAtByteLocation:(unsigned)arg1 ofSummary:(id)arg2 account:(id)arg3 toFileHandle:(id)arg4 segmentCompletion:(/*^block*/id)arg5 completion:(/*^block*/id)arg6 ;
...
-(char)shouldDownloadDataAsSeparateFileForSummary:(id)arg1 account:(id)arg2 ;
-(void)estimateItemSizeForSummary:(id)arg1 account:(id)arg2 ;
-(char)shouldRetryWithData:(id)arg1 response:(id)arg2 error:(id)arg3 ;
-(unsigned)_newNumberOfRetriesAllowed:(unsigned)arg1 startDate:(id)arg2 ;
...
-(id)importWillBegin;
-(void)importDidEnd;
-(char)_shouldDelayBetweenRequests;
-(void)setImportsNilData:(char)arg1 ;
-(char)needsPreImportPhase;
-(void)setNeedsPreImportPhase:(char)arg1 ;
-(unsigned)expectedRecordCount;
-(unsigned)importedRecordCount;
@end
