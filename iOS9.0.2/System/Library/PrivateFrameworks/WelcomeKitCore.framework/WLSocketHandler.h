...
-(void)writeBytes:(const void*)arg1 length:(unsigned long)arg2 toSocket:(int)arg3 completion:(/*^block*/id)arg4 ;
-(void)endReadingIntoCache;
-(void)_readIntoCacheFromSocket:(int)arg1 ;
-(id)waitForDataFromReadCacheReturningError:(id*)arg1 ;
-(void)_writeBytes:(const void*)arg1 offset:(unsigned long)arg2 length:(unsigned long)arg3 toSocket:(int)arg4 completion:(/*^block*/id)arg5 ;
...
-(char)waitForCommand:(id)arg1 fromReadCacheReturningError:(id*)arg2 ;
