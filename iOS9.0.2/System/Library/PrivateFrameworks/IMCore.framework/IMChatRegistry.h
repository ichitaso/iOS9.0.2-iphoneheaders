...
+(Class)messageClass;
-(id)_ck_chatForHandles:(id)arg1 displayName:(id)arg2 ignoresDisplayName:(char)arg3 joinedChatsOnly:(char)arg4 createIfNecessary:(char)arg5 ;
...
-(void)chat:(id)arg1 isFilteredUpdated:(char)arg2 ;
...
-(void)_chat:(id)arg1 updateIsFiltered:(char)arg2 ;
