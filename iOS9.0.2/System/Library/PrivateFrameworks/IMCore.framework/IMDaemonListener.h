...
@interface IMDaemonListener : NSObject {
	...
	char _holdingChatMessages;
	char _hidingDisconnect;
	char _hasPendingProcessChange;
...
@property (nonatomic,readonly) char shouldHoldChatMessages;                                    //@synthesize holdingChatMessages=_holdingChatMessages - In the implementation block
@property (nonatomic,readonly) char isHoldingChatMessages; 
@property (nonatomic,readonly) char isSetupComplete;                                           //@synthesize setupComplete=_setupComplete - In the implementation block
@property (nonatomic,readonly) char hasPostedSetupComplete;                                    //@synthesize postedSetupComplete=_postedSetupComplete - In the implementation block
...
@property (assign,setter=_setHidingDisconnect:,nonatomic) char _hidingDisconnect;              //@synthesize hidingDisconnect=_hidingDisconnect - In the implementation block
-(NSArray *)handlers;
-(void)dealloc;
-(id)init;
...
-(void)account:(id)arg1 defaults:(id)arg2 blockList:(id)arg3 allowList:(id)arg4 blockingMode:(unsigned)arg5 blockIdleStatus:(char)arg6 status:(id)arg7 capabilities:(unsigned long long)arg8 serviceLoginStatus:(unsigned)arg9 loginStatusMessage:(id)arg10 ;
...
-(void)account:(id)arg1 blockIdleStatusChanged:(char)arg2 ;
...
-(void)pinCodeAlertCompleted:(id)arg1 deviceName:(id)arg2 deviceType:(id)arg3 phoneNumber:(id)arg4 responseFromDevice:(char)arg5 wasCancelled:(char)arg6 ;
-(void)_reallyProcessMyStatusChanged;
-(char)isHoldingChatMessages;
-(void)_processDeferredInvitationDictionary:(id)arg1 ;
-(void)_processMyStatusChanged;
-(char)shouldHoldChatMessages;
