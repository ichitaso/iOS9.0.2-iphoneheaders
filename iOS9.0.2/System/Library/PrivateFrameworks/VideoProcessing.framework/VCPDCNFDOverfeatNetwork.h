...
@property (assign,nonatomic) char useGPUScaler;                //@synthesize useGPUScaler=_useGPUScaler - In the implementation block
...
-(NSString *)basename;
-(void)processBlobNoRotation:(const shared_ptr<Espresso::blob<unsigned char __attribute__((ext_vector_type(4))), 2> >*)arg1 tex:(id)arg2 doBGRA2RGBA:(char)arg3 ;
-(void)autoResizeForAspectRatio:(float)arg1 ;
-(void)autoSetupNetBaseName:(id)arg1 weights:(id)arg2 scaleConfig:(int)arg3 setupMode:(int)arg4 computePath:(int)arg5 autoAspectRatio:(float)arg6 forceReset:(char)arg7 ;
...
-(void)setUseGPUScaler:(char)arg1 ;
