...
@property (assign) unsigned long scalingBufferSize;              //@synthesize scalingBufferSize=_scalingBufferSize - In the implementation block
...
-(vImage_Buffer*)crop;
-(float*)desc;
-(char)preProcessImage:(vImage_Buffer*)arg1 error:(id*)arg2 ;
