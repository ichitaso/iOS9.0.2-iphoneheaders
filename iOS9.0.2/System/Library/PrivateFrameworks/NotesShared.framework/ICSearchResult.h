...
@property (nonatomic,readonly) unsigned relevance;                              //@synthesize relevance=_relevance - In the implementation block
...
+(char)canFitAttributedString:(id)arg1 ellipses:(id)arg2 shouldPrefixWithEllipses:(char)arg3 insideFrame:(CGRect)arg4 ;
...
-(id)initWithObject:(id)arg1 relevance:(unsigned)arg2 searchString:(id)arg3 highlightString:(id)arg4 ;
-(id)initWithObject:(id)arg1 relevance:(unsigned)arg2 searchString:(id)arg3 ;
