...
@property (getter=isAuthenticating) char authenticating;                     //@synthesize authenticating=_authenticating - In the implementation block
...
@property (assign) char forceAuthentication;                                 //@synthesize forceAuthentication=_forceAuthentication - In the implementation block
...
-(void)_authenticateUsingAuthUI:(char)arg1 authUIDismissHandler:(/*^block*/id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(char)forceAuthentication;
-(void)setForceAuthentication:(char)arg1 ;
...
-(void)authenticateUsingAuthUIAllowingAppleIDCreation:(char)arg1 usernameEditable:(char)arg2 dismissHandler:(/*^block*/id)arg3 completionHandler:(/*^block*/id)arg4 ;
