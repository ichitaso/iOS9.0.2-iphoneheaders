...
-(void)animateFoundCode:(id)arg1 codePosition:(CGPoint)arg2 codeFrameIndex:(unsigned)arg3 cardHolder:(id)arg4 cardholderPosition:(CGPoint)arg5 cardholderFrameIndex:(unsigned)arg6 expDate:(id)arg7 expdatePosition:(CGPoint)arg8 expDateFrameIndex:(unsigned)arg9 completionBlock:(/*^block*/id)arg10 ;
