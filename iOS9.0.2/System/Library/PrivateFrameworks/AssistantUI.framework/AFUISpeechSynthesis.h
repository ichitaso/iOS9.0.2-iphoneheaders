...
-(void)cancel;
-(void)invalidate;
-(void)enqueueText:(id)arg1 isPhonetic:(char)arg2 provisionally:(char)arg3 eligibleAfterDuration:(double)arg4 preparationIdentifier:(id)arg5 completion:(/*^block*/id)arg6 animationIdentifier:(id)arg7;
