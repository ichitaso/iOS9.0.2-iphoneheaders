...
-(void)_fireResultHandlerWithResult:(id)arg1 error:(id)arg2 final:(char)arg3 ;
-(id)_initWithRequest:(id)arg1 queue:(id)arg2 languageCode:(id)arg3 taskHint:(int)arg4 resultHandler:(/*^block*/id)arg5 ;
@end
