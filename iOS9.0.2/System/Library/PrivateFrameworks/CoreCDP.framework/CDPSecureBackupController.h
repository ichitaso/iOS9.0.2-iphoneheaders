...
-(void)_enableSecureBackupWithSecret:(id)arg1 secretType:(unsigned)arg2 useCachedSecret:(char)arg3 completion:(/*^block*/id)arg4 ;
-(void)disableSecureBackupWithCompletion:(/*^block*/id)arg1 ;
-(void)getBackupRecordDevicesWithCompletion:(/*^block*/id)arg1 ;
-(id)_clientMetadataWithSecretType:(unsigned)arg1 length:(unsigned)arg2 ;
-(id)_sanitizedInfoDictionary:(id)arg1 ;
-(void)_recoverSecureBackupWithSecret:(id)arg1 isSilentAttempt:(char)arg2 device:(id)arg3 useCachedSecret:(char)arg4 completion:(/*^block*/id)arg5 ;
-(int)_circleStatus;
...
-(void)enableSecureBackupWithSecret:(id)arg1 secretType:(unsigned)arg2 useCachedSecret:(char)arg3 completion:(/*^block*/id)arg4 ;
-(void)attemptSilentRecoveryWithLocalSecret:(id)arg1 useCachedSecret:(char)arg2 completion:(/*^block*/id)arg3 ;
