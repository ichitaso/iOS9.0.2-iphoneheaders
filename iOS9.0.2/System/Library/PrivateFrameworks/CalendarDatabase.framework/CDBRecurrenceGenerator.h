...
-(id)copyOccurrenceDatesBetweenStartDate:(SCD_Struct_CD7)arg1 endDate:(SCD_Struct_CD7)arg2 timeZone:(id)arg3 limit:(int)arg4 ;
-(id)computeRecurrenceEndDate:(unsigned)arg1 ;
...
-(id)copyOccurrenceDatesWithCalEvent:(void*)arg1 startDate:(SCD_Struct_CD7)arg2 endDate:(SCD_Struct_CD7)arg3 timeZone:(id)arg4 limit:(int)arg5 locked:(char)arg6 ;
-(void)_setupForCalEvent:(void*)arg1 locked:(char)arg2 ;
-(id)_copyOccurrenceDatesWithBirthdayEvent:(void*)arg1 startDate:(SCD_Struct_CD7)arg2 endDate:(SCD_Struct_CD7)arg3 timeZone:(id)arg4 limit:(int)arg5 locked:(char)arg6 ;
...
-(char)_validateCalDate:(SCD_Struct_CD7)arg1 pinned:(char)arg2 ;
