...
+(char)didChooseToMigrateNote:(id)arg1 context:(NoteContext*)arg2 ;
+(id)searchIndexableObjectWithIdentifier:(id)arg1 includeDeleted:(char)arg2 inNoteContext:(id)arg3 ;
-(id)identifier;
-(NSString *)content;
