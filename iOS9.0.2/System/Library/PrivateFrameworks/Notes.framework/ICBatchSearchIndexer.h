...
@interface ICBatchSearchIndexer : NSObject <ICSearchIndexDelegate, ICSearchIndexingBatchQueueDelegate, ICSearchIndexer> {
	...
	char _waitingForGroupInSynchronousRunMode;
...
@property (assign,nonatomic) char isResumed;                                                                 //@synthesize isResumed=_isResumed - In the implementation block
@property (assign,nonatomic) char isIndexing;                                                                //@synthesize isIndexing=_isIndexing - In the implementation block
...
@property (assign,nonatomic) char hasScheduledIndexing;                                                      //@synthesize hasScheduledIndexing=_hasScheduledIndexing - In the implementation block
...
@property (assign,nonatomic) char waitingForGroupInSynchronousRunMode;                                       //@synthesize waitingForGroupInSynchronousRunMode=_waitingForGroupInSynchronousRunMode - In the implementation block
@property (nonatomic,readonly) char synchronous; 
...
-(void)indexerContextObjectsDidChangeWithUpdateCount:(unsigned)arg1 deletedIdentifiers:(id)arg2 addedIdentifiers:(id)arg3 updatedIdentifiers:(id)arg4 immediateIdentifiers:(id)arg5 ;
...
-(char)addOperation:(id)arg1 forSearchIndexableIdentifier:(id)arg2 ;
-(void)removeAllIndexingOperations;
-(void)setIsIndexing:(char)arg1 ;
-(void)disableIndexing;
-(ICSelectorDelayer *)scheduleProcessingAfterUnpauseDelayer;
-(char)isResumed;
-(char)searchIndexesCanStartNextBatch;
-(char)canProcessImmediateIdentifiers;
...
-(char)waitingForGroupInSynchronousRunMode;
-(void)setWaitingForGroupInSynchronousRunMode:(char)arg1 ;
-(void)waitForGroupToComplete;
-(char)addDocumentWithSearchStringsFromSearchIndexable:(id)arg1 searchIndexableIdentifier:(id)arg2 ;
...
-(char)hasPendingDidChangeIdentifiers;
-(id)queryableIndex;
...
-(char)hasScheduledIndexing;
-(void)setHasScheduledIndexing:(char)arg1 ;
