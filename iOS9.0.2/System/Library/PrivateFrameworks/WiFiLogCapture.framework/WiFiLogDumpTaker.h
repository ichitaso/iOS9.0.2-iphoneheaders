...
@interface WiFiLogDumpTaker : NSObject {
	...
	char _didLastCaptureFallback;

}

@property (nonatomic,readonly) char didLastCaptureFallback;              //@synthesize didLastCaptureFallback=_didLastCaptureFallback - In the implementation block
-(id)init;
