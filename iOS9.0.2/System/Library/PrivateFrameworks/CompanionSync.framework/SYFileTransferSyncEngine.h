...
-(void)_handleSessionRestart:(id)arg1 priority:(int)arg2 options:(id)arg3 userContext:(id)arg4 callback:(/*^block*/id)arg5 ;
-(char)_shouldTreatAsSessionEnd:(id)arg1 ;
-(void)_reallyHandleSessionRestart:(id)arg1 priority:(int)arg2 options:(id)arg3 userContext:(id)arg4 callback:(/*^block*/id)arg5 ;
