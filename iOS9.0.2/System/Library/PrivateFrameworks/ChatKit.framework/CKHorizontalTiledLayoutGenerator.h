...
-(char)_addColumnWithTiles:(SCD_Struct_CK10*)arg1 imageFrames:(CGRect*)arg2 count:(int)arg3 ;
-(char)_addColumnWithContiguousTiles:(SCD_Struct_CK10*)arg1 count:(int)arg2 ;
-(char)_hasLeftSuboptimalColumn;
-(char)_parseSpecialSubsequenceWithColumnRequired:(char)arg1 columnParsed:(char*)arg2 ;
-(char)_scanSpecialSequenceColumn:(SCD_Struct_CK10*)arg1 count:(int*)arg2 ;
-(char)_isAtEndOfColumn;
-(void)_enumerateColumnFramesWithContiguousTiles:(SCD_Struct_CK10*)arg1 count:(int)arg2 useMagneticGuidelines:(char)arg3 block:(/*^block*/id)arg4 ;
@end
