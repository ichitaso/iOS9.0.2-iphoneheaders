...
-(id)tileBatchIDBlock;
-(char)scanTile:(SCD_Struct_CK10*)arg1 passingTest:(/*^block*/id)arg2 ;
-(char)scanTile:(SCD_Struct_CK10*)arg1 ofType:(int)arg2 ;
...
-(char)scanAnyTile:(SCD_Struct_CK10*)arg1 ;
-(char)scanTileWithPortraitImage:(SCD_Struct_CK10*)arg1 ;
-(char)scanTileWithLandscapeImage:(SCD_Struct_CK10*)arg1 ;
-(char)scanTileWithHorizontalPanorama:(SCD_Struct_CK10*)arg1 ;
-(char)scanTileWithSquareImage:(SCD_Struct_CK10*)arg1 ;
-(char)scanTile:(SCD_Struct_CK10*)arg1 type:(int*)arg2 ;
