...
@property (assign,nonatomic) float transcriptWidth;                                                  //@synthesize transcriptWidth=_transcriptWidth - In the implementation block
...
-(id)initWithConversation:(id)arg1 transcriptWidth:(float)arg2 layoutMargins:(UIEdgeInsets)arg3 ;
