...
@property (assign,nonatomic) char defaultStateSelected;                                             //@synthesize defaultStateSelected=_defaultStateSelected - In the implementation block
...
-(void)setDefaultStateSelected:(char)arg1 ;
-(id)_assetForIndexPath:(id)arg1 collectionView:(id)arg2 ;
-(char)defaultStateSelected;
