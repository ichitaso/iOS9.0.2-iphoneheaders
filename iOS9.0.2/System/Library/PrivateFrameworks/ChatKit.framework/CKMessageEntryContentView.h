...
@property (assign,nonatomic) char isCompositionExpirable;                                                          //@synthesize isCompositionExpirable=_isCompositionExpirable - In the implementation block
...
-(char)isCompositionExpirable;
-(void)invalidateComposition;
-(void)setIsCompositionExpirable:(char)arg1 ;
