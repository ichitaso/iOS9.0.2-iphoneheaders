...
@property (assign,nonatomic) char fmfDisabled;                                                           //@synthesize fmfDisabled=_fmfDisabled - In the implementation block
@property (assign,nonatomic) char fmfRestricted;                                                         //@synthesize fmfRestricted=_fmfRestricted - In the implementation block
...
-(void)setFmfDisabled:(char)arg1 ;
-(void)setFmfRestricted:(char)arg1 ;
-(void)_refreshFaceTimeIDSStatusWithCompletion:(/*^block*/id)arg1 ;
-(void)_setupFMFUpdateTimerIfNecessary;
-(char)_shouldShowEnhancedGroupFeatures;
...
-(char)_shouldShowActiveDeviceSwitchFooter;
-(char)fmfRestricted;
-(void)_presentGroupRecipientSelectionController;
-(void)_sendCurrentLocation;
-(void)_presentSharingActionSheet:(char)arg1 fromView:(id)arg2 ;
...
-(char)_showFaceTimeVideoButtonForEntity:(id)arg1 ;
-(char)_showEmailButtonForEntity:(id)arg1 ;
-(char)_showPhoneButtonForEntity:(id)arg1 ;
-(void)sendEmailAction:(id)arg1 ;
-(void)facetimeVideoAction:(id)arg1 ;
-(void)phoneCallAction:(id)arg1 ;
-(void)infoAction:(id)arg1 ;
-(char)_isTelephonyDevice;
-(int)_facetimeAudioIDStatusForEntity:(id)arg1 ;
-(char)_isFaceTimeAudioAvailable;
-(char)_hasLinkedTelephoneNumbersForEntity:(id)arg1 ;
-(char)_isFaceTimeVideoAvailable;
...
-(void)_startFacetimeCommunicationForEntity:(id)arg1 audioOnly:(char)arg2 ;
-(void)_showContactCardForEntity:(id)arg1 fromView:(id)arg2 ;
-(void)_requestCallTypeForEntity:(id)arg1 withAddresses:(id)arg2 withLabels:(id)arg3 faceTimeAudioEnabled:(char)arg4 ;
