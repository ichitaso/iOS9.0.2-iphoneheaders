...
@property (nonatomic,readonly) unsigned activationMode;                           //@synthesize activationMode=_activationMode - In the implementation block
...
-(id)initWithActionBlock:(/*^block*/id)arg1 remoteViewControllerClassName:(id)arg2 remoteServiceBundleIdentifier:(id)arg3 actionIdentifier:(id)arg4 activationMode:(unsigned)arg5 behavior:(unsigned)arg6 parameters:(id)arg7 ;
-(id)actionBlock;
