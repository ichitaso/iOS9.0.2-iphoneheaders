...
-(id)_nonHeaderData;
-(id)initWithSequenceNumber:(unsigned)arg1 streamID:(unsigned short)arg2 expectsPeerResponse:(char)arg3 wantsAppAck:(char)arg4 compressed:(char)arg5 peerResponseIdentifier:(id)arg6 messageUUID:(id)arg7 data:(id)arg8 expiryDate:(id)arg9 ;
-(char)compressed;
