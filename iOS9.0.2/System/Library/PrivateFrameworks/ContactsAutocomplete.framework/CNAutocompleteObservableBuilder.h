...
-(void)setSupplementalResultsUseNetwork:(char)arg1;
...
@interface CNAutocompleteObservableBuilder : NSObject <CNAutocompleteObservableBuilder> {
	...
	char _supplementalResultsUseNetwork;
...
@property (assign,nonatomic) char supplementalResultsUseNetwork;                                              //@synthesize supplementalResultsUseNetwork=_supplementalResultsUseNetwork - In the implementation block
...
+(char)supplementalResultsUseNetwork:(unsigned)arg1 ;
+(id)builderWithSearchType:(unsigned)arg1 scheduler:(id)arg2 probeProvider:(id)arg3 ;
...
-(char)supplementalResultsUseNetwork;
