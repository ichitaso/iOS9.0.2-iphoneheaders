...
-(id)infrequentRecentResultWithDisplayName:(id)arg1 value:(id)arg2 lastSendingAddress:(id)arg3 dateCount:(unsigned)arg4 date:(id)arg5 group:(char)arg6 completesChosenGroup:(char)arg7 ;
...
-(id)recentResultWithDisplayName:(id)arg1 value:(id)arg2 lastSendingAddress:(id)arg3 dateCount:(unsigned)arg4 date:(id)arg5 group:(char)arg6 completesChosenGroup:(char)arg7 ;
@end
