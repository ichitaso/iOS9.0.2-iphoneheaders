...
@property (assign,nonatomic) unsigned currentBatch;                                                          //@synthesize currentBatch=_currentBatch - In the implementation block
...
-(void)setCurrentBatch:(unsigned)arg1 ;
...
-(void)didSelectResult:(id)arg1 atSortedIndex:(unsigned)arg2 ;
