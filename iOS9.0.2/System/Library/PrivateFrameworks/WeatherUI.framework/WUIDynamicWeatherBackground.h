...
-(void)setCity:(id)arg1 animate:(char)arg2 ;
-(void)completeTransitionWithSuccess:(char)arg1 ;
-(id)updateFromCity:(id)arg1 toCity:(id)arg2 ;
-(SCD_Struct_WU0)mixedColorsForIndex:(int)arg1 solarHeight:(float)arg2 condition:(int)arg3 latitude:(float)arg4 ;
-(SCD_Struct_WU1)mixedGradientForSunheight:(double)arg1 hourAngle:(double)arg2 condition:(int)arg3 latitude:(float)arg4 ;
