...
@property (nonatomic,readonly) SCD_Struct_EA0 auditToken;                           //@synthesize auditToken=_auditToken - In the implementation block
...
-(id)initWithCapabilities:(unsigned)arg1 auditToken:(SCD_Struct_EA0)arg2 xpcConnection:(id)arg3 andBundleId:(id)arg4 ;
