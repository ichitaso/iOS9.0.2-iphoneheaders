...
@interface XBApplicationSnapshotManifestImpl : XBApplicationSnapshotManifest <NSCoding, BSDescriptionProviding> {
	...
	char _invalidated;
	char _needsArchiving;
	unsigned _clientCount;
	unsigned _pendingOperations;

}

@property (assign) char needsArchiving;                             //@synthesize needsArchiving=_needsArchiving - In the implementation block
...
+(id)_acquireManifestForApplicationIdentity:(id)arg1 createIfNeeded:(char)arg2 ;
...
-(void)generateImageForSnapshot:(id)arg1 dataProvider:(id)arg2 writeToFile:(char)arg3 didGenerateImage:(/*^block*/id)arg4 didSaveImage:(/*^block*/id)arg5 ;
...
-(void)setNeedsArchiving:(char)arg1 ;
-(char)_imageAccessQueue_saveData:(id)arg1 withContentType:(int)arg2 toPath:(id)arg3 ;
...
-(id)_queue_snapshotGroupForID:(id)arg1 creatingIfNeeded:(char)arg2 ;
...
-(id)allSnapshots;
-(void)generateImageForSnapshot:(id)arg1 dataProvider:(id)arg2 writeToFile:(char)arg3 completion:(/*^block*/id)arg4 ;
-(char)needsArchiving;
-(id)containerPath;
@end
