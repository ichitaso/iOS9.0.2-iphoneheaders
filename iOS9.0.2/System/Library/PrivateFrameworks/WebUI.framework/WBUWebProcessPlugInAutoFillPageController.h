...
@interface WBUWebProcessPlugInAutoFillPageController : WBUWebProcessPlugInPageController <WBUFormAutoFiller, WBUInjectedJavaScriptWebProcessController> {
	...
	unsigned _loadDeferringReasons;
...
@property (nonatomic,readonly) unsigned loadDeferringReasons;                                    //@synthesize loadDeferringReasons=_loadDeferringReasons - In the implementation block
@property (readonly) unsigned hash; 
@property (readonly) Class superclass; 
@property (copy,readonly) NSString * description; 
@property (copy,readonly) NSString * debugDescription; 
-(void)addLoadDeferringReasons:(unsigned)arg1 ;
-(void)removeLoadDeferringReasons:(unsigned)arg1 ;
