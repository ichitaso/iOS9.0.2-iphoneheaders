...
@interface WBUFormMetadataControllerWK2 : WBSFormMetadataController <WKWebProcessPlugInFormDelegatePrivate> {
	...
	char _shouldListenForFormChanges;
...
-(void)dealloc;
-(void)invalidate;
-(void)_webProcessPlugInBrowserContextController:(id)arg1 textDidChangeInTextField:(id)arg2 inFrame:(id)arg3 initiatedByUserTyping:(char)arg4 ;
...
-(char)_webProcessPlugInBrowserContextControllerShouldNotifyOnFormChanges:(id)arg1 ;
...
-(id)_observer;
-(char)_willNavigateFrameWithUnsubmittedForm:(id)arg1 loadingWillBeDeferred:(char)arg2 ;
...
-(char)didStartProvisionalLoadForFrame:(id)arg1 ;
