...
+(id)_insertSourceWithUUID:(id)arg1 bundleIdentifier:(id)arg2 name:(id)arg3 options:(id)arg4 isCurrentDevice:(id)arg5 productType:(id)arg6 deleted:(char)arg7 modificationDate:(id)arg8 provenance:(int)arg9 database:(id)arg10 error:(id*)arg11 ;
...
+(id)insertSourceWithUUID:(id)arg1 bundleIdentifier:(id)arg2 name:(id)arg3 options:(unsigned long long)arg4 isCurrentDevice:(char)arg5 productType:(id)arg6 modificationDate:(id)arg7 provenance:(int)arg8 healthDatabase:(id)arg9 error:(id*)arg10 ;
...
-(char)setBundleIdentifier:(id)arg1 UUID:(id)arg2 healthDatabase:(id)arg3 error:(id*)arg4 ;
-(char)deleteSourceWithDatabase:(id)arg1 error:(id*)arg2 ;
@end
