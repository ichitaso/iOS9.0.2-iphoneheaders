...
-(char)createSourcesWithCodables:(id)arg1 provenance:(int)arg2 error:(id*)arg3 ;
-(char)setLocalDeviceSourceUUID:(id)arg1 bundleIdentifier:(id)arg2 error:(id*)arg3 ;
...
-(id)_createSourceEntityForBundleIdentifier:(id)arg1 name:(id)arg2 options:(unsigned long long)arg3 isCurrentDevice:(char)arg4 productType:(id)arg5 error:(id*)arg6 ;
...
-(id)sourceForCodableSource:(id)arg1 provenance:(int)arg2 createIfNecessary:(char)arg3 error:(id*)arg4 ;
