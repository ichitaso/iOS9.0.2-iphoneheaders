...
-(void)_setLastAttemptDate:(id)arg1 completed:(char)arg2 ;
-(id)_predicateForPruningSamplesExcludingTypes:(id)arg1 daysOld:(unsigned)arg2 calendar:(id)arg3 nowDate:(id)arg4 ;
-(id)_predicateForPruningSampleTypes:(id)arg1 daysOld:(unsigned)arg2 calendar:(id)arg3 nowDate:(id)arg4 ;
-(id)_predicateForPruningThirdPartySampleTypes:(id)arg1 daysOld:(unsigned)arg2 calendar:(id)arg3 nowDate:(id)arg4 ;
-(id)_lastAttemptDateWithCompleted:(char*)arg1 ;
