...
-(id)_initWithNanoRegistryUUID:(id)arg1 persistentUUID:(id)arg2 healthUUID:(id)arg3 syncProvenance:(int)arg4 activated:(char)arg5 database:(id)arg6 error:(id*)arg7 ;
-(void)setNanoRegistryUUID:(NSUUID *)arg1 ;
-(void)setSyncProvenance:(int)arg1 ;
-(char)saveWithHealthDatabase:(id)arg1 error:(id*)arg2 ;
@end
