...
-(void)setRequestedAuthorizationForBundleIdentifier:(id)arg1 shareTypes:(id)arg2 readTypes:(id)arg3 prompt:(char)arg4 completion:(/*^block*/id)arg5 ;
...
-(void)suppressActivityAlertsForIdentifier:(id)arg1 suppressionReason:(int)arg2 timeoutUntilDate:(id)arg3 completion:(/*^block*/id)arg4 ;
...
-(void)submitMetricsIgnoringAnchor:(char)arg1 completion:(/*^block*/id)arg2 ;
-(void)startFakingDataWithActivityType:(int)arg1 speed:(id)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)select:(id)arg1 from:(id)arg2 where:(id)arg3 groupBy:(id)arg4 orderBy:(id)arg5 limit:(int)arg6 completion:(/*^block*/id)arg7 ;
...
-(char)queryServerShouldObserveInBackground:(id)arg1 ;
...
-(char)queryServer:(id)arg1 isAuthorizedToReadType:(id)arg2 withRestrictedSourceIdentifier:(id*)arg3 authorizationAnchor:(id*)arg4 ;
...
-(char)_queue_insertObjects:(id)arg1 sourceEntity:(id)arg2 sourceVersion:(id)arg3 error:(id*)arg4 ;
