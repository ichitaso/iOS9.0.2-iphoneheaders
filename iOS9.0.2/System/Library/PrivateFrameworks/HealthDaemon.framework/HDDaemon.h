...
@property (readonly) char isAppleWatch; 
...
-(char)_persistDataAndNotify:(id)arg1 provenance:(id)arg2 error:(id*)arg3 ;
...
-(char)persistAndNotifyDataObjects:(id)arg1 device:(id)arg2 error:(id*)arg3 ;
...
-(char)persistAndNotifyDataObject:(id)arg1 device:(id)arg2 error:(id*)arg3 ;
