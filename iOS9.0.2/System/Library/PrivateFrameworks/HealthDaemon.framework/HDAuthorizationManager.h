...
-(char)_queue_resetAuthorizationRecordsForBundleIdentifier:(id)arg1 error:(id*)arg2 ;
-(char)_needsAuthorizationForRequestGroup:(id)arg1 overwriteAuthorizationStatus:(char)arg2 error:(id*)arg3 ;
