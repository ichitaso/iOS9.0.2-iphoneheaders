...
-(void)_notifyObservers:(id)arg1 didUpdateTodayActivityCache:(id)arg2 updatedFields:(unsigned)arg3 error:(id)arg4 ;
...
-(void)_notifyObservers:(id)arg1 didUpdateYesterdayActivityCache:(id)arg2 updatedFields:(unsigned)arg3 error:(id)arg4 ;
-(void)_updateActivityCache:(id)arg1 withSample:(id)arg2 anchor:(long long)arg3 updatedFields:(unsigned*)arg4 ;
-(void)_updateCachedEnergyBurnedGoal:(id)arg1 date:(id)arg2 ;
-(char)_updateEnergyBurnedGoalForActivityCache:(id)arg1 ;
-(id)_predicateForThirdPartyWorkoutsWithTodayActivityCache:(id)arg1 yesterdayActivityCache:(id)arg2 ;
-(void)_digestSample:(id)arg1 anchor:(long long)arg2 todayActivityCache:(id)arg3 todayUpdatedFields:(unsigned*)arg4 yesterdayActivityCache:(id)arg5 yesterdayUpdatedFields:(unsigned*)arg6 ;
