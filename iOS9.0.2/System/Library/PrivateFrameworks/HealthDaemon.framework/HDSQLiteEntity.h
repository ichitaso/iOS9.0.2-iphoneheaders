...
+(char)enumerateQueryResultsFromColumns:(id)arg1 properties:(id)arg2 predicate:(id)arg3 database:(id)arg4 error:(id*)arg5 usingBlock:(/*^block*/id)arg6 ;
...
+(char)enumerateEntitiesInDatabase:(id)arg1 predicate:(id)arg2 error:(id*)arg3 usingBlock:(/*^block*/id)arg4 ;
...
+(char)enumerateQueryResultsFromColumns:(id)arg1 properties:(id)arg2 predicate:(id)arg3 groupBy:(id)arg4 orderingProperties:(id)arg5 limit:(int)arg6 database:(id)arg7 error:(id*)arg8 usingBlock:(/*^block*/id)arg9 ;
+(id)queryWithDatabase:(id)arg1 predicate:(id)arg2 limit:(unsigned)arg3 orderingProperties:(id)arg4 orderingDirections:(id)arg5 groupBy:(id)arg6 ;
...
-(char)booleanForProperty:(id)arg1 database:(id)arg2 ;
...
-(char)getValuesForProperties:(id)arg1 database:(id)arg2 handler:(/*^block*/id)arg3 ;
