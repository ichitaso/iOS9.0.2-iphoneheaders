...
@interface HDDeviceInformationService : HDHealthService {
	...
	char _deviceInformationHasBeenLoaded;
...
@property (assign,nonatomic) char deviceInformationHasBeenLoaded;                                 //@synthesize deviceInformationHasBeenLoaded=_deviceInformationHasBeenLoaded - In the implementation block
...
-(char)deviceInformationHasBeenLoaded;
-(void)setDeviceInformationHasBeenLoaded:(char)arg1 ;
