...
+(id)speechActsForCategory:(unsigned)arg1 platform:(id)arg2 ;
+(id)sharedCollection;
-(void)resetPhraseMap;
...
-(id)responsesForCategory:(unsigned)arg1 gender:(unsigned)arg2 maximumResponses:(unsigned)arg3 withLanguage:(id)arg4 context:(id)arg5 options:(unsigned)arg6 ;
