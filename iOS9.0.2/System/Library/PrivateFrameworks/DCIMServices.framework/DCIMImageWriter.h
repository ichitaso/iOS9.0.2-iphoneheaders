...
+(void)writeableDataForImageData:(id)arg1 thumbnailDataOut:(id*)arg2 imageUTITypeOut:(id*)arg3 exifPropertiesOut:(id*)arg4 isJPEGOut:(char*)arg5 imageDataOut:(id*)arg6 ;
...
+(void)writeableDataForImage:(id)arg1 previewImage:(id)arg2 imageData:(id)arg3 imageUTIType:(CFStringRef)arg4 exifProperties:(id)arg5 imageOrientation:(int)arg6 thumbnailDataOut:(id*)arg7 imageUTITypeOut:(id*)arg8 exifPropertiesOut:(id*)arg9 isJPEGOut:(char*)arg10 imageDataOut:(id*)arg11 ;
