...
@property (nonatomic,readonly) char daemonDelegateIsLocal; 
...
-(void)requestInitialStateIfNecessaryAndSendNotifications:(char)arg1 ;
-(int)connectionRequestNotificationToken;
-(void)_tearDownXPCConnection;
-(id)daemonDelegateWithErrorHandler:(/*^block*/id)arg1 ;
-(char)daemonDelegateIsLocal;
...
-(void)_updateCallModelState:(id)arg1 shouldSendNotifications:(char)arg2 ;
