...
@property (getter=isLoadingResults,nonatomic,readonly) char loadingResults; 
@property (getter=isIndexing,nonatomic,readonly) char indexing;                          //@synthesize indexing=_indexing - In the implementation block
@property (nonatomic,readonly) char hasCompletedIndexing; 
@property (assign,nonatomic) char waitUntilFinished;                                     //@synthesize waitUntilFinished=_waitUntilFinished - In the implementation block
...
@property (assign,nonatomic) char showSectionInDetailText;                               //@synthesize showSectionInDetailText=_showSectionInDetailText - In the implementation block
...
-(void)_beginSearchingEntriesForCurrentQuery:(id)arg1 newSearch:(char)arg2 ;
-(void)_updatedEntry:(id)arg1 withChildren:(id)arg2 ;
-(void)_removeSearchEntries:(id)arg1 usingBlock:(/*^block*/id)arg2 forReload:(char)arg3 ;
...
-(void)_updateWithNewSearchResults:(id)arg1 forQuery:(id)arg2 newSearch:(char)arg3 ;
-(NSArray *)rootEntries;
...
-(char)isIndexing;
-(void)setWaitUntilFinished:(char)arg1 ;
-(char)showSectionInDetailText;
-(void)setShowSectionInDetailText:(char)arg1 ;
@end
