...
@property (getter=isRunningInBuddy,nonatomic,readonly) char runningInBuddy; 
...
@property (assign,nonatomic) char circleWasReset;                                        //@synthesize circleWasReset=_circleWasReset - In the implementation block
...
-(void)_showResetFlowOverController:(id)arg1 withEnableBackupText:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
...
-(char)_resetCircleAndDisableBackupWithError:(id*)arg1 ;
-(void)stopNavigationSpinner;
-(void)showResetAcknowledgementIfNeededWithCompletion:(/*^block*/id)arg1 ;
-(void)setCircleWasReset:(char)arg1 ;
-(void)_disableKeychainSyncOverController:(id)arg1 deletingSafariPasswords:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
-(char)_errorRequiresPasswordPrompt:(id)arg1 ;
...
-(char)_registerUserCredentialsName:(id)arg1 rawPassword:(id)arg2 error:(id*)arg3 ;
...
-(void)pinChoiceAlertDidChooseToUseDevicePasscode:(char)arg1 ;
-(id)preferencesApp;
-(char)_changeSecurityCode:(id)arg1 type:(int)arg2 smsTarget:(id)arg3 smsTargetCountryInfo:(id)arg4 username:(id)arg5 passwordOrEquivalentToken:(id)arg6 error:(id*)arg7 ;
...
-(void)joinCircleAfterRecovery:(char)arg1 withCompletion:(/*^block*/id)arg2 ;
