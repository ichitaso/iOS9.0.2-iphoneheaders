...
@interface ISSoftwareApplication : NSObject <SSXPCCoding> {
	...
	char _hasMIDBasedSINF;
	NSNumber* _itemIdentifier;
	NSString* _itemName;
	char _missingRequiredSINF;
	char _placeholder;
...
@property (assign,nonatomic) char hasMIDBasedSINF;                                         //@synthesize hasMIDBasedSINF=_hasMIDBasedSINF - In the implementation block
@property (assign,nonatomic) char missingRequiredSINF;                                     //@synthesize missingRequiredSINF=_missingRequiredSINF - In the implementation block
...
-(void)setHasMIDBasedSINF:(char)arg1 ;
-(char)missingRequiredSINF;
-(void)setMissingRequiredSINF:(char)arg1 ;
-(NSString *)vendorName;
