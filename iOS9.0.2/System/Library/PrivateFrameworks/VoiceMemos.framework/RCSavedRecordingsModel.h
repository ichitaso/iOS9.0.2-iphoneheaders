...
@property (assign,nonatomic) int isSavingDisabledCount;                      //@synthesize isSavingDisabledCount=_isSavingDisabledCount - In the implementation block
...
-(void)_setNextRecordingID:(long long)arg1 save:(char)arg2 ;
...
-(char)_saveIfNecessary:(id*)arg1 ;
-(id)_labelPresetsForQuery:(id)arg1 ;
-(char)__saveManagedObjectContext:(id*)arg1 ;
...
-(void)_enumerateSavedRecordingsAndEntityRevisionInArrayOfManagedObjects:(id)arg1 createIfNeeded:(char)arg2 block:(/*^block*/id)arg3 ;
-(void)_setNextEntityRevisionID:(long long)arg1 save:(char)arg2 ;
-(char)setValue:(id)arg1 forDatabaseProperty:(id)arg2 save:(char)arg3 ;
-(void)enumerateExistingRecordingsWithBlock:(/*^block*/id)arg1 ;
-(void)_deleteOrphanedEntityRevisionsAndSave:(char)arg1 ;
...
-(char)hasExistingRecordingForAudioFile:(id)arg1 ;
