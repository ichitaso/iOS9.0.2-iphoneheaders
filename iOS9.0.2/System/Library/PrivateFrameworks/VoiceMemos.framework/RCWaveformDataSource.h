...
@interface RCWaveformDataSource : NSObject <RCWaveformGeneratorSegmentOutputObserver> {
	...
	char _hasSavedGeneratedWaveform;
...
@property (nonatomic,readonly) char canceled; 
...
@property (nonatomic,readonly) char hasStartedLoading;                                  //@synthesize hasStartedLoading=_hasStartedLoading - In the implementation block
@property (nonatomic,readonly) char hasSavedGeneratedWaveform;                          //@synthesize hasSavedGeneratedWaveform=_hasSavedGeneratedWaveform - In the implementation block
...
-(char)hasStartedLoading;
-(char)hasSavedGeneratedWaveform;
@end
