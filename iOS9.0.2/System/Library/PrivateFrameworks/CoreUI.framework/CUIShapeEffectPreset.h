...
@interface CUIShapeEffectPreset : NSObject {
	...
	SCD_Struct_CU22 _parameterList[35];
...
-(void)_insertEffectTuple:(SCD_Struct_CU23)arg1 atEffectIndex:(unsigned)arg2 ;
...
-(id)initWithConstantPreset:(const SCD_Struct_CU24*)arg1 ;
