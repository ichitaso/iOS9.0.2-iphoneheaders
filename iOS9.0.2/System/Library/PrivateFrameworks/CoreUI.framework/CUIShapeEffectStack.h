...
@interface CUIShapeEffectStack : NSObject {
	...
	SCD_Struct_CU32 colorOverlay;
	BOOL hasInnerGradient;
	SCD_Struct_CU33 innerGradient;
	BOOL hasInnerGlow;
	SCD_Struct_CU34 innerGlow;
	BOOL hasInnerShadow;
	SCD_Struct_CU35 insideShadow;
	BOOL hasOuterGlow;
	SCD_Struct_CU36 outerGlow;
	BOOL hasEngraveShadow;
	SCD_Struct_CU37 engraveShadow;
	BOOL hasExtraShadow;
	SCD_Struct_CU37 extraShadow;
	BOOL hasBevelEmboss;
	SCD_Struct_CU38 emboss;
	float scalefactor;
	int renderStrategy;
...
+(id)gradientWithParameters:(SCD_Struct_CU33*)arg1 inRect:(CGRect)arg2 ;
