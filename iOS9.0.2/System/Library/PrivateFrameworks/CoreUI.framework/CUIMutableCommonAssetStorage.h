...
-(void)_setZeroCodeInfo:(SCD_Struct_CU17)arg1 forKey:(const void*)arg2 withLength:(unsigned long)arg3 inTree:(const void*)arg4 ;
...
-(void)setZeroCodeGlyphInformation:(SCD_Struct_CU17)arg1 forKey:(const void*)arg2 withLength:(unsigned long)arg3 ;
-(void)setZeroCodeBezelInformation:(SCD_Struct_CU17)arg1 forKey:(const void*)arg2 withLength:(unsigned long)arg3 ;
-(char)writeToDisk;
