...
-(char)_setupListenerConnection:(id)arg1 listenerID:(id)arg2 pid:(int)arg3 setupInfo:(id)arg4 entitlements:(id)arg5 setupResponse:(id*)arg6 ;
...
-(char)daemonInterface:(id)arg1 shouldGrantAccessForPID:(int)arg2 auditToken:(SCD_Struct_ID17)arg3 portName:(id)arg4 listenerConnection:(id)arg5 setupInfo:(id)arg6 setupResponse:(id*)arg7 ;
...
-(char)shouldIncludeDefaultDeviceAsDestinationForMessageForFromID:(id)arg1 service:(id)arg2 ;
...
-(void)_ackMessageWithSequenceNumber:(unsigned)arg1 forDeviceID:(id)arg2 priority:(int)arg3 ;
...
-(void)continuityStartScanningForType:(int)arg1 withData:(id)arg2 peers:(id)arg3 withOptions:(id)arg4 messageContext:(id)arg5 ;
-(void)continuityStartScanningForType:(int)arg1 withData:(id)arg2 withOptions:(id)arg3 messageContext:(id)arg4 ;
