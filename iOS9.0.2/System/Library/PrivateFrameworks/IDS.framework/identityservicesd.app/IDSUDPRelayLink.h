...
-(void)sendRelayRequestWithType:(int)arg1 packetBuffer:(SCD_Struct_ID16*)arg2 startTime:(double)arg3 scheduledRexmit:(int)arg4 sendItNow:(char)arg5 ;
...
-(char)processStunPacket:(SCD_Struct_ID16*)arg1 ;
