...
-(unsigned)sendPacketBuffer:(SCD_Struct_ID16*)arg1 destination:(id)arg2 toDeviceID:(id)arg3 ;
-(unsigned)sendPacketBuffer:(SCD_Struct_ID16*)arg1 sourceInterface:(id)arg2 destination:(id)arg3 toDeviceID:(id)arg4 ;
