...
-(void)_queue_removeHandleForTokenStore:(/*function pointer*/void*)arg1 withErrorCode:(int)arg2 underlyingError:(id)arg3 ;
-(void)queue_lookupHandlesForRemoteAlertWithConfiguration:(id)arg1 creatingIfNone:(char)arg2 withCompletion:(/*^block*/id)arg3 ;
