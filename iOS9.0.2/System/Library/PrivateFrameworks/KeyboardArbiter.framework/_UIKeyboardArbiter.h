...
-(void)processWithPID:(int)arg1 foreground:(char)arg2 suspended:(char)arg3 ;
...
-(char)handler:(id)arg1 activateSceneLayer:(id)arg2 ;
...
-(char)handler:(id)arg1 deactivateSceneLayer:(id)arg2 ;
-(void)handleUnexpectedDeallocForHandler:(id)arg1 ;
-(void)updateSuppression:(char)arg1 ofPIDs:(id)arg2 ;
-(void)reevaluateSceneSettings;
-(id)handlerForBundleID:(id)arg1 ;
-(void)transition:(id)arg1 eventStage:(unsigned)arg2 withInfo:(id)arg3 fromHandler:(id)arg4 ;
