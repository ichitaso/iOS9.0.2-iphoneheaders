...
+(void)_enumerateEmphasisRangesInString:(id)arg1 withEmphasisSubstring:(id)arg2 options:(unsigned)arg3 usingBlock:(/*^block*/id)arg4 ;
...
+(id)attributedStringWithString:(id)arg1 emphasisSubstring:(id)arg2 options:(unsigned)arg3 regularTextAttributes:(id)arg4 emphasizedTextAttributes:(id)arg5 ;
