...
@property (assign,nonatomic) char vibrancyEnabled;                          //@synthesize vibrancyEnabled=_vibrancyEnabled - In the implementation block
...
-(void)setVibrancyEnabled:(char)arg1 ;
-(char)vibrancyEnabled;
