...
-(void)makeNewIncomingTransferWithGUID:(id)arg1 filename:(id)arg2 isDirectory:(char)arg3 totalBytes:(unsigned long long)arg4 hfsType:(unsigned long)arg5 hfsCreator:(unsigned long)arg6 hfsFlags:(unsigned short)arg7 ;
-(void)makeNewOutgoingTransferWithGUID:(id)arg1 filename:(id)arg2 isDirectory:(char)arg3 totalBytes:(unsigned long long)arg4 hfsType:(unsigned long)arg5 hfsCreator:(unsigned long)arg6 hfsFlags:(unsigned short)arg7 ;
...
-(id)guidForNewIncomingTransferWithFilename:(id)arg1 isDirectory:(char)arg2 totalBytes:(unsigned long long)arg3 hfsType:(unsigned long)arg4 hfsCreator:(unsigned long)arg5 hfsFlags:(unsigned short)arg6 ;
-(id)guidForNewOutgoingTransferWithFilename:(id)arg1 isDirectory:(char)arg2 totalBytes:(unsigned long long)arg3 hfsType:(unsigned long)arg4 hfsCreator:(unsigned long)arg5 hfsFlags:(unsigned short)arg6 ;
