...
-(void)_doLoginIgnoringProxy:(char)arg1 withAccount:(id)arg2 ;
...
-(void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(char)arg4 account:(id)arg5 completionBlock:(/*^block*/id)arg6 ;
...
-(void)didReceiveError:(unsigned)arg1 forMessageID:(id)arg2 forceError:(char)arg3 account:(id)arg4 ;
-(void)noteSuppressedMessageUpdate:(id)arg1 ;
-(void)_updateExpireStateForMessageGUID:(id)arg1 ;
-(char)_didReceiveMessageDeliveryReceiptForMessageID:(id)arg1 attempts:(int)arg2 date:(id)arg3 account:(id)arg4 ;
...
-(void)_didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(char)arg5 date:(id)arg6 attempts:(int)arg7 useMessageSuppression:(char)arg8 account:(id)arg9 completionBlock:(/*^block*/id)arg10 ;
...
-(void)notifyDidSendMessageID:(id)arg1 account:(id)arg2 shouldNotify:(char)arg3 ;
...
-(void)processMessageForSending:(id)arg1 toChat:(id)arg2 style:(unsigned char)arg3 allowWatchdog:(char)arg4 completionBlock:(/*^block*/id)arg5 ;
...
-(char)didReceiveMessageDeliveryReceiptForMessageID:(id)arg1 date:(id)arg2 account:(id)arg3 ;
...
-(void)didReceiveMessageSavedForMessageID:(id)arg1 ofType:(long long)arg2 forChat:(id)arg3 fromHandle:(id)arg4 fromMe:(char)arg5 date:(id)arg6 useMessageSuppression:(char)arg7 account:(id)arg8 completionBlock:(/*^block*/id)arg9 ;
