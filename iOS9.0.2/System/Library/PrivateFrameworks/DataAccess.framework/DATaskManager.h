...
@property (assign,nonatomic) char didLogSyncStart;                                  //@synthesize didLogSyncStart=_didLogSyncStart - In the implementation block
...
-(void)setDidLogSyncStart:(char)arg1 ;
