...
-(id)_copyCalendarItemActionsInContainer:(void*)arg1 existingActions:(id)arg2 dataHandler:(id)arg3 wantPreserveActions:(char)arg4 skippedDetachments:(id)arg5 changeContext:(id)arg6 ;
...
-(char)_isOrganizerSelfWithLocalEvent:(void*)arg1 ;
...
-(char)_isDetachmentFromEventId:(id)arg1 ;
