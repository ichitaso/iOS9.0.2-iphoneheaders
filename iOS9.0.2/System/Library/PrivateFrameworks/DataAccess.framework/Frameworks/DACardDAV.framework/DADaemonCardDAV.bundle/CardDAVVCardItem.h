...
-(char)saveWithLocalObject:(void*)arg1 toContainer:(void*)arg2 containerURL:(id)arg3 shouldMergeProperties:(char)arg4 outMergeDidChooseLocalProperties:(char*)arg5 account:(id)arg6 shouldSaveGroups:(char)arg7 ;
-(id)initWithABRecord:(void*)arg1 outNeedsDBSave:(char*)arg2 maxImageSize:(int)arg3 maxResourceSize:(int)arg4 inContainerWithURL:(id)arg5 ;
-(void)setUUIDToPersonCache:(NSMutableDictionary *)arg1 ;
-(char)saveIfGroupWithLocalObject:(void*)arg1 toContainer:(void*)arg2 shouldMergeProperties:(char)arg3 outMergeDidChooseLocalProperties:(char*)arg4 account:(id)arg5 ;
