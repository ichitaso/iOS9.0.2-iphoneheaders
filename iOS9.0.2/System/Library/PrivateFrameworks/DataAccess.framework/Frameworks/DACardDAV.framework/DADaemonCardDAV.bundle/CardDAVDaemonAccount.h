...
@property (assign,nonatomic) char hasOutstandingABChanges;                                //@synthesize hasOutstandingABChanges=_hasOutstandingABChanges - In the implementation block
...
-(char)setBestMeCard;
-(char)finishInitialSyncOfContactsFolder:(id)arg1 previousTag:(id)arg2 uuidsToAddActions:(id)arg3 hrefsToModDeleteActions:(id)arg4 useCRUD:(char)arg5 maxResources:(int)arg6 maxSize:(int)arg7 consumer:(id)arg8 ;
-(char)_fillOutExternalURLForRecordType:(unsigned)arg1 localId:(int)arg2 changeType:(int)arg3 inFolderWithURL:(id)arg4 outNewExternalURL:(id*)arg5 outTouchedDB:(char*)arg6 ;
...
-(char)isForgivableError:(id)arg1 ;
...
-(char)_handleOrphanarium:(id)arg1 toBeCreatedContainersByURL:(id)arg2 ;
...
-(char)_serverMeCard:(void*)arg1 hasChangedInContainer:(void*)arg2 ;
-(char)_reallyUpdateMeCardWithWithConsumer:(id)arg1 allowDistantUpdate:(char)arg2 ;
-(void)setHomeURL:(NSURL *)arg1 ;
-(NSURL *)meFolderURL;
-(void)setMeFolderURL:(NSURL *)arg1 ;
-(char)hasOutstandingABChanges;
-(void)setHasOutstandingABChanges:(char)arg1 ;
