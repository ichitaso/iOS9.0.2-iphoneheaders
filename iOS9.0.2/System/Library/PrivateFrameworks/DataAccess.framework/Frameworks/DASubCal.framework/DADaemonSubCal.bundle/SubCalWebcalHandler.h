...
@interface SubCalWebcalHandler : NSObject <DAValidityCheckConsumer, DADataclassLockWatcher> {
	...
	char _haveShownSubscribeAlert;
	char _haveTriedHTTPS;
...
@property (assign,nonatomic) char haveShownSubscribeAlert;                                 //@synthesize haveShownSubscribeAlert=_haveShownSubscribeAlert - In the implementation block
@property (assign,nonatomic) char haveTriedHTTPS;                                          //@synthesize haveTriedHTTPS=_haveTriedHTTPS - In the implementation block
...
-(char)haveShownSubscribeAlert;
-(void)setHaveShownSubscribeAlert:(char)arg1 ;
-(void)_showSubscribeAccount;
-(void)_showAuthPrompt;
-(char)haveTriedHTTPS;
-(void)setHaveTriedHTTPS:(char)arg1 ;
