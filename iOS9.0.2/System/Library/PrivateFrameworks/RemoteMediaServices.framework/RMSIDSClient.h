...
@property (assign,getter=isCompanionAvailable,nonatomic) char companionAvailable;              //@synthesize companionAvailable=_companionAvailable - In the implementation block
...
-(void)_invokeBeginDiscoveryResponseBlock:(id)arg1 success:(char)arg2 session:(int)arg3 ;
...
-(void)setLikedState:(int)arg1 itemID:(unsigned long long)arg2 databaseID:(unsigned long long)arg3 sessionIdentifier:(int)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(void)requestArtworkDataForNowPlayingInfo:(id)arg1 width:(unsigned long)arg2 height:(unsigned long)arg3 compressionQuality:(float)arg4 completionHandler:(/*^block*/id)arg5 ;
