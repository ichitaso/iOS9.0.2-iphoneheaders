...
@class NSDictionary, SPSafariDatastore, NSString;

@interface SPSafariDatastoreToken : NSObject <SDSearchToken> {

	char _canceled;
	SPSafariDatastore* _store;

}

@property (readonly) SPSafariDatastore * store;                          //@synthesize store=_store - In the implementation block
