...
+(id)_statisticsCollectionQueryFromDate:(id)arg1 toDate:(id)arg2 intervalSize:(id)arg3 dataType:(id)arg4 predicate:(id)arg5 sendUpdates:(char)arg6 seperateBySource:(char)arg7 handler:(/*^block*/id)arg8 ;
...
+(id)statisticsCollectionQueryForDate:(id)arg1 intervalSize:(id)arg2 dataType:(id)arg3 predicate:(id)arg4 sendUpdates:(char)arg5 seperateBySource:(char)arg6 handler:(/*^block*/id)arg7 ;
+(id)statisticsCollectionQueryFromDate:(id)arg1 toDate:(id)arg2 intervalSize:(id)arg3 dataType:(id)arg4 predicate:(id)arg5 sendUpdates:(char)arg6 seperateBySource:(char)arg7 handler:(/*^block*/id)arg8 ;
