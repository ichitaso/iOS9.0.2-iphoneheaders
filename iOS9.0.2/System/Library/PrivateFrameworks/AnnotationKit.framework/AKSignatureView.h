...
@property (assign) unsigned totalPointsAdded;                                       //@synthesize totalPointsAdded=_totalPointsAdded - In the implementation block
...
-(unsigned)totalPointsAdded;
-(void)setTotalPointsAdded:(unsigned)arg1 ;
...
-(char)ak_forceAvailableForTouch:(id)arg1 ;
