...
@property (assign) float baselineOffset;               //@synthesize baselineOffset=_baselineOffset - In the implementation block
...
-(id)initWithPath:(CGPathRef)arg1 baselineOffset:(float)arg2 creationDate:(id)arg3 ;
-(char)shouldPersist;
-(void)setShouldPersist:(char)arg1 ;
-(id)initWithPath:(CGPathRef)arg1 baselineOffset:(float)arg2 ;
-(CGRect)pathBounds;
-(NSUUID *)uniqueID;
