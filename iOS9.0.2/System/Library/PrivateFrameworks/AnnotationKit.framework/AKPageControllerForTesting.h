...
@property (assign) unsigned testingPageIndex;                                                 //@synthesize testingPageIndex=_testingPageIndex - In the implementation block
...
-(void)setTestingPageIndex:(unsigned)arg1 ;
