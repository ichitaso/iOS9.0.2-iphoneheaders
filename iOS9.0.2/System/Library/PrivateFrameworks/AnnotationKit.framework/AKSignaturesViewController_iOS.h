...
@property (assign,nonatomic) char presentedInAlert;                                               //@synthesize presentedInAlert=_presentedInAlert - In the implementation block
...
-(void)setPresentedInAlert:(char)arg1 ;
-(float)idealHeight;
-(char)presentedInAlert;
-(void)_configureUI;
