...
+(CGPathRef)_newRectanglePathForAnnotation:(id)arg1 withPageController:(id)arg2 outLineWidth:(float*)arg3 ;
+(void)_pixelAlignedBaseRect:(CGRect*)arg1 interiorRect:(CGRect*)arg2 scaleFactor:(float*)arg3 forAnnotation:(id)arg4 withPageController:(id)arg5 ;
@end
