...
@property (assign) float lastRotationAngleInRotationGesture;                      //@synthesize lastRotationAngleInRotationGesture=_lastRotationAngleInRotationGesture - In the implementation block
...
-(char)_hitTestAnnotationsIncludingPOI:(char)arg1 atPointInWindow:(CGPoint)arg2 outAnnotation:(id*)arg3 ;
