...
-(char)_addLanguageModelCompletionsForPartialWordRange:(NSRange)arg1 language:(id)arg2 connection:(PR_DB_IO*)arg3 sender:(id)arg4 encoding:(unsigned long)arg5 tagger:(id)arg6 taggerIndex:(unsigned)arg7 appIdentifier:(id)arg8 candidates:(id)arg9 ;
...
-(id)_rankedCandidatesForRange:(NSRange)arg1 candidateList:(id)arg2 language:(id)arg3 tagger:(id)arg4 taggerIndex:(unsigned)arg5 appIdentifier:(id)arg6 ;
...
-(void)_addBasicGuessesForWordBuffer:(char*)arg1 length:(unsigned)arg2 language:(id)arg3 connection:(PR_DB_IO*)arg4 sender:(id)arg5 minAutocorrectionLength:(unsigned)arg6 previousLetter:(unsigned short)arg7 nextLetter:(unsigned short)arg8 toGuesses:(id)arg9 ;
