...
@interface PLAppTimeService : PLService {
	...
	char _inCallNow;
	char _pluggedInBetweenCoalitionSBC;
	char _audioPlayingNow;
	char _musicPlayerForeground;
...
@property (assign) char displayOn;                                                                   //@synthesize displayOn=_displayOn - In the implementation block
...
@property (assign) char inCallNow;                                                                   //@synthesize inCallNow=_inCallNow - In the implementation block
...
@property (assign) char pluggedInBetweenCoalitionSBC;                                                //@synthesize pluggedInBetweenCoalitionSBC=_pluggedInBetweenCoalitionSBC - In the implementation block
...
@property (assign) char audioPlayingNow;                                                             //@synthesize audioPlayingNow=_audioPlayingNow - In the implementation block
@property (assign) char musicPlayerForeground;                                                       //@synthesize musicPlayerForeground=_musicPlayerForeground - In the implementation block
...
-(void)setPluggedInBetweenCoalitionSBC:(char)arg1 ;
-(void)setDisplayOn:(char)arg1 ;
-(char)displayOn;
-(void)setLastScreenOnTime:(NSDate *)arg1 ;
-(void)setInCallNow:(char)arg1 ;
...
-(char)audioPlayingNow;
-(void)setAudioPlayingNow:(char)arg1 ;
...
-(char)pluggedInBetweenCoalitionSBC;
...
-(void)setMusicPlayerForeground:(char)arg1 ;
