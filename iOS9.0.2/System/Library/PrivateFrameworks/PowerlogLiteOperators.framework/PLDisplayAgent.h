...
@interface PLDisplayAgent : PLAgent {
	...
	char _alsOn;
	char _userTouch;
	char _isMultitouchLoggingEnabled;
...
@property (assign) char userTouch;                                                        //@synthesize userTouch=_userTouch - In the implementation block
...
@property (assign) char isMultitouchLoggingEnabled;                                       //@synthesize isMultitouchLoggingEnabled=_isMultitouchLoggingEnabled - In the implementation block
...
-(void)setIsMultitouchLoggingEnabled:(char)arg1 ;
-(NSString *)displayHardware;
-(char)isMultitouchLoggingEnabled;
...
-(void)logEventBackwardUserTouch:(char)arg1 ;
