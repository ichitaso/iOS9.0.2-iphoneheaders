...
-(void)formatArray:(unsigned*)arg1 ofSize:(unsigned)arg2 inString:(id)arg3 inReverse:(char)arg4 ;
-(void)formatArray:(unsigned*)arg1 ofSize:(unsigned)arg2 withMultiplier:(float)arg3 inString:(id)arg4 inReverse:(char)arg5 ;
