...
@property (assign) int spotlightAgentIndexOperationCount;                                                                   //@synthesize spotlightAgentIndexOperationCount=_spotlightAgentIndexOperationCount - In the implementation block
...
@property (assign) int peekpopProcessID;                                                                                    //@synthesize peekpopProcessID=_peekpopProcessID - In the implementation block
@property (retain) NSDate * peekStartTime;                                                                                  //@synthesize peekStartTime=_peekStartTime - In the implementation block
@property (assign) int peekCount;                                                                                           //@synthesize peekCount=_peekCount - In the implementation block
@property (assign) int popCount;                                                                                            //@synthesize popCount=_popCount - In the implementation block
