...
@interface WeatherInMemoryDefaults : NSObject <WeatherPreferencesPersistence> {
	...
	char _synchronizeWasCalled;
	NSMutableDictionary* _inMemoryStore;

}

@property (readonly) char synchronizeWasCalled;                      //@synthesize synchronizeWasCalled=_synchronizeWasCalled - In the implementation block
