...
-(void)_setSizeOfResourcesToUpload:(unsigned long long)arg1 sizeOfOriginalResourcesToUpload:(unsigned long long)arg2 numberOfImages:(unsigned)arg3 numberOfVideos:(unsigned)arg4 numberOfOtherItems:(unsigned)arg5 ;
