...
-(void)notifyAttachedObjectsSizeOfResourcesToUploadDidChangeToSize:(unsigned long long)arg1 sizeOfOriginalResourcesToUpload:(unsigned long long)arg2 numberOfImages:(unsigned)arg3 numberOfVideos:(unsigned)arg4 numberOfOtherItems:(unsigned)arg5 ;
...
-(void)reportRadar:(unsigned)arg1 ;
-(unsigned)totalAssetCountOnServer;
