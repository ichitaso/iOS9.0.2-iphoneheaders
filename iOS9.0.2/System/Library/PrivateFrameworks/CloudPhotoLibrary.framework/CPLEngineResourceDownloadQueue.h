...
-(id)dequeueBackgroundDownloadTasks:(unsigned)arg1 forResourceType:(unsigned)arg2 eachWithCompletionHandler:(/*^block*/id)arg3 ;
...
-(unsigned)_availableSlotsForDownloadTaskGroupsOfHighPriority:(char)arg1 ;
-(char)_deferOneLowPriorityActiveTaskGroup;
-(void)_dequeueTasks:(id*)arg1 taskGroups:(id*)arg2 maxTaskGroupCount:(unsigned)arg3 ofHighPriority:(char)arg4 ;
