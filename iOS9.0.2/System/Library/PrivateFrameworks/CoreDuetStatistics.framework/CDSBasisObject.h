...
-(char)risingEdge;
-(char)fallingEdge;
-(id)initWithLocalTime:(unsigned long long)arg1 creationDate:(id)arg2 basisValueString:(id)arg3 basisUint64Value:(unsigned long long)arg4 basisDoubleValue:(double)arg5 risingEdge:(char)arg6 fallingEdge:(char)arg7 duration:(double)arg8 attributeId:(unsigned long long)arg9 type:(int)arg10 ;
