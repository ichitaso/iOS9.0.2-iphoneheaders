...
@interface PLAccountingEnergyEstimateEventEntry : PLAccountingEnergyEventEntry {
	...
	char _isRootNodeEnergyAggregated;
...
@property (assign) char isRootNodeEnergyAggregated;                            //@synthesize isRootNodeEnergyAggregated=_isRootNodeEnergyAggregated - In the implementation block
+(void)load;
+(id)entryKey;
...
-(char)isRootNodeEnergyAggregated;
-(NSDate *)distributionDate;
-(int)parentEntryID;
-(NSDate *)qualificationDate;
-(void)setIsRootNodeEnergyAggregated:(char)arg1 ;
