...
@property (assign,nonatomic) int preferredVariant;                                             //@synthesize preferredVariant=_preferredVariant - In the implementation block
@property (assign,nonatomic) char showsVariants;                                               //@synthesize showsVariants=_showsVariants - In the implementation block
@property (assign,getter=isPurchasing,nonatomic) char purchasing;                              //@synthesize purchasing=_purchasing - In the implementation block
...
-(char)showsVariants;
-(void)setShowsVariants:(char)arg1 ;
