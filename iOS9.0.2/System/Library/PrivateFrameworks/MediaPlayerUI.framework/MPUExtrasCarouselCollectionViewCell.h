...
@property (assign,nonatomic) char allowsPinchingThumbnailImageForInteractiveZoomingImageTransition;                                     //@synthesize allowsPinchingThumbnailImageForInteractiveZoomingImageTransition=_allowsPinchingThumbnailImageForInteractiveZoomingImageTransition - In the implementation block
...
-(char)allowsPinchingThumbnailImageForInteractiveZoomingImageTransition;
-(void)setDescriptionText:(id)arg1 ;
-(id)descriptionText;
-(unsigned)itemIndex;
-(void)setItemIndex:(unsigned)arg1 ;
