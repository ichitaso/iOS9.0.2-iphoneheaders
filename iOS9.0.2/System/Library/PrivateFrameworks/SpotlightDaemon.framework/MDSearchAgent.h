...
@property (assign) char finishedQuery;                                                   //@synthesize finishedQuery=_finishedQuery - In the implementation block
+(id)xpcInterface;
+(id)machServiceName;
...
-(char)finishedQuery;
-(char)_convertMDSearchOptionsToSPQueryOptions:(id)arg1 ;
...
-(void)setFinishedQuery:(char)arg1 ;
@end
