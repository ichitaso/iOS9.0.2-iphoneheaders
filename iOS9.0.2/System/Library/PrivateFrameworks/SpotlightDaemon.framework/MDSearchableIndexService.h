...
-(char)_bundleIsInTCCWhiteList:(id)arg1 ;
-(unsigned)clientUID;
-(NSSet *)tccAllowances;
-(id)_checkItems:(id)arg1 identifiers:(id)arg2 protectionClass:(id)arg3 bundleID:(id)arg4 allowedOnH4:(char)arg5 ;
...
-(char)_jobForTest:(int)arg1 ;
-(char)_jobForDuet:(int)arg1 ;
-(char)_jobForSuggestions:(int)arg1 ;
-(char)_jobForIndex:(int)arg1 ;
