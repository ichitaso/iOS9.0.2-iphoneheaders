...
+(char)contactlessInterfaceCanBePresentedFromSource:(int)arg1 ;
...
-(void)valueAddedServiceTransactionsForPassWithUniqueIdentifier:(id)arg1 limit:(int)arg2 completion:(/*^block*/id)arg3 ;
-(void)valueAddedServiceTransactionsForPaymentTransaction:(id)arg1 limit:(int)arg2 completion:(/*^block*/id)arg3 ;
-(void)presentContactlessInterfaceForDefaultPassFromSource:(int)arg1 completion:(/*^block*/id)arg2 ;
