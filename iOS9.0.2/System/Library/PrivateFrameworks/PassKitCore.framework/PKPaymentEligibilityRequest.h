...
@property (assign,setter=setPANInputMethod:,nonatomic) int panInputMethod;              //@synthesize panInputMethod=_panInputMethod - In the implementation block
...
-(id)init;
-(int)source;
-(id)_urlRequestWithServiceURL:(id)arg1 deviceIdentifier:(id)arg2 account:(id)arg3 certChain:(id)arg4 devSigned:(char)arg5 ;
