...
-(void)_getSortedPrefixMatchesForTypedString:(id)arg1 topHits:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg2 historyMatches:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg3 historyLimit:(unsigned)arg4 bookmarkMatches:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg5 bookmarkLimit:(unsigned)arg6 ;
-(void)_getSortedFullTextMatchesForTypedString:(id)arg1 topHits:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg2 historyMatches:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg3 historyLimit:(unsigned)arg4 bookmarkMatches:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg5 bookmarkLimit:(unsigned)arg6 ;
-(void)clearBookmarkMatchesCachesKeepingEmptyValues:(char)arg1 ;
-(void)clearBookmarkMatchesCaches;
-(void)clearHistoryMatchesCache;
-(void)_getSortedMatchesForTypedString:(id)arg1 topHits:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg2 historyMatches:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg3 historyLimit:(unsigned)arg4 bookmarkMatches:(Vector<WTF::RefPtr<SafariShared::BookmarkAndHistoryCompletionMatch>, 0, WTF::CrashOnOverflow, 16>*)arg5 bookmarkLimit:(unsigned)arg6 prefixMatchesOnly:(char)arg7 ;
