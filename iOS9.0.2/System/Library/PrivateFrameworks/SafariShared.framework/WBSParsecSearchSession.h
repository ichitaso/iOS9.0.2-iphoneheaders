...
-(void)userDidSelectCompletionListItem:(id)arg1 atPosition:(unsigned)arg2 ;
-(void)userDidEngageWithCompletionListItem:(id)arg1 atPosition:(unsigned)arg2 withEngagementActionDictionary:(id)arg3 ;
