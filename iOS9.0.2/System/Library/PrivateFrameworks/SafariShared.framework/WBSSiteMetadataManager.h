...
-(id)_processPool;
-(void)_reregisterRequest:(id)arg1 priority:(int)arg2 withProvider:(id)arg3 didReceiveNewData:(char)arg4 ;
-(id)registerRequest:(id)arg1 priority:(int)arg2 responseHandler:(/*^block*/id)arg3 ;
-(id)registerOneTimeRequest:(id)arg1 priority:(int)arg2 responseHandler:(/*^block*/id)arg3 ;
...
-(id)siteMetadataProvider:(id)arg1 registerRequest:(id)arg2 priority:(int)arg3 responseHandler:(/*^block*/id)arg4 ;
-(id)siteMetadataProvider:(id)arg1 registerOneTimeRequest:(id)arg2 priority:(int)arg3 responseHandler:(/*^block*/id)arg4 ;
