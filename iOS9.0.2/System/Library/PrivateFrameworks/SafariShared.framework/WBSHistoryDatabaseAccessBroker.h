...
-(id)init;
-(void)requestAccessType:(int)arg1 onQueue:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
-(void)requestAccessType:(int)arg1 onQueue:(id)arg2 completionHandlerWithInvalidationHandler:(/*^block*/id)arg3 ;
...
-(void)_requestAccessType:(int)arg1 onQueue:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
