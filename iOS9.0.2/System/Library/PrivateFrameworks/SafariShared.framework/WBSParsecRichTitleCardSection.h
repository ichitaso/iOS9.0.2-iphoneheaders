...
@interface WBSParsecRichTitleCardSection : WBSParsecCardSection {
	...
	char _centered;
	char _includesSeparateLineForRottenTomatoes;
	NSString* _titleText;
	NSString* _subtitle;
	NSArray* _moreGlyphs;
...
@property (getter=isCentered,nonatomic,readonly) char centered;                                 //@synthesize centered=_centered - In the implementation block
...
@property (nonatomic,readonly) char includesSeparateLineForRottenTomatoes;                      //@synthesize includesSeparateLineForRottenTomatoes=_includesSeparateLineForRottenTomatoes - In the implementation block
...
-(char)includesSeparateLineForRottenTomatoes;
-(NSString *)ratingText;
@end
