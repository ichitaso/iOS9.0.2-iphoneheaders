...
@property (nonatomic,readonly) unsigned outstandingActionCount; 
...
-(void)dealloc;
-(void)_invokeAndNilGetAccountPropertiesHandlerWithSuccess:(char)arg1 error:(id)arg2 ;
-(BookmarkDAVSyncData *)topLevelSyncData;
-(void)_closeDBAndSave:(char)arg1 ;
-(void)setGetAccountPropertiesHandler:(id)arg1 ;
-(id)_dbRelativeString:(id)arg1 ;
-(void)setSyncHandler:(id)arg1 ;
-(void)_syncWithRemoteChanges:(char)arg1 completionHandler:(/*^block*/id)arg2 skipAddChanges:(char)arg3 ;
-(void)getAccountPropertiesWithCompletionHandler:(/*^block*/id)arg1 ;
-(void)_setServerIdOnItem:(void*)arg1 isBookmark:(char)arg2 suggestedId:(id)arg3 ;
...
-(void)_finishInitialSyncShouldPushChanges:(char)arg1 ;
-(char)getCTag:(id*)arg1 pTag:(id*)arg2 forFolderWithURL:(id)arg3 ;
-(id)initWithAccountInfoProvider:(id)arg1 taskManager:(id)arg2 openDBBlock:(/*^block*/id)arg3 getDBBlock:(/*^block*/id)arg4 saveDBBlock:(/*^block*/id)arg5 closeDBBlock:(/*^block*/id)arg6 registerForPush:(/*^block*/id)arg7 forceSafariOrdering:(char)arg8 ;
-(void)syncWithRemoteChanges:(char)arg1 completionHandler:(/*^block*/id)arg2 ;
-(unsigned)outstandingActionCount;
-(id)getAccountPropertiesHandler;
-(id)syncHandler;
-(char)_addChange:(void*)arg1 toData:(id)arg2 numActionsP:(int*)arg3 runningSizeP:(int*)arg4 maxResources:(int)arg5 maxSize:(int)arg6 foldersToAddByServerId:(CFDictionaryRef)arg7 parentToArrayOfChildrenFolderChanges:(CFDictionaryRef)arg8 pushedParentToArrayOfChildrenFolders:(CFDictionaryRef)arg9 ;
-(char)_handleErrorItem:(id)arg1 forBAItem:(void*)arg2 ;
-(char)_matchParsedFolders:(id)arg1 toPushedFolders:(CFDictionaryRef)arg2 unmatchedParsedFolders:(id)arg3 parsedSetsOfChildrenFoldersByParentURL:(id)arg4 arraysOfChildrenByNameByParent:(CFDictionaryRef)arg5 ;
-(char)_applyUnmatchedParsedFolders:(id)arg1 ;
...
-(char)_applyReturnedFolders:(id)arg1 parentToArrayOfChildrenFolders:(CFDictionaryRef)arg2 topmostFolders:(CFArrayRef)arg3 postedToURL:(id)arg4 ;
...
-(char)_applyReturnedBookmarks:(id)arg1 withPushedBookmarks:(CFArrayRef)arg2 ;
