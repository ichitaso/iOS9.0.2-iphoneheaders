...
-(id)_handleOptionalAtIndex:(unsigned)arg1 withBuffer:(SCD_Struct_AF4*)arg2 totalLength:(unsigned)arg3 consumedLength:(unsigned*)arg4 ;
-(id)_handleProviderAtIndex:(unsigned)arg1 withBuffer:(SCD_Struct_AF4*)arg2 totalLength:(unsigned)arg3 consumedLength:(unsigned*)arg4 ;
-(id)_handleControlCodeAtIndex:(unsigned)arg1 withBuffer:(SCD_Struct_AF4*)arg2 totalLength:(unsigned)arg3 consumedLength:(unsigned*)arg4 hadEmpties:(char*)arg5 ;
