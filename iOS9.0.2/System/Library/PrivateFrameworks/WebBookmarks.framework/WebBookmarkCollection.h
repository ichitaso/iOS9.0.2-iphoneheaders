...
-(char)_setupWithPath:(id)arg1 checkIntegrity:(char)arg2 ;
...
-(char)_setupWithPath:(id)arg1 migratingBookmarksPlist:(id)arg2 syncAnchorPlist:(id)arg3 checkIntegrity:(char)arg4 ;
...
-(id)listWithID:(unsigned)arg1 skipOffset:(unsigned)arg2 includeHidden:(char)arg3 filteredUsingString:(id)arg4 ;
-(id)listWithSpecialID:(unsigned)arg1 ;
-(id)readingListWithUnreadOnly:(char)arg1 filteredUsingString:(id)arg2 ;
...
-(char)_ensureFolderChildrenCount:(id)arg1 ;
