...
+(id)sharedInstance;
-(id)_voiceAssetQueryForVoiceName:(id)arg1 language:(id)arg2 gender:(int)arg3 footprint:(int)arg4 version:(id)arg5 localOnly:(char)arg6 ;
...
-(void)getCustomVoiceAssetsLocalOnly:(char)arg1 language:(id)arg2 reply:(/*^block*/id)arg3 ;
