...
@property (assign,nonatomic) char showTopicViewOnLoad;                                                        //@synthesize showTopicViewOnLoad=_showTopicViewOnLoad - In the implementation block
...
-(void)showHelpTopicItem:(id)arg1 animate:(char)arg2 ;
...
-(void)reachabilityManagerConnectionStatusChanged:(id)arg1 connected:(char)arg2 ;
-(id)topicIDForTopicName:(id)arg1 locale:(id)arg2 ;
-(char)hideDoneButton;
-(char)showTopicViewOnLoad;
-(void)setShowTopicViewOnLoad:(char)arg1 ;
-(NSString *)subpath;
