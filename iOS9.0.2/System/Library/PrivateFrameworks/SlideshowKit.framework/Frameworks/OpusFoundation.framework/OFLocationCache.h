...
-(id)placemarksForLocationCoordinate:(SCD_Struct_OF4)arg1 ;
-(id)placemarksForLocationCoordinate:(SCD_Struct_OF4)arg1 andAccuracy:(double)arg2 ;
-(void)setPlacemarks:(id)arg1 forLocationCoordinate:(SCD_Struct_OF4)arg2 ;
-(void)_didEnterBackgroundNotification;
-(void)_willTerminateNotification;
-(void)invalidateMemoryCaches;
-(void)invalidateDiskCaches;
-(id)initWithDiskCacheFilepath:(id)arg1 ;
-(id)placemarksForLocationCoordinate:(SCD_Struct_OF4)arg1 andAccuracy:(double)arg2 closestResultDistance:(double*)arg3 numberOfResults:(unsigned*)arg4 ;
-(void)invalidateCacheForLocationCoordinate:(SCD_Struct_OF4)arg1 ;
@end
