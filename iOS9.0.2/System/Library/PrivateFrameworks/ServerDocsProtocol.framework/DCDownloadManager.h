...
-(char)isDownloadingDirectory:(id)arg1 ;
-(char)isDownloadingFile:(id)arg1 ;
-(void)cancelAllDownloadTasks;
-(char)_needsToStartDownloadingItemAtSubpath:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
-(char)_isAuthError:(id)arg1 ;
