...
-(void)restartUploads;
-(char)deleteAllLocalData;
-(char)hasPendingUploads;
...
@interface DCDocumentManager : NSObject <DCConnectivityTrackerDelegate, DCDocumentManager> {
	...
	char _synchronousContentsOfDirectory;
...
+(char)_synchronouslyRemoveItemAtURL:(id)arg1 withFileCoordinator:(id)arg2 ;
+(void)_deleteAllContent;
+(id)documentManagerForService:(id)arg1 ;
-(void)dealloc;
-(char)connectionStatus;
...
-(void)removeDelegate:(id)arg1 ;
-(char)_shouldCallDelegate:(id)arg1 forPath:(id)arg2 ;
...
-(char)_didDownloadChangedItem:(id)arg1 downloadedMetadata:(id)arg2 ;
...
-(char)_needsToCallDelegateForPath:(id)arg1 ;
-(void)_contentsOfDirectoryAtPath:(id)arg1 downloadIfNecessary:(char)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(char)_isWatchedAndUpToDateItem:(id)arg1 ;
...
-(void)setDelegate:(id)arg1 queue:(id)arg2 forFilterPath:(id)arg3 ;
-(char)_performPreOperationChecksWithPath:(id)arg1 itemClass:(Class)arg2 itemMustBeKnown:(char)arg3 item:(id*)arg4 relativePath:(id*)arg5 error:(id*)arg6 ;
...
-(char)_rebuildItemWithRelativePath:(id)arg1 parentDirectoryMetadata:(id)arg2 ;
-(void)connectivityTracker:(id)arg1 didUpdateConnectionStatus:(char)arg2 ;
-(void)resetCachedItemManagerForService:(id)arg1 ;
-(void)setDelegate:(id)arg1 forFilterPath:(id)arg2 ;
-(id)delegateForFilterPath:(id)arg1 ;
-(void)removeDelegateForFilterPath:(id)arg1 ;
