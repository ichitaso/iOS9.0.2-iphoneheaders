...
-(unsigned)_addHandlerToCallForItemAtSubpath:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
...
-(char)_isUploadingFileAtPath:(id)arg1 ;
-(char)_needsToStartUploadingItemAtSubpath:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
@end
