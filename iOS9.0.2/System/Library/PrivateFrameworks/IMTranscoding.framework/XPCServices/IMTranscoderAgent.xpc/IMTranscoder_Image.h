...
-(id)_generateImage:(CGImageSourceRef)arg1 target:(int)arg2 hardwareEncoder:(id)arg3 inFormat:(CFStringRef)arg4 fromFormat:(CFStringRef)arg5 withMaxLength:(unsigned long)arg6 withMaxCount:(unsigned long)arg7 enforceMaxes:(char)arg8 subsampling:(int)arg9 ;
