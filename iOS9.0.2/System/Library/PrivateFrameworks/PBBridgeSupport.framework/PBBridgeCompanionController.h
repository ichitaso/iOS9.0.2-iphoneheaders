...
@property (assign,nonatomic) char awaitingCustomResponse;                                 //@synthesize awaitingCustomResponse=_awaitingCustomResponse - In the implementation block
...
-(char)awaitingCustomResponse;
-(void)setAwaitingCustomResponse:(char)arg1 ;
