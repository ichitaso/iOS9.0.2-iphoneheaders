...
-(void)updateNotificationTypes:(unsigned)arg1 forBundleIdentifier:(id)arg2 ;
-(void)enableNotificationsWithTypes:(unsigned)arg1 forBundleIdentifier:(id)arg2 ;
-(void)_queue_reloadDataProviders;
-(void)_queue_enableNotifications:(char)arg1 withSettings:(id)arg2 forBundleIdentifier:(id)arg3 withResult:(/*^block*/id)arg4 ;
-(void)_queue_enableNotifications:(char)arg1 withTypes:(unsigned)arg2 forBundleIdentifier:(id)arg3 ;
...
-(char)_queue_shouldUseDefaultDataProviderForBundleIdentifier:(id)arg1 ;
