...
@interface UNLocalNotificationClient : NSObject <UNLocationMonitorDelegate> {
	...
	char _uninstalled;
	char _userNotificationsEnabled;
	char _requiresLocalNotifications;
...
-(char)_canScheduledLocalNotificationTimers;
...
-(id)initWithBundleIdentifier:(id)arg1 isSystemApplication:(char)arg2 requiresLocalNotifications:(char)arg3 userNotificationsEnabled:(char)arg4 queue:(id)arg5 ;
-(void)setUserNotificationsEnabled:(char)arg1 ;
