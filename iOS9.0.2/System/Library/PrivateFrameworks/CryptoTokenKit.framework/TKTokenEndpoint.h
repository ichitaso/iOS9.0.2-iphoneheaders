...
@property (assign) int referenceCount;                              //@synthesize referenceCount=_referenceCount - In the implementation block
-(NSXPCListenerEndpoint *)endpoint;
-(void)setReferenceCount:(int)arg1 ;
-(void)acceptNewConnection:(id)arg1 ;
-(void)handleOperation:(int)arg1 session:(id)arg2 event:(id)arg3 reply:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
