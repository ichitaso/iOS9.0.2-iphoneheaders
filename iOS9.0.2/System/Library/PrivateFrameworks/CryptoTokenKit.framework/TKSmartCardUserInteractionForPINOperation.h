...
@interface TKSmartCardUserInteractionForPINOperation : TKSmartCardUserInteraction <NSSecureCoding> {
	...
	unsigned _PINCompletion;
	NSArray* _PINMessageIndices;
	NSData* _resultData;

}

@property (assign) unsigned PINCompletion;                   //@synthesize PINCompletion=_PINCompletion - In the implementation block
...
-(unsigned)PINCompletion;
-(void)setPINCompletion:(unsigned)arg1 ;
