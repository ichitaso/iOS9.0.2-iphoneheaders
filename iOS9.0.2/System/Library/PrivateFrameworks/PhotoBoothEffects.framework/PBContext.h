...
-(void)applyFilter:(id)arg1 toSurface:(IOSurfaceRef)arg2 mirrored:(char)arg3 resultHandler:(/*^block*/id)arg4 ;
-(void)applyFilter:(id)arg1 toSurface:(IOSurfaceRef)arg2 mirrored:(char)arg3 surfaceResultHandler:(/*^block*/id)arg4 ;
