...
-(char)dbQueueAlbumWithGUID:(id)arg1 outObject:(id*)arg2 outName:(id*)arg3 outCtag:(id*)arg4 outForeignCtag:(id*)arg5 outURLString:(id*)arg6 outUserInfoData:(id*)arg7 ;
-(id)dbQueueAccessControlsForAlbumWithGUID:(id)arg1 ;
-(id)dbQueueAccessControlGUIDsForAlbumWithGUID:(id)arg1 ;
-(char)dbQueueAccessControlWithGUID:(id)arg1 outObject:(id*)arg2 outAlbumGUID:(id*)arg3 outEmail:(id*)arg4 outUserInfoData:(id*)arg5 ;
-(id)dbQueueInvitationForAlbumWithGUID:(id)arg1 ;
-(char)dbQueueInvitationWithAlbumGUID:(id)arg1 outObject:(id*)arg2 outInvitationGUID:(id*)arg3 outEmail:(id*)arg4 outUserInfoData:(id*)arg5 ;
-(char)dbQueueInvitationWithGUID:(id)arg1 outObject:(id*)arg2 outAlbumGUID:(id*)arg3 outEmail:(id*)arg4 outUserInfoData:(id*)arg5 ;
-(char)dbQueueAssetCollectionWithGUID:(id)arg1 outObject:(id*)arg2 outCtag:(id*)arg3 outAlbumGUID:(id*)arg4 outBatchDate:(id*)arg5 outPhotoDate:(id*)arg6 outPhotoNumber:(long long*)arg7 outUserInfoData:(id*)arg8 ;
-(id)dbQueueAssetCollectionGUIDsInAlbumWithGUID:(id)arg1 ;
-(id)dbQueueCommentsForAssetCollectionWithGUID:(id)arg1 ;
-(char)dbQueueCommentWithGUID:(id)arg1 outObject:(id*)arg2 outID:(unsigned*)arg3 outTimestamp:(id*)arg4 outAssetCollectionGUID:(id*)arg5 outIsCaption:(char*)arg6 outUserInfoData:(id*)arg7 ;
...
-(void)dbQueueSetUnviewedState:(char)arg1 onAlbumWithGUID:(id)arg2 info:(id)arg3 ;
-(id)dbQueueMaximumPhotoNumberForAlbumWithGUID:(id)arg1 ;
-(char)dbQueueAlbumMetadataWithAlbumGUID:(id)arg1 key:(id)arg2 outValue:(id*)arg3 ;
...
-(void)dbQueueSetUnviewedState:(char)arg1 onAssetCollectionWithGUID:(id)arg2 info:(id)arg3 ;
...
-(char)dbQueueAssetCollectionMetadataWithAssetCollectionGUID:(id)arg1 key:(id)arg2 outValue:(id*)arg3 ;
...
-(char)dbQueueCheckToClearUnviewedStateOnAlbumWithGUID:(id)arg1 info:(id)arg2 ;
-(void)_reconstruct;
-(void)dbQueueAddCommentCheckOperation:(id)arg1 ;
-(char)dbQueueAssetCollectionContainsCommentsFromMeAssetCollectionGUID:(id)arg1 ;
-(char)dbQueueCommentWithID:(int)arg1 assetCollectionGUID:(id)arg2 outObject:(id*)arg3 outGUID:(id*)arg4 outTimestamp:(id*)arg5 outIsCaption:(char*)arg6 outUserInfoData:(id*)arg7 ;
-(char)dbQueueCheckToClearUnviewedStateOnAssetCollectionWithGUID:(id)arg1 info:(id)arg2 ;
