...
@property (assign,nonatomic) char shouldDownloadEarliestPhotosFirst;              //@synthesize shouldDownloadEarliestPhotosFirst=_shouldDownloadEarliestPhotosFirst - In the implementation block
-(id)initWithPersonID:(id)arg1 ;
-(char)shouldDownloadEarliestPhotosFirst;
-(void)setShouldDownloadEarliestPhotosFirst:(char)arg1 ;
...
-(char)hasItemsForDownloadCountFocusAlbumGUID:(id)arg1 focusAssetCollectionGUID:(id)arg2 ;
...
-(char)dbQueueIsAssetCollectionWithGUIDPending:(id)arg1 ;
...
-(char)dbQueueIsGUIDQueued:(id)arg1 inQueue:(id)arg2 ;
-(int)dbQueueAssetCountAlbumGUID:(id)arg1 inQueue:(id)arg2 ;
-(id)nextItemsForDownloadFocusAlbumGUID:(id)arg1 focusAssetCollectionGUID:(id)arg2 thumbnails:(char)arg3 maxCount:(int)arg4 isInflight:(char)arg5 ;
...
-(char)isAssetCollectionWithGUIDPending:(id)arg1 ;
