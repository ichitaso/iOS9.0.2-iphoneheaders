...
@property (nonatomic,readonly) char scrollNewCommentToView;                 //@synthesize scrollNewCommentToView=_scrollNewCommentToView - In the implementation block
@property (nonatomic,readonly) char showKeyboard;                           //@synthesize showKeyboard=_showKeyboard - In the implementation block
-(char)showKeyboard;
-(NSString *)asText;
