...
-(void)_popDocument:(char)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)_dismissOverlayControllerWithStackItem:(id)arg1 animated:(char)arg2 ;
-(void)_unloadDocumentForViewController:(id)arg1 ;
-(void)_unloadDocumentForPopoverController:(id)arg1 ;
-(void)_popOverlayStackItem:(id)arg1 animated:(char)arg2 completion:(/*^block*/id)arg3 ;
-(void)_popPopoverStackItem:(id)arg1 animated:(char)arg2 completion:(/*^block*/id)arg3 ;
...
-(CGRect)_centerRect:(id)arg1 adjust:(char)arg2 ;
...
-(char)_popoverController:(id)arg1 containsStackItem:(id)arg2 ;
