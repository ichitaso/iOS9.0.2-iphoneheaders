...
-(char)_makeSearchBarFirstResponderOnLoad;
-(char)_selectSearchBarContentOnBecomingFirstResponder;
-(void)_setMakeSearchBarFirstResponderOnLoad:(char)arg1 ;
-(void)_setSelectSearchBarContentOnBecomingFirstResponder:(char)arg1 ;
@end
