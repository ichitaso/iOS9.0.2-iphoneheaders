...
-(void)removeAllCirclesAnimated:(char)arg1 completionBlock:(/*^block*/id)arg2 ;
-(void)removeCirclesInIndexSet:(id)arg1 animated:(char)arg2 completionBlock:(/*^block*/id)arg3 ;
-(id)circleViewAtIndex:(int)arg1 ;
-(void)setSize:(CGSize)arg1 forCircleAtIndex:(int)arg2 ;
...
-(id)addRepellorWithCenter:(CGPoint)arg1 radius:(float)arg2 bufferSize:(float)arg3 ;
...
-(int)_circleIndexForPoint:(CGPoint)arg1 ;
...
-(CGPoint)_initialPositionForCircleIndex:(int)arg1 view:(id)arg2 ;
-(id)_circleBodyWithView:(id)arg1 ;
-(char)_addNextMissingSpringJoint;
