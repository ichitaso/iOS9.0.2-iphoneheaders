...
@interface SKUIProductPageHeaderView : UIView <SKUIItemOfferButtonDelegate, SKUIContentRatingArtworkLoaderObserver> {
	...
	char _needsLayoutAfterButtonAnimation;
...
-(void)_getTopLayoutProperties:(/*function pointer*/void**)arg1 origins:(float*)arg2 height:(float*)arg3 forWidth:(float)arg4 ;
-(void)_getBottomLayoutProperties:(/*function pointer*/void**)arg1 origins:(float*)arg2 height:(float*)arg3 forWidth:(float)arg4 ;
