...
-(void)_ensureStackConsistencyForNavigationControllerOperation:(int)arg1 operationDidComplete:(char)arg2 ;
...
-(void)ensureStackConsistencyForNavigationControllerOperation:(int)arg1 operationDidComplete:(char)arg2 ;
