...
@interface SKUIProductPageItem : SKUIItem {
	...
	unsigned _supportedGameCenterFeatures;
...
@property (nonatomic,readonly) unsigned supportedGameCenterFeatures;                        //@synthesize supportedGameCenterFeatures=_supportedGameCenterFeatures - In the implementation block
...
-(unsigned)supportedGameCenterFeatures;
