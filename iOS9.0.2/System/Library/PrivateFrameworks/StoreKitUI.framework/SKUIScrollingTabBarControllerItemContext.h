...
@interface SKUIScrollingTabBarControllerItemContext : NSObject <SKUINavigationStackObserver> {
	...
	char _adjustingNestedPagingScrollViewContentOffset;
	...
	unsigned _lastSelectedPageIndex;
...
@property (assign,nonatomic) unsigned lastSelectedPageIndex;                                                    //@synthesize lastSelectedPageIndex=_lastSelectedPageIndex - In the implementation block
...
@property (nonatomic,readonly) char viewControllerIsNavigationController; 
...
-(char)viewControllerIsNavigationController;
...
-(id)viewControllerInNestedPagingScrollViewAtPageIndex:(unsigned)arg1 ;
-(void)setLastSelectedPageIndex:(unsigned)arg1 ;
-(unsigned)lastSelectedPageIndex;
...
-(id)_nestedPagedScrollingConformingViewControllerForcingViewLoading:(char)arg1 ;
-(void)_updateAppliedContentInsetsAdjustment;
-(id)_appearanceStatusObserver;
-(void)_prepareViewControllerForDisplayWithViewFrame:(CGRect)arg1 updateContentOffset:(char)arg2 contentOffset:(CGPoint)arg3 ;
