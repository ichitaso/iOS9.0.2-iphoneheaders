...
-(void)_handleAccountSetupCompletionWithAppleID:(id)arg1 success:(char)arg2 error:(id)arg3 ;
...
-(void)_handleAccountRegistrationCompletionWithSuccess:(char)arg1 error:(id)arg2 ;
...
-(void)_handleAccountPromotionCompletionForAccount:(id)arg1 withSuccess:(char)arg2 error:(id)arg3 ;
