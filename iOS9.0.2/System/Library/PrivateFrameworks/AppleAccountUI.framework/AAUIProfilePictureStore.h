...
@property (assign,nonatomic) float pictureDiameter;              //@synthesize pictureDiameter=_pictureDiameter - In the implementation block
@property (assign,nonatomic) int pictureStyle;                   //@synthesize pictureStyle=_pictureStyle - In the implementation block
-(void)dealloc;
-(id)init;
...
-(char)_onAddressBookQueue_peopleLinkedToMeCardContainsRecordID:(int)arg1 ;
-(void)_updateServerProfilePictureForAccountOwner:(id)arg1 cropRect:(id)arg2 ;
-(char)_onAddressBookQueue_personSyncsWithiCloud:(void*)arg1 ;
-(void)_updateServerProfilePictureWithRequest:(id)arg1 ;
-(id)_profilePictureForPicture:(id)arg1 crop:(char)arg2 cropRect:(CGRect)arg3 cacheable:(char)arg4 ;
