...
-(CGRect)getCanvas;
-(id)recolor:(id)arg1 fill:(char)arg2 ;
...
-(void)applyNonClippingOfDCAtIndexToCurrentContext:(unsigned)arg1 ;
-(void)applyClippingOfDCAtIndexToCurrentContext:(unsigned)arg1 ;
-(unsigned)firstClipDCIndex;
-(unsigned)clippingStartDCIndex;
-(unsigned)currentDCIndex;
-(void)restoreGState:(id)arg1 ;
-(void)saveGState:(id)arg1 ;
-(void)addClippingPathToCurrentDCAndCurrentContext:(id)arg1 ;
-(void)applyDCAtIndexToCurrentContext:(unsigned)arg1 ;
-(int)restoreDC;
...
-(id)recolor:(unsigned char)arg1 :(unsigned char)arg2 :(unsigned char)arg3 fill:(char)arg4 ;
...
-(int)createPatternBrush:(id)arg1 :(unsigned)arg2 usePaletteForBilevel:(char)arg3 ;
...
-(int)stretchBlt:(int)arg1 :(int)arg2 :(int)arg3 :(int)arg4 :(id)arg5 :(int)arg6 :(int)arg7 :(int)arg8 :(int)arg9 :(unsigned)arg10 :(CGAffineTransform*)arg11 :(unsigned)arg12 usePaletteForBilevel:(char)arg13 ;
-(int)alphaBlend:(int)arg1 :(int)arg2 :(int)arg3 :(int)arg4 :(id)arg5 :(int)arg6 :(int)arg7 :(int)arg8 :(int)arg9 :(unsigned char)arg10 :(char)arg11 :(CGAffineTransform*)arg12 :(unsigned)arg13 ;
