...
-(int)alphaBlend:(id)arg1 :(int)arg2 :(int)arg3 :(int)arg4 :(int)arg5 :(id)arg6 :(int)arg7 :(int)arg8 :(int)arg9 :(int)arg10 :(unsigned char)arg11 :(char)arg12 :(CGAffineTransform*)arg13 :(unsigned)arg14 ;
