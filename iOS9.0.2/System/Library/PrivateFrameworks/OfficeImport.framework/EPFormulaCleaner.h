...
-(BOOL)cleanRef:(unsigned)arg1 updateSheet:(char)arg2 ;
-(BOOL)cleanArea:(unsigned)arg1 updateSheet:(char)arg2 ;
...
-(BOOL)cleanName:(unsigned)arg1 nameIndex:(unsigned)arg2 sheetIndex:(unsigned)arg3 tokenOffset:(int*)arg4 ;
...
-(char)isArrayedFormulaSupported:(id)arg1 allowSimpleRanges:(char)arg2 ;
-(char)doesNameIndexContainCircularReferences:(unsigned)arg1 sheetIndex:(unsigned)arg2 previousNameIndexes:(set<unsigned int, std::__1::less<unsigned int>, std::__1::allocator<unsigned int> >*)arg3 ;
