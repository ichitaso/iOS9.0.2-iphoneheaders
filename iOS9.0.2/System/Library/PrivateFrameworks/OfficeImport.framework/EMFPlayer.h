...
-(void)dealloc;
-(void)done;
-(int)playPolyBezier:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(int)playPolygon:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(int)playPolyLine:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(int)playPolyBezierTo:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(int)playPolyLineTo:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(int)playPolyPolyLine:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(int)playPolyPolygon:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
...
-(int)playAngleArc:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(int)playArcTo:(unsigned)arg1 :(const char*)arg2 ;
-(int)playPolyDraw:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
...
-(int)playStrokeAndFillPath:(unsigned)arg1 :(const char*)arg2 :(char)arg3 :(char)arg4 ;
...
-(int)playExtTextOut:(unsigned)arg1 :(const char*)arg2 :(char)arg3 ;
-(id)getGdi;
-(void)setIgnoreEMFPlusRecords:(char)arg1 ;
-(void)setIgnoreEMFRecords:(char)arg1 ;
