...
@property (assign) char existsInDB;                                             //@synthesize existsInDB=_existsInDB - In the implementation block
@property (assign) char isErrorEntry;                                           //@synthesize isErrorEntry=_isErrorEntry - In the implementation block
@property (assign) char writeToDB;                                              //@synthesize writeToDB=_writeToDB - In the implementation block
