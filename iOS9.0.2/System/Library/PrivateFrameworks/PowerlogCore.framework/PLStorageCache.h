...
@property (assign) long lastEntryCacheSize;                                       //@synthesize lastEntryCacheSize=_lastEntryCacheSize - In the implementation block
@property (assign) long stagingEntryCacheSize;                                    //@synthesize stagingEntryCacheSize=_stagingEntryCacheSize - In the implementation block
...
-(id)stagingEntryCacheForEntryKey:(id)arg1 withComparisons:(id)arg2 isSingleton:(char)arg3 ;
