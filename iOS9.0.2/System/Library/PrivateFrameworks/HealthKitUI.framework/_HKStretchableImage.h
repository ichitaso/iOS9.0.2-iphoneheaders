...
-(float)_desiredWidth;
-(void)renderInContext:(CGContextRef)arg1 topCenter:(CGPoint)arg2 bottomCenter:(CGPoint)arg3 contextBounds:(CGRect)arg4 alpha:(float)arg5 ;
...
-(void)_renderSingleImageInContext:(CGContextRef)arg1 point:(CGPoint)arg2 contextBounds:(CGRect)arg3 alpha:(float)arg4 ;
-(void)_renderStretchedInContext:(CGContextRef)arg1 frame:(CGRect)arg2 contextBounds:(CGRect)arg3 alpha:(float)arg4 ;
-(UIImage *)topImage;
-(UIImage *)centerImage;
-(UIImage *)bottomImage;
