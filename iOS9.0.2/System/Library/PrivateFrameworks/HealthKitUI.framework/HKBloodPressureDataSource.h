...
-(void)_callCompletionWithSystolicResults:(id)arg1 diastolicResults:(id)arg2 statisticsOptions:(unsigned)arg3 blockStart:(id)arg4 blockEnd:(id)arg5 completion:(/*^block*/id)arg6 ;
@end
