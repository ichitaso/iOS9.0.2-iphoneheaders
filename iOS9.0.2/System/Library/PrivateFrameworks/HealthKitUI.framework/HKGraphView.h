...
@interface HKGraphView : UIView <UIScrollViewDelegate, HKGraphRenderDelegate, HKSeriesDelegate> {
	...
	char _haveRescaledSinceRender;
	char _needsUpdateGraphViewConfiguration;
	_HKGraphViewSelectionContext* _selectionContext;
	HKPropertyAnimationApplier* _animationApplier;
	char _shouldInformDelegateOfUpdates;
	char _shouldListenToScrollViewDelegate;
	...
	unsigned _outlineOptions;
	unsigned _featheringOptions;
...
@property (assign,nonatomic) unsigned outlineOptions;                                 //@synthesize outlineOptions=_outlineOptions - In the implementation block
@property (assign,nonatomic) unsigned featheringOptions;                              //@synthesize featheringOptions=_featheringOptions - In the implementation block
...
@property (nonatomic,readonly) int xAxisDateZoom;                                     //@synthesize xAxisDateZoom=_xAxisDateZoom - In the implementation block
...
@property (assign,nonatomic) int minimumDateZoom;                                     //@synthesize minimumDateZoom=_minimumDateZoom - In the implementation block
@property (assign,nonatomic) int maximumDateZoom;                                     //@synthesize maximumDateZoom=_maximumDateZoom - In the implementation block
...
-(void)_setVisibleXAxisRange:(HKRange)arg1 animated:(char)arg2 ;
...
-(void)_scrollToNowAnimated:(char)arg1 ;
