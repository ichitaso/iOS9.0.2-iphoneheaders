...
#import <navd/GEONavdAnalyticsReporter.h>
...
-(void)addValueForScalarKey:(const char*)arg1 scalarValue:(long long)arg2 ;
-(void)recordInitialTravelTime:(double)arg1 ;
-(void)addValueForDistributionKey:(const char*)arg1 value:(double)arg2 ;
