...
+(id)barTintColor;
+(id)generateImageNamed:(id)arg1 withColor:(id)arg2 forClass:(Class)arg3 isKitImage:(char)arg4 ;
...
-(char)shouldHideCancel;
-(void)setCancelButtonHidden:(char)arg1 animated:(char)arg2 ;
-(void)updateCancelButtonVisibilityAnimated:(char)arg1 ;
-(void)setIsCapturing:(char)arg1 ;
