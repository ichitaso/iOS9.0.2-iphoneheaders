...
@property (assign) unsigned currentButtonTypes;                                               //@synthesize currentButtonTypes=_currentButtonTypes - In the implementation block
...
-(id)contactButtonWithImageName:(id)arg1 type:(unsigned)arg2 ;
...
-(void)setCurrentButtonTypes:(unsigned)arg1 ;
-(void)updateWithButtonTypes:(unsigned)arg1 ;
@end
