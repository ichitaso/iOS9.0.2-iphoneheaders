...
-(id)videoDeviceFormatForModeWithOptions:(CAMCaptureModeWithOptions)arg1 device:(int)arg2 ;
-(id)videoDevicePresetForModeWithOptions:(CAMCaptureModeWithOptions)arg1 device:(int)arg2 ;
