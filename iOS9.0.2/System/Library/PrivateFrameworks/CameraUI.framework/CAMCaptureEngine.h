...
@interface CAMCaptureEngine : NSObject <CAMPanoramaProcessorDelegate> {
	...
	char _interrupted;
	char _managedDevicesLockedForConfiguration;
	char __performingRecovery;
	...
	unsigned __numberOfRecoveryAttempts;
...
@property (assign,getter=areManagedDevicesLockedForConfiguration,nonatomic) char managedDevicesLockedForConfiguration;                                                 //@synthesize managedDevicesLockedForConfiguration=_managedDevicesLockedForConfiguration - In the implementation block
...
@property (assign,setter=_setPerformingRecovery:,getter=_isPerformingRecovery,nonatomic) char _performingRecovery;                                                     //@synthesize _performingRecovery=__performingRecovery - In the implementation block
@property (assign,setter=_setNumberOfRecoveryAttempts:,nonatomic) unsigned _numberOfRecoveryAttempts;                                                                  //@synthesize _numberOfRecoveryAttempts=__numberOfRecoveryAttempts - In the implementation block
...
-(char)_isPerformingRecovery;
-(void)_performSessionRuntimeRecovery:(id)arg1 ;
-(void)_setPerformingRecovery:(char)arg1 ;
-(void)_setNumberOfRecoveryAttempts:(unsigned)arg1 ;
-(void)_handleFailedSessionRecoveryAttemptAfterDelay:(char)arg1 ;
...
-(unsigned)_numberOfRecoveryAttempts;
-(double)_delayForRecoveryAttempt:(unsigned)arg1 ;
-(void)_markSessionRecoveryAsRecovered;
-(void)_performSessionNonstartRecoveryIfNeeded;
-(void)_validateSessionRecovery;
-(char)_updatePanoramaSubgraphForEnteringBackground:(char)arg1 ;
-(void)_setPanoramaAssertionIdentifier:(unsigned)arg1 ;
-(char)_isSessionModificationRequiredByCommand:(id)arg1 ;
...
-(char)_lockManagedCapturedDevice:(id)arg1 ;
-(void)setManagedDevicesLockedForConfiguration:(char)arg1 ;
...
-(char)_lockAllEngineManagedDevices;
...
-(int)_notificationForError:(CFStringRef)arg1 ;
...
-(char)areManagedDevicesLockedForConfiguration;
...
-(void)captureOutput:(id)arg1 didFinishCapturingStillImageSurface:(IOSurfaceRef)arg2 ofSize:(unsigned long)arg3 withPreviewSurface:(IOSurfaceRef)arg4 ofSize:(unsigned long)arg5 metadata:(id)arg6 forSettings:(id)arg7 error:(id)arg8 ;
-(void)captureOutput:(id)arg1 didFinishRecordingToMovieFileAtURL:(id)arg2 withDuration:(SCD_Struct_CA2)arg3 stillImageDisplayTime:(SCD_Struct_CA2)arg4 forSettings:(id)arg5 referringToMasterMovieFileAtURL:(id)arg6 isFinalReferenceMovie:(char)arg7 error:(id)arg8 ;
