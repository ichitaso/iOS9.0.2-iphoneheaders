...
@interface CAMPanoramaView : UIView {
	...
	char _painting;
	char __currentlyShowingMoveInstructions;
	char __currentlyMovingTooFast;
	int _direction;
...
@property (assign,setter=_setCurrentlyShowingMoveInstructions:,getter=_isCurrentlyShowingMoveInstructions,nonatomic) char _currentlyShowingMoveInstructions;              //@synthesize _currentlyShowingMoveInstructions=__currentlyShowingMoveInstructions - In the implementation block
...
@property (assign,setter=_setCurrentlyMovingTooFast:,getter=_isCurrentlyMovingTooFast,nonatomic) char _currentlyMovingTooFast;                                            //@synthesize _currentlyMovingTooFast=__currentlyMovingTooFast - In the implementation block
...
@property (assign,setter=_setArrowUpdateFrame:,nonatomic) unsigned _arrowUpdateFrame;                                                                                     //@synthesize _arrowUpdateFrame=__arrowUpdateFrame - In the implementation block
+(Class)layerClass;
...
-(void)setDirection:(int)arg1 animated:(char)arg2 ;
...
-(char)_isCurrentlyShowingMoveInstructions;
...
-(void)_resetPaintingUIAnimated:(char)arg1 ;
-(void)_setArrowUpdateFrame:(unsigned)arg1 ;
...
-(void)_setCurrentlyShowingMoveInstructions:(char)arg1 ;
-(void)_setCurrentlyMovingTooFast:(char)arg1 ;
-(void)_showSpeedInstructions;
-(void)_hideSpeedInstructionsAfterDelay;
-(unsigned)_arrowUpdateFrame;
...
-(char)_isCurrentlyMovingTooFast;
