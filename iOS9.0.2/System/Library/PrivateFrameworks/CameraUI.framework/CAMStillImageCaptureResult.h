...
@property (nonatomic,readonly) unsigned long stillImageOriginalSurfaceSize;                          //@synthesize stillImageOriginalSurfaceSize=_stillImageOriginalSurfaceSize - In the implementation block
...
@property (nonatomic,readonly) unsigned long stillImageUnfilteredPreviewSurfaceSize;                 //@synthesize stillImageUnfilteredPreviewSurfaceSize=_stillImageUnfilteredPreviewSurfaceSize - In the implementation block
...
@property (nonatomic,readonly) unsigned long stillImageFilteredPreviewSurfaceSize;                   //@synthesize stillImageFilteredPreviewSurfaceSize=_stillImageFilteredPreviewSurfaceSize - In the implementation block
...
@property (getter=isHDREV0,nonatomic,readonly) char HDREV0; 
...
-(id)initWithOriginalSurface:(IOSurfaceRef)arg1 size:(unsigned long)arg2 unfilteredPreviewSurface:(IOSurfaceRef)arg3 size:(unsigned long)arg4 filteredPreviewSurface:(IOSurfaceRef)arg5 size:(unsigned long)arg6 metadata:(id)arg7 expectingPairedVideo:(char)arg8 error:(id)arg9 ;
