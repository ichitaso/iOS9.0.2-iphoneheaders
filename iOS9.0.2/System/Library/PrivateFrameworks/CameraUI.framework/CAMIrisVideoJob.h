...
-(id)initWithVideoURL:(id)arg1 stillImagePersistenceUUID:(id)arg2 videoPersistenceUUID:(id)arg3 irisIdentifier:(id)arg4 captureDevice:(int)arg5 captureOrientation:(int)arg6 duration:(SCD_Struct_CA2)arg7 stillImageDisplayTime:(SCD_Struct_CA2)arg8 masterVideoURL:(id)arg9 isFinalReferenceVideo:(char)arg10 captureTime:(double)arg11 captureError:(id)arg12 ;
