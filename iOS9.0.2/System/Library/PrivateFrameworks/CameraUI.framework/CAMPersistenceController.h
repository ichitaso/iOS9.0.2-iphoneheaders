...
+(id)clientVideoMetadataForRequest:(id)arg1 withCreationDate:(id)arg2 isHDREV0:(char)arg3 ;
...
-(char)_shouldProtectPersistenceForStillImageRequest:(id)arg1 ;
...
-(void)_writeJPEGToURL:(id)arg1 withData:(id)arg2 thumbnail:(id)arg3 properties:(id)arg4 duringBurst:(char)arg5 error:(id)arg6 ;
-(id)_xmpEncodedDiagnosticDataFromDictionary:(id)arg1 ;
-(CAMThumbnailGenerator *)_remotePersistenceThumbnailGenerator;
-(void)_notifyDelegateOfCompletedStillImageRemotePersistenceForRequest:(id)arg1 withReply:(id)arg2 fromBatchOfSize:(unsigned)arg3 error:(id)arg4 ;
-(void)_handleCompletedStillImageJobForRequest:(id)arg1 withReply:(id)arg2 fromBatchOfSize:(unsigned)arg3 error:(id)arg4 ;
