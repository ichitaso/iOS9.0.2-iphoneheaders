...
@property (nonatomic,readonly) char _oldMovieWriterEnabled;                                           //@synthesize _oldMovieWriterEnabled=__oldMovieWriterEnabled - In the implementation block
...
-(char)_shouldSaveLastTimelapseDataForDebugging;
