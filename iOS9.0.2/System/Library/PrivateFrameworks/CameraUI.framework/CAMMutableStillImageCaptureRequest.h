...
@property (assign,nonatomic) int irisMode; 
@property (assign,nonatomic) char usesStillImageStabilization; 
@property (assign,nonatomic) char wantsAudioForCapture; 
@property (assign,nonatomic) char wantsSquareCrop; 
@property (assign,nonatomic) char wantsHighResolutionStills; 
...
-(void)setWantsSquareCrop:(char)arg1 ;
-(void)setWantsHighResolutionStills:(char)arg1 ;
