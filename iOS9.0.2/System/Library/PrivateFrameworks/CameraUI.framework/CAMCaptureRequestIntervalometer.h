...
@property (nonatomic,readonly) int maximumCount;                                                         //@synthesize maximumCount=_maximumCount - In the implementation block
@property (assign,nonatomic) int remaining;                                                              //@synthesize remaining=_remaining - In the implementation block
