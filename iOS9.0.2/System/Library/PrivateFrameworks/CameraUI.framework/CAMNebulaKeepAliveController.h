...
@interface CAMNebulaKeepAliveController : NSObject {
	...
	char __didCreateKeepAliveDirectory;
...
@property (assign,setter=_setDidCreateKeepAliveDirectory:,nonatomic) char _didCreateKeepAliveDirectory;                   //@synthesize _didCreateKeepAliveDirectory=__didCreateKeepAliveDirectory - In the implementation block
-(id)init;
-(NSObject*<OS_dispatch_queue>)_syncQueue;
-(char)_didCreateKeepAliveDirectory;
-(void)_setDidCreateKeepAliveDirectory:(char)arg1 ;
