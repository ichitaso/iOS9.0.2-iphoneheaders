...
@property (nonatomic,readonly) long batchOffset;                                        //@synthesize batchOffset=_batchOffset - In the implementation block
...
-(char)findDocuments:(unsigned*)arg1 docNames:(id*)arg2 valueLists:(id*)arg3 maxCount:(unsigned)arg4 timeOut:(double)arg5 foundCount:(unsigned*)arg6 ;
-(SIQueryRef)siQuery;
-(long)batchOffset;
-(NSArray *)batchValues;
-(BOOL)waiting;
