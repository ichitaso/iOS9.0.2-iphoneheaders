...
@interface PLVideoRemaker : NSObject {
	...
	id _delegate;
	char _shouldExportToPhotoDataDirectory;
...
@property (assign,nonatomic) char shouldExportToPhotoDataDirectory;                                //@synthesize shouldExportToPhotoDataDirectory=_shouldExportToPhotoDataDirectory - In the implementation block
...
-(void)setShouldExportToPhotoDataDirectory:(char)arg1 ;
-(void)remake;
-(void)cancel;
...
-(char)shouldExportToPhotoDataDirectory;
