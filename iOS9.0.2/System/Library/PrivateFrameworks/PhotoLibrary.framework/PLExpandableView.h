...
@property (assign,nonatomic) char allowsExpansion; 
...
-(void)_setAutorotationDisabled:(char)arg1 ;
...
-(void)notifyExpansionFraction:(float)arg1 force:(char)arg2 ;
-(float)continueTrackingPinch:(id)arg1 ;
-(int)snapState:(char)arg1 ;
...
-(CGRect)pinchRect:(CGRect)arg1 inView:(id)arg2 insetTouches:(char)arg3 ;
-(void)collapseWithAnimation:(char)arg1 completion:(/*^block*/id)arg2 ;
-(void)expandWithAnimation:(char)arg1 completion:(/*^block*/id)arg2 ;
-(CGRect)contractedFrame;
-(void)setExpandedFrame:(CGRect)arg1 ;
-(CGRect)expandedFrame;
-(void)setAllowsExpansion:(char)arg1 ;
-(int)previousState;
