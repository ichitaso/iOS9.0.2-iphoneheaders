...
-(unsigned)tsmRegionPushTopicsCount;
-(void)clearTsmRegionPushTopics;
-(id)tsmRegionPushTopicsAtIndex:(unsigned)arg1 ;
-(unsigned)tsmRegionURLsCount;
-(void)clearTsmRegionURLs;
-(id)tsmRegionURLsAtIndex:(unsigned)arg1 ;
-(unsigned)brokerRegionPushTopicsCount;
-(void)clearBrokerRegionPushTopics;
-(id)brokerRegionPushTopicsAtIndex:(unsigned)arg1 ;
