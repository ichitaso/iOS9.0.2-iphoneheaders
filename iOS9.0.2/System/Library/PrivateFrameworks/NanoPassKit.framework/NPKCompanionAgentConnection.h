...
@interface NPKCompanionAgentConnection : NSObject {
	...
	char _queueAppropriateFailedActions;
...
@property (assign,nonatomic) char queueAppropriateFailedActions;                                               //@synthesize queueAppropriateFailedActions=_queueAppropriateFailedActions - In the implementation block
...
+(char)isSetupAssistantProvisioningSupported;
+(char)isIssuerAppProvisioningSupported;
...
-(void)setQueueAppropriateFailedActions:(char)arg1 ;
...
-(char)queueAppropriateFailedActions;
