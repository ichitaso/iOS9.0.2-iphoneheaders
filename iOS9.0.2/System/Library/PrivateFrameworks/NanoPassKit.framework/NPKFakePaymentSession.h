...
@property (assign,nonatomic) unsigned changeCardToken;                                   //@synthesize changeCardToken=_changeCardToken - In the implementation block
...
-(unsigned)changeCardToken;
-(void)setChangeCardToken:(unsigned)arg1 ;
