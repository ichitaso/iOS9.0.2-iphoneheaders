...
@property (assign,getter=isDeactivated,nonatomic) char deactivated;                           //@synthesize deactivated=_deactivated - In the implementation block
...
-(char)_sessionQueue_startContactlessSessionWithSuccessfulCompletionOnInternalQueue:(/*^block*/id)arg1 ;
-(char)isConfirmed;
-(void)setConfirmed:(char)arg1 ;
-(PKContactlessInterfaceSession *)contactlessSession;
-(void)_sessionQueue_invokeAppropriateCallbackForActivationWithSuccess:(char)arg1 invokeOnSuccess:(char)arg2 contactlessValidity:(unsigned long long)arg3 forPass:(id)arg4 ;
...
-(char)_sessionQueue_updateContactlessSessionForPass:(id)arg1 paymentApplication:(id)arg2 allVASPasses:(id)arg3 sessionConfirmed:(char)arg4 ;
