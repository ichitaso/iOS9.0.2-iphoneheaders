...
-(id)initWithContext:(unsigned)arg1 responseQueue:(id)arg2 ;
...
-(id)_sendProtobuf:(id)arg1 responseExpected:(char)arg2 ;
-(id)_supportedRegionsForWebService:(id)arg1 ;
-(void)removeAIDsFromSecureElement:(id)arg1 withCompletion:(/*^block*/id)arg2 ;
-(id)_sendProtobuf:(id)arg1 responseExpected:(char)arg2 extraOptions:(id)arg3 ;
