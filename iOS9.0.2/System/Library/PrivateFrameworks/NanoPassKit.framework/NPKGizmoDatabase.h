...
@property (nonatomic,readonly) unsigned numberOfPasses; 
...
+(unsigned)latestWatchOSMajorVersion;
...
-(char)_preconditionsMetForDatabaseOpen;
-(void)_enumerateAllPassesForMigration:(/*^block*/id)arg1 ;
-(char)_updateNFCPayloadDuringMigration:(id)arg1 ;
-(char)_updatePrivateLabelAndCobrandDuringMigration:(id)arg1 ;
-(char)_updateDeviceAndPreferredPaymentApplicationsDuringMigration:(id)arg1 ;
-(char)_updateIngestedDatesDuringMigration:(id)arg1 ;
-(char)_updateEffectivePaymentApplicationStateDuringMigration:(id)arg1 ;
-(char)_updateHasUserSelectablePaymentApplications:(id)arg1 ;
-(char)_updateEncodedPaymentPassDuringMigration:(id)arg1 ;
-(char)_updateHasStoredValueDuringMigration:(id)arg1 ;
-(char)_updateSettingsDuringMigration:(id)arg1 ;
-(char)_updateCompleteHashesDuringMigration:(id)arg1 ;
-(char)_migrateDatabase:(/*^block*/id)arg1 ;
...
-(void)_savePassLocked:(id)arg1 wasUpdate:(char*)arg2 ;
-(id)_libraryHashLockedForWatchOSMajorVersion:(unsigned)arg1 ;
...
-(char)_getDeletePendingForUniqueID:(id)arg1 ;
...
-(id)libraryHashForWatchOSMajorVersion:(unsigned)arg1 ;
-(id)manifestHashesForWatchOSMajorVersion:(unsigned)arg1 ;
