...
-(char)_issuePurchaseRequestForPurchases:(id)arg1 ;
...
-(char)addPurchaseBatch:(id)arg1 ;
-(void)cancelFuturePurchase:(id)arg1 ;
-(char)itemIdentifierIsPurchased:(unsigned long long)arg1 ;
-(char)itemIdentifierIsPurchasing:(unsigned long long)arg1 ;
-(id)newPurchaseBatchForItems:(id)arg1 offers:(id)arg2 ;
-(int)numberOfPendingPurchases;
-(char)_needsAuthenticationForPurchases:(id)arg1 ;
