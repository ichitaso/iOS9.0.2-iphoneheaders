...
@property (assign,nonatomic) char alwaysRegenerateWebArchives;                     //@synthesize alwaysRegenerateWebArchives=_alwaysRegenerateWebArchives - In the implementation block
@property (nonatomic,retain) NSDictionary * defaultAdData;                         //@synthesize defaultAdData=_defaultAdData - In the implementation block
@property (assign,nonatomic) char defaultsToNoQualifiedAds;                        //@synthesize defaultsToNoQualifiedAds=_defaultsToNoQualifiedAds - In the implementation block
@property (assign,nonatomic) char digestAuthenticationEnabled; 
...
@property (assign,nonatomic) char pipeliningEnabled; 
...
+(char)adBundleAtURL:(id)arg1 matchesRequest:(id)arg2 ;
+(id)creativesForAdBundleAtURL:(id)arg1 matchingRequest:(id)arg2 ;
+(char)creativeTypeMatches:(id)arg1 type:(int)arg2 creativeType:(id)arg3 ;
...
-(void)setDigestAuthenticationEnabled:(char)arg1 ;
...
-(void)setPipeliningEnabled:(char)arg1 ;
...
-(id)adDataForAdBundleAtPath:(id)arg1 creative:(id)arg2 allowWebArchive:(char)arg3 ;
