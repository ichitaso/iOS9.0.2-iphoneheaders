...
@property (assign,nonatomic) char digestAuthenticationEnabled;                        //@synthesize digestAuthenticationEnabled=_digestAuthenticationEnabled - In the implementation block
...
@property (assign,nonatomic) char pipeliningEnabled;                                  //@synthesize pipeliningEnabled=_pipeliningEnabled - In the implementation block
...
-(void)_returnResponse:(id)arg1 toConnection:(id)arg2 closeAfterSending:(char)arg3 ;
