...
+(id)postalAddress:(id)arg1 components:(id)arg2 label:(id)arg3 extractionType:(unsigned)arg4 recordId:(id)arg5 origin:(id)arg6 ;
-(NSString *)address;
...
-(NSString *)rawAddress;
-(id)initWithAddress:(id)arg1 components:(id)arg2 label:(id)arg3 extractionType:(unsigned)arg4 recordId:(id)arg5 origin:(id)arg6 ;
