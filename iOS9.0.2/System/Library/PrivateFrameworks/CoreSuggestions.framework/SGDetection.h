...
-(NSString *)context;
-(NSString *)label;
-(id)initWithType:(unsigned)arg1 extraction:(id)arg2 context:(id)arg3 contextRangeOfInterest:(NSRange)arg4 label:(id)arg5 hasPhoneLabel:(char)arg6 match:(NSRange)arg7 ;
-(NSString *)extraction;
