...
-(id)_addServiceIdentitiesOfType:(id)arg1 toSet:(PCSIdentitySetDataRef)arg2 fromSet:(PCSIdentitySetDataRef)arg3 markCurrent:(char)arg4 ;
...
-(char)_saveZoneToServer:(id)arg1 withPCS:(OpaquePCSShareProtectionRef)arg2 operation:(id)arg3 completion:(/*^block*/id)arg4 ;
-(char)_zonePCSNeedsUpdate:(OpaquePCSShareProtectionRef)arg1 ;
...
-(void)fetchPCSForRecordWithID:(id)arg1 operation:(id)arg2 options:(unsigned)arg3 withCompletionHandler:(/*^block*/id)arg4 ;
