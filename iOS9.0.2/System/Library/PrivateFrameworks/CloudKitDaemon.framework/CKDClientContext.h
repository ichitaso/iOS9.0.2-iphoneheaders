...
@interface CKDClientContext : NSObject <CKLoggingProtocol> {
	...
	char _hasAllowAccessDuringBuddyEntitlement;
	char _sandboxed;
...
@property (assign,nonatomic) char hasAllowAccessDuringBuddyEntitlement;                                            //@synthesize hasAllowAccessDuringBuddyEntitlement=_hasAllowAccessDuringBuddyEntitlement - In the implementation block
