...
@interface CKDDownloadAssetsOperation : CKDDatabaseOperation {
	...
	unsigned _maxPackageDownloadsPerBatch;
...
@property (assign,nonatomic) unsigned maxPackageDownloadsPerBatch;              //@synthesize maxPackageDownloadsPerBatch=_maxPackageDownloadsPerBatch - In the implementation block
...
-(void)_downloadPackageSectionAtIndex:(int)arg1 task:(id)arg2 completionBlock:(/*^block*/id)arg3 ;
-(unsigned)maxPackageDownloadsPerBatch;
...
-(void)setMaxPackageDownloadsPerBatch:(unsigned)arg1 ;
