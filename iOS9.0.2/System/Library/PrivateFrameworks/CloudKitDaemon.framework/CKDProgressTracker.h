...
@property (assign,nonatomic) char hasCachedTotalBytes;                             //@synthesize hasCachedTotalBytes=_hasCachedTotalBytes - In the implementation block
@property (assign,nonatomic) char hasCachedCompletedBytes;                         //@synthesize hasCachedCompletedBytes=_hasCachedCompletedBytes - In the implementation block
...
-(void)setHasCachedTotalBytes:(char)arg1 ;
-(char)hasCachedCompletedBytes;
-(void)setHasCachedCompletedBytes:(char)arg1 ;
