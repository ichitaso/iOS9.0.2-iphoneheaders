...
@property (readonly) int advertisementVersion;                           //@synthesize advertisementVersion=_advertisementVersion - In the implementation block
...
-(id)initWithAdvertisementVersion:(unsigned)arg1 advertisementPayload:(id)arg2 options:(id)arg3 device:(id)arg4 ;
