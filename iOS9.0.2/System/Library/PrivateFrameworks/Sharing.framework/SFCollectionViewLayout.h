...
-(float)_evaluateHorizontalItemOffsetForItemSize:(CGSize)arg1 containerWidth:(float)arg2 inset:(UIEdgeInsets)arg3 ;
-(CGPoint)firstItemCenterForContainerWidth:(float)arg1 ;
@end
