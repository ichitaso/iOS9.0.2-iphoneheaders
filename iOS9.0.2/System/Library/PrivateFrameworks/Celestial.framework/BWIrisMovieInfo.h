...
@interface BWIrisMovieInfo : NSObject {
	...
	char _keyFrameForStillImageEmitted;
...
@property (assign,nonatomic) char keyFrameForStillImageEmitted;                                            //@synthesize keyFrameForStillImageEmitted=_keyFrameForStillImageEmitted - In the implementation block
...
-(char)keyFrameForStillImageEmitted;
-(void)setKeyFrameForStillImageEmitted:(char)arg1 ;
@end
