...
-(id)initWithNumberOfVideoInputs:(unsigned)arg1 numberOfAudioInputs:(unsigned)arg2 numberOfMetadataInputs:(unsigned)arg3 autoTrimMethod:(int)arg4 updateStopPTSDelegate:(id)arg5 ;
...
-(void)_serviceIrisRequestsForCurrentTime:(SCD_Struct_BW2)arg1 emitBuffers:(char)arg2 ;
...
-(char)_fillInRefMovieStartAndTrimTimes;
