...
@interface NPSDomainAccessorInternal : NSObject <NPSDomainAccessorFilePresenterDelegate> {
	...
	char _nanoSettingsDirectoryExists;
	char _hasReadFromDisk;
	NSUUID* _pairingID;
...
@property (assign,nonatomic) unsigned referenceCounter;                                   //@synthesize referenceCounter=_referenceCounter - In the implementation block
@property (assign,nonatomic) char nanoSettingsDirectoryExists;                            //@synthesize nanoSettingsDirectoryExists=_nanoSettingsDirectoryExists - In the implementation block
@property (assign,nonatomic) char hasReadFromDisk;                                        //@synthesize hasReadFromDisk=_hasReadFromDisk - In the implementation block
...
-(void)setReferenceCounter:(unsigned)arg1 ;
-(void)setHasReadFromDisk:(char)arg1 ;
-(id)createNanoSettingsDirectory;
-(void)_invalidatePresenter;
-(id)_copyKeyList;
-(id)_synchronizeReadOnly:(char)arg1 ;
-(id)canSynchronizeForWritingURL:(id)arg1 readFirst:(char)arg2 ;
-(id)canSynchronizeForReadingURL:(id)arg1 ;
-(id)_objectForKey:(id)arg1 error:(id*)arg2 ;
-(void)setPairingStorePath:(NSString *)arg1 ;
-(char)nanoSettingsDirectoryExists;
-(void)setNanoSettingsDirectoryExists:(char)arg1 ;
-(char)hasReadFromDisk;
