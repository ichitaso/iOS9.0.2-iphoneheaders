...
@property (getter=hasFreeDeveloperProvisioningProfile,nonatomic,readonly) char freeDeveloperProvisioningProfile;              //@synthesize hasFreeDeveloperProvisioningProfile=_hasFreeDeveloperProvisioningProfile - In the implementation block
@property (getter=hasUniversalProvisioningProfile,nonatomic,readonly) char universalProvisioningProfile;                      //@synthesize hasUniversalProvisioningProfile=_hasUniversalProvisioningProfile - In the implementation block
...
-(void)_updateWithManagedApplicationStatus:(char)arg1 ;
...
-(unsigned)_computeSupportedInterfaceOrientations:(id)arg1 ;
-(NSString *)sdkVersion;
...
-(char)supportsDeviceFamily:(unsigned)arg1 ;
-(void)acceptApplicationSignatureIdentity;
-(char)statusBarHiddenForInterfaceOrientation:(int)arg1 onDisplay:(id)arg2 ;
