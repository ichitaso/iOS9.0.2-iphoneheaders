...
-(id)_rootWindowForDisplay:(id)arg1 createIfNecessary:(char)arg2 ;
...
-(void)_enqueueObserverCalloutsForScene:(id)arg1 eventName:(id)arg2 preferInternal:(char)arg3 withBlock:(/*^block*/id)arg4 ;
