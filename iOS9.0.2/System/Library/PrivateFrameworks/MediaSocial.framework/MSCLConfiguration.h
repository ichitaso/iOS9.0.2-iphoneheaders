...
@property (assign,nonatomic) int maximumNumberOfAttachments;                            //@synthesize maximumNumberOfAttachments=_maximumNumberOfAttachments - In the implementation block
