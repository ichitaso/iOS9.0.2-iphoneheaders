...
@property (assign,nonatomic) int allowedCharacterCount;                                        //@synthesize allowedCharacterCount=_allowedCharacterCount - In the implementation block
...
@property (assign,nonatomic) char showsAttachmentButton; 
...
-(void)hideTextCompletionViewControllerAnimated:(char)arg1 completion:(/*^block*/id)arg2 ;
-(void)setAttachmentViews:(NSArray *)arg1 ;
-(void)setShowsAttachmentButton:(char)arg1 ;
-(NSString *)tagForSelectedRange;
-(void)showTextCompletionViewController:(id)arg1 animated:(char)arg2 completion:(/*^block*/id)arg3 ;
