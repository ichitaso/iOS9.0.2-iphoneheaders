...
-(void)addAttachments:(id)arg1 animated:(char)arg2 ;
...
-(char)_canShowEditorForAttachment:(id)arg1 ;
-(void)_editPropertiesForAttachment:(id)arg1 animated:(char)arg2 ;
...
-(void)_ingestAttachment:(id)arg1 animated:(char)arg2 ;
