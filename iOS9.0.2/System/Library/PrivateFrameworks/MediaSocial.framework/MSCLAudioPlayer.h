...
@property (assign,nonatomic) char usesCADisplayLink;                                   //@synthesize usesCADisplayLink=_usesCADisplayLink - In the implementation block
...
-(char)usesCADisplayLink;
-(void)setUsesCADisplayLink:(char)arg1 ;
