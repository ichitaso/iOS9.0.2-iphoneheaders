...
@interface NNMKSyncProvider : NNMKSyncEndpoint <NNMKMessagesSyncServiceServerDelegate, NNMKMessageContentSyncServiceServerDelegate, NNMKAccountsSyncServiceServerDelegate, NNMKFetchesSyncServiceServerDelegate, PSYSyncCoordinatorDelegate> {
	...
	char _fullSyncRecoveredInThisSession;
...
@property (assign,nonatomic) char fullSyncRecoveredInThisSession;                                                 //@synthesize fullSyncRecoveredInThisSession=_fullSyncRecoveredInThisSession - In the implementation block
...
-(void)_checkConnectivityBasedSuspensionTimer:(char)arg1 ;
...
-(void)_addMessages:(id)arg1 messagesAreNew:(char)arg2 loadedFromLocalStorage:(char)arg3 ;
...
-(void)_resendObjectIds:(id)arg1 type:(id)arg2 resendInterval:(unsigned)arg3 idsIdentifier:(id)arg4 ;
...
-(void)_fastForwardToFullSyncVersion:(unsigned)arg1 ;
-(void)_triggerFullMessagesAndAccountsSync;
-(void)_clearForFullSyncWithAccountsSync:(char)arg1 ;
...
-(void)_scheduleIdsIdentifierForResend:(id)arg1 currentResendInterval:(unsigned)arg2 newResendInterval:(unsigned)arg3 errorCode:(int)arg4 ;
...
-(void)_resendSendingProgressForComposedMessageWithId:(id)arg1 forIDSIdentifier:(id)arg2 newResendInterval:(unsigned)arg3 ;
...
-(char)fullSyncRecoveredInThisSession;
-(void)setFullSyncRecoveredInThisSession:(char)arg1 ;
