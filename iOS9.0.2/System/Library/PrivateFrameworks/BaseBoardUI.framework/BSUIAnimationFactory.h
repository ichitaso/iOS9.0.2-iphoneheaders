...
+(void)animateWithSettings:(id)arg1 options:(unsigned)arg2 actions:(/*^block*/id)arg3 ;
+(void)animateWithSettings:(id)arg1 options:(unsigned)arg2 actions:(/*^block*/id)arg3 completion:(/*^block*/id)arg4 ;
