...
+(void)initialize;
+(id)elementStyleWithSelector:(id)arg1 cssRule:(id)arg2 filterBlockedStyles:(char)arg3 ;
+(id)elementStyleWithSelector:(id)arg1 aggregatingStyles:(id)arg2 ;
+(id)normalizeClassSelectorString:(id)arg1 ;
+(id)registeredStyles;
+(id)registeredAliases;
+(void)registerStyle:(id)arg1 aliasName:(id)arg2 withType:(unsigned)arg3 inherited:(char)arg4 ;
...
+(unsigned)imageTreatmentFromString:(id)arg1 ;
+(id)elementStyleWithSelector:(id)arg1 inlineStyleString:(id)arg2 filterBlockedStyles:(char)arg3 ;
...
-(int)reflectImage;
-(id)initWithCSSRule:(id)arg1 filterBlockedStyles:(char)arg2 selStr:(id)arg3 ;
