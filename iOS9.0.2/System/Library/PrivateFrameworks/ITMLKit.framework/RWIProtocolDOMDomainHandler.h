...
-(void)setInspectModeEnabledWithErrorCallback:(/*^block*/id)arg1 successCallback:(/*^block*/id)arg2 enabled:(char)arg3 highlightConfig:(id*)arg4;
-(void)highlightRectWithErrorCallback:(/*^block*/id)arg1 successCallback:(/*^block*/id)arg2 x:(int)arg3 y:(int)arg4 width:(int)arg5 height:(int)arg6 color:(id*)arg7 outlineColor:(id*)arg8 usePageCoordinates:(char*)arg9;
-(void)highlightQuadWithErrorCallback:(/*^block*/id)arg1 successCallback:(/*^block*/id)arg2 quad:(id)arg3 color:(id*)arg4 outlineColor:(id*)arg5 usePageCoordinates:(char*)arg6;
