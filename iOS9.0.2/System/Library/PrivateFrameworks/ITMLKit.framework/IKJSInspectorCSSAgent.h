...
-(void)setPropertyTextWithErrorCallback:(/*^block*/id)arg1 successCallback:(/*^block*/id)arg2 styleId:(id)arg3 propertyIndex:(int)arg4 text:(id)arg5 overwrite:(char)arg6 ;
-(void)togglePropertyWithErrorCallback:(/*^block*/id)arg1 successCallback:(/*^block*/id)arg2 styleId:(id)arg3 propertyIndex:(int)arg4 disable:(char)arg5 ;
