...
@property (nonatomic,readonly) char requiresMediaQueryEvaluation;               //@synthesize requiresMediaQueryEvaluation=_requiresMediaQueryEvaluation - In the implementation block
