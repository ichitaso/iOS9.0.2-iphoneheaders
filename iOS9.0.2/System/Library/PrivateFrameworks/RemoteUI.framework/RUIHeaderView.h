...
@property (assign,nonatomic) float headerLabelBottomPadding;              //@synthesize headerLabelBottomPadding=_headerLabelBottomPadding - In the implementation block
