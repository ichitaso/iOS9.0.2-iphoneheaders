...
-(id)imageTaskWithHTTPGetRequest:(id)arg1 client:(id)arg2 fitToSize:(CGSize)arg3 incremental:(char)arg4 progressHandler:(/*^block*/id)arg5 fillColor:(id)arg6 userAgent:(id)arg7 ;
