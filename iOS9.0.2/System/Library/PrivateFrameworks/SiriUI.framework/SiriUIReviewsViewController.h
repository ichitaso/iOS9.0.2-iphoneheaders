...
@property (assign,nonatomic) char ignoreBackgroundInsets;                                                 //@synthesize ignoreBackgroundInsets=_ignoreBackgroundInsets - In the implementation block
...
-(char)ignoreBackgroundInsets;
-(void)setIgnoreBackgroundInsets:(char)arg1 ;
