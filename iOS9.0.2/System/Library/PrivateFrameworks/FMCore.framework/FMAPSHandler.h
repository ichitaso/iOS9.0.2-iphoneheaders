...
@property (assign,nonatomic) char suspendRegistrations;                         //@synthesize suspendRegistrations=_suspendRegistrations - In the implementation block
...
-(NSString *)apsToken;
-(void)setSuspendRegistrations:(char)arg1 ;
