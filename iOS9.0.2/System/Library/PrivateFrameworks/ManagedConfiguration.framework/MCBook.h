...
-(char)isUninstalledOnMDMRemoval;
-(char)isExcludedFromBackup;
-(char)isExcludedFromCloudSync;
-(char)isUnableToExportToUnmanaged;
-(char)isEnterpriseBook;
-(char)hasManagedRestrictions;
