...
@interface MCSoftwareUpdateController : NSObject <MCSoftwareUpdateManagerDelegate, SUNetworkObserver, MCSoftwareUpdateManagerDelegate> {
	...
	NSError* _suError;
	int _networkType;
	unsigned _downloadAttemptsRemaining;
	unsigned _installAttemptsRemaining;
	char _isNewDownload;
