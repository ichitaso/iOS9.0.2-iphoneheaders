...
-(void)installITunesStoreID:(id)arg1 appIdentifier:(id)arg2 managementFlags:(int)arg3 changeManagementState:(int)arg4 attributes:(id)arg5 configuration:(id)arg6 mustRedownload:(char)arg7 assertion:(id)arg8 completionBlock:(/*^block*/id)arg9 ;
...
-(void)_SSVPromptForManagementWithPurchase:(id)arg1 managementFlags:(int)arg2 changeManagementState:(int)arg3 attributes:(id)arg4 configuration:(id)arg5 mustRedownload:(char)arg6 assertion:(id)arg7 completionBlock:(/*^block*/id)arg8 ;
-(void)_installITunesStoreIDLicensedToUser:(id)arg1 appIdentifier:(id)arg2 managementFlags:(int)arg3 attributes:(id)arg4 configuration:(id)arg5 mustRedownload:(char)arg6 assertion:(id)arg7 completionBlock:(/*^block*/id)arg8 ;
...
-(void)_displayManagementPromptForAppTitle:(id)arg1 bundleID:(id)arg2 isAppStore:(char)arg3 assertion:(id)arg4 completionBlock:(/*^block*/id)arg5 ;
