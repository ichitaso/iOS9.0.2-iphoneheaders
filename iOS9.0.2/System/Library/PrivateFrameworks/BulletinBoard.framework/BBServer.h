...
+(id)_sectionInfoPath;
+(char)_removeSavedChronologicalSectionInfos:(id)arg1 ;
...
-(void)_removeBulletins:(id)arg1 forSectionID:(id)arg2 shouldSync:(char)arg3 ;
...
-(id)_sectionInfoArrayForSectionIDs:(id)arg1 effective:(char)arg2 ;
...
-(id)_sectionInfoArray:(char)arg1 ;
-(id)_sectionInfoArrayForActiveSections:(char)arg1 ;
...
-(char)_sectionFiltersAllowBulletin:(id)arg1 ;
