...
-(void)dataProviderStore:(id)arg1 didAddDataProvider:(id)arg2 performMigration:(char)arg3 completion:(/*^block*/id)arg4 ;
...
-(id)_configureDataProvider:(id)arg1 performMigration:(char)arg2 ;
