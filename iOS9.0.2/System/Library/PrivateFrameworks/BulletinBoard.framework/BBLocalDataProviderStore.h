...
-(void)loadAllDataProvidersAndPerformMigration:(char)arg1 ;
-(id)initWithDelegate:(id)arg1 dataProviderQueue:(id)arg2 ;
-(void)_loadDataProviderPluginBundle:(id)arg1 performMigration:(char)arg2 ;
-(void)_addDataProviderClass:(Class)arg1 performMigration:(char)arg2 ;
-(void)_addLocalDataProviderFactoryOfClass:(Class)arg1 ;
-(void)_queue_addDataProvider:(id)arg1 performMigration:(char)arg2 ;
-(void)addDataProvider:(id)arg1 performMigration:(char)arg2 ;
