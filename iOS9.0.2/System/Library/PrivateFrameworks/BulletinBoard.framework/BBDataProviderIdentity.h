...
@property (nonatomic,readonly) char syncsBulletinDismissal;                        //@synthesize syncsBulletinDismissal=_syncsBulletinDismissal - In the implementation block
...
-(id)initForDataProvider:(id)arg1 forRemoteDataProvider:(char)arg2 ;
