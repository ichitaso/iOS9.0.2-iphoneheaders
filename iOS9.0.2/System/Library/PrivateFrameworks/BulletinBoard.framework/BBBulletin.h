...
@property (nonatomic,readonly) char allowsAutomaticRemovalFromLockScreen; 
@property (nonatomic,readonly) char allowsAddingToLockScreenWhenUnlocked; 
...
-(char)bulletinAlertShouldOverridePocketMode;
-(id)sb_minimalSupplementaryActions;
-(char)sb_supportsRaiseAction;
-(char)sb_hasCustomSecondaryContent;
-(NSDate *)endDate;
