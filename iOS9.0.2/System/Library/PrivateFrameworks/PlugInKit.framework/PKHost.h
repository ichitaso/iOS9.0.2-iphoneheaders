...
-(id)activePlugInForIdentifier:(id)arg1 activeOnly:(char)arg2 ;
...
-(id)rewriteDiscoveryAttributes:(id)arg1 flags:(unsigned)arg2 ;
...
-(void)discoverPlugInsForAttributes:(id)arg1 flags:(unsigned)arg2 found:(/*^block*/id)arg3 ;
-(id)continuouslyDiscoverPlugInsForAttributes:(id)arg1 flags:(unsigned)arg2 found:(/*^block*/id)arg3 ;
