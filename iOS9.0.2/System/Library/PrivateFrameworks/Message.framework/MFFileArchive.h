...
-(archive_entryRef)_compressionArchiveEntryWithFileName:(id)arg1 length:(unsigned)arg2 ;
-(archiveRef)_decompressionArchive;
-(char)_decompressArchive:(archiveRef)arg1 intoArchiveDirectory:(id)arg2 error:(id*)arg3 ;
-(int)_decompressionCompleteForArchive:(archiveRef)arg1 error:(id*)arg2 ;
-(char)_decompressContents:(id)arg1 inMemoryWithError:(id*)arg2 mainEntry:(char)arg3 ;
-(void)_compressInputWithReader:(/*^block*/id)arg1 writer:(/*^block*/id)arg2 completion:(/*^block*/id)arg3 ;
-(char)_decompressContents:(id)arg1 error:(id*)arg2 mainEntry:(char)arg3 ;
-(void)_decompressInputWithReader:(/*^block*/id)arg1 writer:(/*^block*/id)arg2 mainEntry:(char)arg3 completion:(/*^block*/id)arg4 ;
