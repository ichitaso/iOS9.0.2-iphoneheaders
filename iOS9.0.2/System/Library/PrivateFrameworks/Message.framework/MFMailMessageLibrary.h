...
-(unsigned)allNonDeleteCountForMailbox:(id)arg1 includeServerSearchResults:(char)arg2 includeThreadSearchResults:(char)arg3 ;
...
-(unsigned)nonDeletedCountForAggregatedMailboxes:(id)arg1 includeServerSearchResults:(char)arg2 includeThreadSearchResults:(char)arg3 ;
...
-(char)canProvideMinimumRemoteID;
...
-(char)_checkpointDatabase;
-(char)_rollbackToCheckpoint;
...
-(char)_insertThreadReferences:(id)arg1 toMessageWithLibraryID:(unsigned)arg2 usingDatabase:(sqlite3Ref)arg3 ;
-(char)isProtectedDataAvailable:(sqlite3Ref)arg1 ;
...
-(id)_messageForStatement:(sqlite3_stmtRef)arg1 options:(unsigned)arg2 timestamp:(unsigned long long)arg3 isProtectedDataAvailable:(char)arg4 ;
-(char)_canSelectMessagesWithOptions:(unsigned)arg1 db:(sqlite3Ref)arg2 ;
...
-(id)queryForCriterion:(id)arg1 db:(sqlite3Ref)arg2 options:(unsigned)arg3 baseTable:(unsigned)arg4 isSubquery:(char)arg5 range:(NSRange)arg6 ;
-(id)queryForCriterion:(id)arg1 db:(sqlite3Ref)arg2 options:(unsigned)arg3 baseTable:(unsigned)arg4 isSubquery:(char)arg5 ;
...
-(sqlite3_stmtRef)_prepareBatchStatement:(sqlite3Ref)arg1 pattern:(id)arg2 libraryIDs:(unsigned*)arg3 batchSize:(unsigned)arg4 ;
