...
@interface MFLibrarySearchableIndex : NSObject <MFDiagnosticsGenerator, CSSearchableIndexDelegate> {
	...
	unsigned _throttledIndexingBatchSize;
	unsigned _throttledDataSourceBatchSize;
	unsigned _currentMaximumBatchSize;
...
@property (assign,setter=_setForeground:,getter=_isForeground,nonatomic) char foreground; 
...
-(void)setRemainingIndexingBudget:(double)arg1 shouldPersist:(char)arg2 ;
-(void)_queueTransitionActive:(char)arg1 ;
...
-(void)_indexItems:(id)arg1 fromRefresh:(char)arg2 ;
-(double)_throttleRequestedSize:(unsigned*)arg1 action:(/*^block*/id)arg2 ;
...
-(void)_queueConsumeBudgetItemCount:(unsigned)arg1 ;
