...
-(id)moveMessages:(id)arg1 fromMailbox:(id)arg2 toMailbox:(id)arg3 markAsRead:(char)arg4 ;
...
-(id)suggestionsLostMessageSearchOrderWithLimit:(unsigned)arg1 wasTruncated:(char*)arg2 ;
