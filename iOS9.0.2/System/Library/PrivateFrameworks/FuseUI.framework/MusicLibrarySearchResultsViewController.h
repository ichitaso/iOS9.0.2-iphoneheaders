...
@property (getter=isResultsViewVisible,nonatomic,readonly) char resultsViewVisible; 
...
-(id)_collectionViewDescriptorForSection:(unsigned)arg1 traitCollection:(id)arg2 ;
