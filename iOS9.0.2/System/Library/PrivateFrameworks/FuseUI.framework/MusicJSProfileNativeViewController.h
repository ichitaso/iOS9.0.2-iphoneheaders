...
-(void)setSocialHidden:(char)arg1;
-(char)supportsRelatedContentDocument;
...
@property (assign,getter=isSocialHidden,nonatomic) char socialHidden;                                     //@synthesize socialHidden=_socialHidden - In the implementation block
