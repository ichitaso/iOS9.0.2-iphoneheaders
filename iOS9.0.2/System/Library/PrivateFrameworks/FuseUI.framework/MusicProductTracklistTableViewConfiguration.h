...
@interface MusicProductTracklistTableViewConfiguration : MusicLibraryBrowseTableViewConfiguration {
	...
	char _wantsArtistName;
	char _wantsArtwork;
	char _wantsCompleteOffer;
	char _wantsCopyrightText;
...
@property (assign,nonatomic) char wantsArtistName;                                                              //@synthesize wantsArtistName=_wantsArtistName - In the implementation block
@property (assign,nonatomic) char wantsArtwork;                                                                 //@synthesize wantsArtwork=_wantsArtwork - In the implementation block
@property (assign,nonatomic) char wantsCompleteOffer;                                                           //@synthesize wantsCompleteOffer=_wantsCompleteOffer - In the implementation block
@property (assign,nonatomic) char wantsCopyrightText;                                                           //@synthesize wantsCopyrightText=_wantsCopyrightText - In the implementation block
...
-(char)wantsArtistName;
-(void)setWantsArtistName:(char)arg1 ;
-(char)wantsCompleteOffer;
-(void)setWantsCompleteOffer:(char)arg1 ;
-(char)wantsCopyrightText;
-(void)setWantsCopyrightText:(char)arg1 ;
