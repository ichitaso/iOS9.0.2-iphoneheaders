...
@property (nonatomic,readonly) char shouldStartPictureInPictureEnteringBackground; 
@property (assign,getter=isPictureInPicturePossible,nonatomic) char pictureInPicturePossible; 
...
-(void)startPictureInPictureEnteringBackgroundAnimated:(char)arg1 withCompletionHandler:(/*^block*/id)arg2 ;
...
-(void)_tearDownAndNotifyClientAboutCancellation:(char)arg1 ;
