...
@interface HAPTunneledAccessoryBLTE : HAPAccessory <HAPAccessoryServerInternalDelegate> {
	...
	char _performingPairVerify;
	char _pairVerifyComplete;
...
@property (assign,getter=isPerformingPairVerify,nonatomic) char performingPairVerify;              //@synthesize performingPairVerify=_performingPairVerify - In the implementation block
@property (assign,getter=isPairVerifyComplete,nonatomic) char pairVerifyComplete;                  //@synthesize pairVerifyComplete=_pairVerifyComplete - In the implementation block
...
-(char)_handleCharacteristicReadResponse:(id)arg1 error:(id*)arg2 ;
...
-(void)setPerformingPairVerify:(char)arg1 ;
...
-(void)setPairVerifyComplete:(char)arg1 ;
...
-(char)isPairVerifyComplete;
-(char)isPerformingPairVerify;
-(char)_establishSecureSessionWithError:(id*)arg1 ;
-(char)_parseTunneledBTLEAccessoryService:(id)arg1 ;
-(char)_parsePairingService:(id)arg1 ;
...
-(void)addPairingWithIdentifier:(id)arg1 publicKey:(id)arg2 admin:(char)arg3 completionQueue:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
