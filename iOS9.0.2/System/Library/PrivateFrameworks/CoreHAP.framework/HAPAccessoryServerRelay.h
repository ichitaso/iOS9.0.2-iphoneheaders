...
@property (assign,getter=isSecuritySessionOpen,nonatomic) char securitySessionOpen;                    //@synthesize securitySessionOpen=_securitySessionOpen - In the implementation block
