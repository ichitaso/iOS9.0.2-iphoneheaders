...
@property (assign,getter=isPerformingGeneralScan,nonatomic) char performingGeneralScan;              //@synthesize performingGeneralScan=_performingGeneralScan - In the implementation block
...
-(unsigned)_parseManufacturerSpecificData:(id)arg1 reservedByte:(id*)arg2 configNumber:(id*)arg3 pairingStatusFlag:(id*)arg4 stateNumber:(id*)arg5 uniqueIdentifier:(id*)arg6 category:(id*)arg7 ;
...
-(unsigned)_parseAdvertisementData:(id)arg1 forPeripheral:(id)arg2 name:(id*)arg3 pairingUsername:(id*)arg4 statusFlags:(id*)arg5 stateNumber:(id*)arg6 category:(id*)arg7 configNumber:(id*)arg8 ;
-(char)_shouldCreateHAPAccessoryServerWithIdentifier:(id)arg1 statusFlags:(id)arg2 stateNumber:(id)arg3 category:(id)arg4 configNumber:(id)arg5 forPeripheral:(id)arg6 ;
-(void)_createHAPAccessoryAndNotifyDelegateWithPeripheral:(id)arg1 name:(id)arg2 pairingUsername:(id)arg3 statusFlags:(id)arg4 stateNumber:(id)arg5 category:(id)arg6 version:(unsigned)arg7 ;
