...
-(char)_isRegisteredURI:(id)arg1 ;
-(char)_isFromLinkedID:(id)arg1 fromID:(id)arg2 ;
-(char)_isWhitelistedUnencryptedSender:(id)arg1 ;
-(void)_fixParticipantsForChat:(id)arg1 ;
-(void)_handleMessageSentToSelf:(id)arg1 chatIdentifier:(id)arg2 style:(unsigned char)arg3 isLocal:(char)arg4 account:(id)arg5 ;
...
-(void)handler:(id)arg1 receivedError:(id)arg2 forMessageID:(id)arg3 toIdentifier:(id)arg4 fromIdentifier:(id)arg5 fromToken:(id)arg6 timeStamp:(id)arg7 fromIDSID:(id)arg8 needsDeliveryReceipt:(id)arg9 deliveryContext:(id)arg10 storageContext:(id)arg11 additionalInfo:(id)arg12 shouldShowPeerErrors:(char)arg13 ;
