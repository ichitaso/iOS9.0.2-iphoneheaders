...
+[CAMApplicationAccessibility(SafeCategory) safeCategoryBaseClass]
...
___45+[AXCameraGlue accessibilityInitializeBundle]_block_invoke_6
___45+[AXCameraGlue accessibilityInitializeBundle]_block_invoke_7
_objc_msgSend$shim
