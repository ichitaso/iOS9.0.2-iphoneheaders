...
-(char)_axWebKitSupportsARIAPressed;
-(char)_axWebKitIsAriaPressed;
-(char)_axWebKitSupportsARIAExpanded;
-(char)_axWebKitIsAriaExpanded;
-(char)_axWebKitHasPopup;
...
-(char)_accessibilityIsDataEmpty:(id)arg1 ;
...
-(char)_axHasMultipleAccessibleChildren:(int*)arg1 ;
-(void)_repostFocusChangeNotification;
-(id)_axWebAreaURL;
-(void)_axSetWebAreaURL:(id)arg1 ;
-(char)_accessibilityRequiresContextIdConversion;
-(char)_isCheckBox;
...
-(char)_accessibilityShouldScrollRemoteParent;
...
-(char)_accessibilitySupportsPressedState;
-(char)_accessibilityIsPressed;
...
-(char)_accessibilityHandwritingAttributeAcceptsContractedBraille;
