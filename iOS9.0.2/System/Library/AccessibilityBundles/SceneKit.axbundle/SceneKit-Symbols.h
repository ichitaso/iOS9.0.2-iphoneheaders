...
+[SCNNodeAccessibility(SafeCategory) safeCategoryBaseClass]
...
+[SCNViewAccessibility(SafeCategory) safeCategoryBaseClass]
...
+[SCNSceneAccessibility(SafeCategory) safeCategoryBaseClass]
