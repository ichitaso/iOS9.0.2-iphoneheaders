...
@class SARestaurantRestaurant, SALocalSearchReviewList, SiriRestaurantsParsedOperationHours, UISegmentedControl, NSMutableArray, SiriRestaurantsLogoButton, SiriUIMapCollectionViewCell, NSString;
...
@interface SiriRestaurantsDetailViewController : SiriUISnippetViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout> {
	...
	char _needToUnloadMapView;
	SiriUIMapCollectionViewCell* _mapCell;
