...
@class WiFiManager, NSMutableArray, PSSpecifier, NSMutableDictionary, NSString, NSTimer, APPasswordAlert, APAlert, APPersonalHotspotAlert, APCarPlayAlert, UIAlertView, UILabel, UIView, NSMutableSet, NSArray, NSDictionary, UINavigationController, WiFiNetwork;
