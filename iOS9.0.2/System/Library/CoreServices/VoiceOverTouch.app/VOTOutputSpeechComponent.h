...
@class SCRCThread, TTSSpeechSynthesizer, SCRCIndexMap, NSString, NSDictionary, NSMutableDictionary, TTSSpeechRequest, NSArray;
...
-(void)_applyTelephoneFormatting:(id)arg1 withRanges:(id)arg2 languageCode:(id)arg3 ;
...
-(id)_stringForLiteralText:(id)arg1 action:(id)arg2 languageCode:(id)arg3 ;
...
-(void)_formatEthernetMacAddress:(id)arg1 ;
...
-(void)_formatTelephoneNumber:(id)arg1 languageCode:(id)arg2 ;
-(void)_applyTextualWorkarounds:(id)arg1 ;
-(void)_insertEmoji:(id)arg1 languageCode:(id)arg2 ;
...
-(id)_preferenceLanguageForLanguage:(id)arg1 defaultLanguage:(id)arg2 selectedLanguage:(id)arg3 ;
...
-(void)_updateVoiceOverCaptionPanel:(id)arg1 characterRange:(NSRange)arg2 withLanguage:(id)arg3 ;
