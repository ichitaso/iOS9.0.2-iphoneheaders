...
@class SCATFocusContext, AXAccessQueueTimer, SCATElementManager;
...
@property (nonatomic,retain) AXAccessQueueTimer * idleTimer;                           //@synthesize idleTimer=_idleTimer - In the implementation block
...
-(AXAccessQueueTimer *)idleTimer;
-(void)setIdleTimer:(AXAccessQueueTimer *)arg1 ;
@end
